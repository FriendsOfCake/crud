...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba02644a161_content')) { function _lba02644a161_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb67147109dc_classes')) { function _lb67147109dc_classes($_l, $_args) { extract($_args)
