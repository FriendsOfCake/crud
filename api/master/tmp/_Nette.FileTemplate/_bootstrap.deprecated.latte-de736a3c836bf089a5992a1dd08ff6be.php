...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9f2bb12a43_content')) { function _lb9f2bb12a43_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb8691a88dc6_classes')) { function _lb8691a88dc6_classes($_l, $_args) { extract($_args)
