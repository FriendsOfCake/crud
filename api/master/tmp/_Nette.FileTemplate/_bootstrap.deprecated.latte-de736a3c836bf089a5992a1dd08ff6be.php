...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb33125d6ec6_content')) { function _lb33125d6ec6_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbd5d4522f78_classes')) { function _lbd5d4522f78_classes($_l, $_args) { extract($_args)
