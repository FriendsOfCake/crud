...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3ac7bf6c9d_content')) { function _lb3ac7bf6c9d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb0970cf78e4_classes')) { function _lb0970cf78e4_classes($_l, $_args) { extract($_args)
