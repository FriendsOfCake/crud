...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb54125da1ea_content')) { function _lb54125da1ea_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb9f6049b42e_classes')) { function _lb9f6049b42e_classes($_l, $_args) { extract($_args)
