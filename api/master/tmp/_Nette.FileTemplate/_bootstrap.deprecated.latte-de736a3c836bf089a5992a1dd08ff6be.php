...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8561c5d4f1_content')) { function _lb8561c5d4f1_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbde7745a2c5_classes')) { function _lbde7745a2c5_classes($_l, $_args) { extract($_args)
