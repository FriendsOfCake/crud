...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb48c465753e_content')) { function _lb48c465753e_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb44491c879a_classes')) { function _lb44491c879a_classes($_l, $_args) { extract($_args)
