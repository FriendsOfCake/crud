...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb19557518ff_content')) { function _lb19557518ff_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbc5d01cc93d_classes')) { function _lbc5d01cc93d_classes($_l, $_args) { extract($_args)
