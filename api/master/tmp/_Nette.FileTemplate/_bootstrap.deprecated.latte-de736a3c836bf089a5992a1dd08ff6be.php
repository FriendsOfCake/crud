...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbfb6493a200_content')) { function _lbfb6493a200_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb448bf07db1_classes')) { function _lb448bf07db1_classes($_l, $_args) { extract($_args)
