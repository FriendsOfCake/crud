...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9cd3f5f57c_content')) { function _lb9cd3f5f57c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb986be743c5_classes')) { function _lb986be743c5_classes($_l, $_args) { extract($_args)
