...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb648901e430_content')) { function _lb648901e430_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb692321f52b_classes')) { function _lb692321f52b_classes($_l, $_args) { extract($_args)
