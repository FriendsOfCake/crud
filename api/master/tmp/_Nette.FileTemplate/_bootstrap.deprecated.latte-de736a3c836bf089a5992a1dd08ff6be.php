...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1526aba18d_content')) { function _lb1526aba18d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbcf87bc7ccb_classes')) { function _lbcf87bc7ccb_classes($_l, $_args) { extract($_args)
