...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5395367646_content')) { function _lb5395367646_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb19391bc231_classes')) { function _lb19391bc231_classes($_l, $_args) { extract($_args)
