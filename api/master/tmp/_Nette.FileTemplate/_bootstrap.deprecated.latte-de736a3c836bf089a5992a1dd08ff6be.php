...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe7f33c8b45_content')) { function _lbe7f33c8b45_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb249ecbff56_classes')) { function _lb249ecbff56_classes($_l, $_args) { extract($_args)
