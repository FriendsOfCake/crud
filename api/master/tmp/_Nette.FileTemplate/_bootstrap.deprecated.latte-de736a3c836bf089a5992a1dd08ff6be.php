...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbcce6cc7fb3_content')) { function _lbcce6cc7fb3_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lba9f29d8b5e_classes')) { function _lba9f29d8b5e_classes($_l, $_args) { extract($_args)
