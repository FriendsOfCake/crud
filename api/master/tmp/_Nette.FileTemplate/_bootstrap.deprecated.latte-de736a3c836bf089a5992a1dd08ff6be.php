...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8b3a2fd60c_content')) { function _lb8b3a2fd60c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb20a7dbf98f_classes')) { function _lb20a7dbf98f_classes($_l, $_args) { extract($_args)
