...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4e8725c248_content')) { function _lb4e8725c248_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbf6a7b3d343_classes')) { function _lbf6a7b3d343_classes($_l, $_args) { extract($_args)
