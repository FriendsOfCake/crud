...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb80542d7a4c_content')) { function _lb80542d7a4c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb02ec958d5_classes')) { function _lbb02ec958d5_classes($_l, $_args) { extract($_args)
