...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbed3bdea87f_content')) { function _lbed3bdea87f_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbececb3a5fe_classes')) { function _lbececb3a5fe_classes($_l, $_args) { extract($_args)
