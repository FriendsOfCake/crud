...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb864733587d_content')) { function _lb864733587d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbfcb210e5a2_classes')) { function _lbfcb210e5a2_classes($_l, $_args) { extract($_args)
