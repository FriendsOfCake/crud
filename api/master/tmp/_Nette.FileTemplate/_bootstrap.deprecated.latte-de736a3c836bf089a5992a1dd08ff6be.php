...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb840c8641b6_content')) { function _lb840c8641b6_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb03e17a2cf_classes')) { function _lbb03e17a2cf_classes($_l, $_args) { extract($_args)
