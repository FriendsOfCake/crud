...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb60a49ada12_content')) { function _lb60a49ada12_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb886ee8e762_classes')) { function _lb886ee8e762_classes($_l, $_args) { extract($_args)
