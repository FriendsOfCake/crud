...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe960cb5be3_content')) { function _lbe960cb5be3_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb31d3fd1bf7_classes')) { function _lb31d3fd1bf7_classes($_l, $_args) { extract($_args)
