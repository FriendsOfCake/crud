...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9a982e8b79_content')) { function _lb9a982e8b79_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbd53213fff6_classes')) { function _lbd53213fff6_classes($_l, $_args) { extract($_args)
