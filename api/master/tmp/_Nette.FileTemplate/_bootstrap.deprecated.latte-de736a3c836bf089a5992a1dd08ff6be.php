...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb32ac297cae_content')) { function _lb32ac297cae_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb34988b2c3a_classes')) { function _lb34988b2c3a_classes($_l, $_args) { extract($_args)
