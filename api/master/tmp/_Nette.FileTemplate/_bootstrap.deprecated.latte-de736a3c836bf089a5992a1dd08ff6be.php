...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb004f8e80ae_content')) { function _lb004f8e80ae_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb3eac178b8f_classes')) { function _lb3eac178b8f_classes($_l, $_args) { extract($_args)
