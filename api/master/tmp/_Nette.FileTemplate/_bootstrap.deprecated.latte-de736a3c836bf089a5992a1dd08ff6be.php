...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe09178c301_content')) { function _lbe09178c301_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbea11d0f528_classes')) { function _lbea11d0f528_classes($_l, $_args) { extract($_args)
