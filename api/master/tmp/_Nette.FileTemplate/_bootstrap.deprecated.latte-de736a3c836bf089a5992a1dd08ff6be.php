...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5ce06dcbd2_content')) { function _lb5ce06dcbd2_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb968b6c9dcb_classes')) { function _lb968b6c9dcb_classes($_l, $_args) { extract($_args)
