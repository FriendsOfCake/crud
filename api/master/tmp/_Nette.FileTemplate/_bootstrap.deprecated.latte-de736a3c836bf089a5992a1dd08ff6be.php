...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1adcc62499_content')) { function _lb1adcc62499_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbccfdbe8049_classes')) { function _lbccfdbe8049_classes($_l, $_args) { extract($_args)
