...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb16f0533f05_content')) { function _lb16f0533f05_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbc46abe11e4_classes')) { function _lbc46abe11e4_classes($_l, $_args) { extract($_args)
