...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb00f70fab43_content')) { function _lb00f70fab43_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbafb87e94f0_classes')) { function _lbafb87e94f0_classes($_l, $_args) { extract($_args)
