...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1ebeb51da9_content')) { function _lb1ebeb51da9_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb72a820c1f6_classes')) { function _lb72a820c1f6_classes($_l, $_args) { extract($_args)
