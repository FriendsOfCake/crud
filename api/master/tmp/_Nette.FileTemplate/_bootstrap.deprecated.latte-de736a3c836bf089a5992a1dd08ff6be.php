...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8bd129d4b2_content')) { function _lb8bd129d4b2_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb940ce795c8_classes')) { function _lb940ce795c8_classes($_l, $_args) { extract($_args)
