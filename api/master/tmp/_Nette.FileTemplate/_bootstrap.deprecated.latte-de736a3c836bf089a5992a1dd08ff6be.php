...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9f981e7a3d_content')) { function _lb9f981e7a3d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb8c11589dd3_classes')) { function _lb8c11589dd3_classes($_l, $_args) { extract($_args)
