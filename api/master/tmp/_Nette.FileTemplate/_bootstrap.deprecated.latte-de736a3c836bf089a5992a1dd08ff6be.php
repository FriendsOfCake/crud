...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8c7bca015b_content')) { function _lb8c7bca015b_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbabbd74e69c_classes')) { function _lbabbd74e69c_classes($_l, $_args) { extract($_args)
