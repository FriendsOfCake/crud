...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb1583492d0_content')) { function _lbb1583492d0_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb44ec7a95d4_classes')) { function _lb44ec7a95d4_classes($_l, $_args) { extract($_args)
