...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb562676f4b9_content')) { function _lb562676f4b9_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb608d0bfef_classes')) { function _lbb608d0bfef_classes($_l, $_args) { extract($_args)
