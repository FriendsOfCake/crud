...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb27ad2a1f10_content')) { function _lb27ad2a1f10_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb92ca082306_classes')) { function _lb92ca082306_classes($_l, $_args) { extract($_args)
