...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb366ec537f2_content')) { function _lb366ec537f2_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb36be1a8960_classes')) { function _lb36be1a8960_classes($_l, $_args) { extract($_args)
