...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba525859a9c_content')) { function _lba525859a9c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb2b17396a06_classes')) { function _lb2b17396a06_classes($_l, $_args) { extract($_args)
