...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba0c11612e0_content')) { function _lba0c11612e0_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb72c0dbbf5c_classes')) { function _lb72c0dbbf5c_classes($_l, $_args) { extract($_args)
