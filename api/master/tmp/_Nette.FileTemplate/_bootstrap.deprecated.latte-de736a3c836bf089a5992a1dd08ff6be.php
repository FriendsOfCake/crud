...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb01205e617b_content')) { function _lb01205e617b_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb1e32e5cfa5_classes')) { function _lb1e32e5cfa5_classes($_l, $_args) { extract($_args)
