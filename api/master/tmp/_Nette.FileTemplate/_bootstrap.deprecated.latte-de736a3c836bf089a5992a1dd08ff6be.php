...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb43c2facb6a_content')) { function _lb43c2facb6a_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb4d1451b86a_classes')) { function _lb4d1451b86a_classes($_l, $_args) { extract($_args)
