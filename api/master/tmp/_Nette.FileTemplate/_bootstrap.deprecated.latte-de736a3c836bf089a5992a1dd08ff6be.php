...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7a4aa756eb_content')) { function _lb7a4aa756eb_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb8dfdb264a4_classes')) { function _lb8dfdb264a4_classes($_l, $_args) { extract($_args)
