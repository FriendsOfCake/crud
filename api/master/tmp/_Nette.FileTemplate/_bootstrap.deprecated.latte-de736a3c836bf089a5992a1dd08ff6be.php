...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba107b33540_content')) { function _lba107b33540_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb539585474b_classes')) { function _lb539585474b_classes($_l, $_args) { extract($_args)
