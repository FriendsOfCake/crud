...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb05ea0b8814_content')) { function _lb05ea0b8814_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb2fbbf962fe_classes')) { function _lb2fbbf962fe_classes($_l, $_args) { extract($_args)
