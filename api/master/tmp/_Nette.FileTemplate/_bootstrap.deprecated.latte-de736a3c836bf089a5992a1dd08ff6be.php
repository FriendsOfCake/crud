...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbfdbe0cdfce_content')) { function _lbfdbe0cdfce_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb0cca9f24a_classes')) { function _lbb0cca9f24a_classes($_l, $_args) { extract($_args)
