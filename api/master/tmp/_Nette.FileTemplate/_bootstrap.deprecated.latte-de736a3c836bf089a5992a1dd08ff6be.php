...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6097219bd5_content')) { function _lb6097219bd5_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb813bbc28b_classes')) { function _lbb813bbc28b_classes($_l, $_args) { extract($_args)
