...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb14f9e370a0_content')) { function _lb14f9e370a0_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb535a2c48b1_classes')) { function _lb535a2c48b1_classes($_l, $_args) { extract($_args)
