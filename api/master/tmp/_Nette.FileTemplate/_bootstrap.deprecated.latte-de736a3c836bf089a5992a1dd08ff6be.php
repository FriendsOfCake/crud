...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbbeae480469_content')) { function _lbbeae480469_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb58c63249f8_classes')) { function _lb58c63249f8_classes($_l, $_args) { extract($_args)
