...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf56c7bf69b_content')) { function _lbf56c7bf69b_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbcb58a34766_classes')) { function _lbcb58a34766_classes($_l, $_args) { extract($_args)
