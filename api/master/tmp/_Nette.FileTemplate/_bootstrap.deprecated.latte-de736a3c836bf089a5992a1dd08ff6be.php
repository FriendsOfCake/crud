...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2ed06eb1c5_content')) { function _lb2ed06eb1c5_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb19933fac57_classes')) { function _lb19933fac57_classes($_l, $_args) { extract($_args)
