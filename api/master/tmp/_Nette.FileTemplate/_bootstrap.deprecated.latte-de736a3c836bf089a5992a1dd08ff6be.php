...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7d78feabfe_content')) { function _lb7d78feabfe_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb27dfb2828e_classes')) { function _lb27dfb2828e_classes($_l, $_args) { extract($_args)
