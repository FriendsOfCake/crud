...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd2c4a6afc1_content')) { function _lbd2c4a6afc1_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb78f596beeb_classes')) { function _lb78f596beeb_classes($_l, $_args) { extract($_args)
