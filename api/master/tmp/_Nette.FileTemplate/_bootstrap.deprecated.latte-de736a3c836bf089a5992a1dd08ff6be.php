...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb12bb4661d9_content')) { function _lb12bb4661d9_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb854c665f49_classes')) { function _lb854c665f49_classes($_l, $_args) { extract($_args)
