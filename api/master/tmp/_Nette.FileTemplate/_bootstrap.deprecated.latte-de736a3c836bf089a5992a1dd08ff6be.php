...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb033ded6e79_content')) { function _lb033ded6e79_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbe7aa0d951b_classes')) { function _lbe7aa0d951b_classes($_l, $_args) { extract($_args)
