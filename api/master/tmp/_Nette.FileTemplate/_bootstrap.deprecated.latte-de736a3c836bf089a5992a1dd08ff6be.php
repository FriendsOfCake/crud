...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb84971449da_content')) { function _lb84971449da_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb909ce02c28_classes')) { function _lb909ce02c28_classes($_l, $_args) { extract($_args)
