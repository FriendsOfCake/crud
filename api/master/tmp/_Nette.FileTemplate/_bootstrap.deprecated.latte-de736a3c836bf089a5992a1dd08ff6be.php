...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf584703f70_content')) { function _lbf584703f70_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb57beac6959_classes')) { function _lb57beac6959_classes($_l, $_args) { extract($_args)
