...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe6ecff47ee_content')) { function _lbe6ecff47ee_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb1af085e051_classes')) { function _lb1af085e051_classes($_l, $_args) { extract($_args)
