...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2736fab72d_content')) { function _lb2736fab72d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbf6665a43ad_classes')) { function _lbf6665a43ad_classes($_l, $_args) { extract($_args)
