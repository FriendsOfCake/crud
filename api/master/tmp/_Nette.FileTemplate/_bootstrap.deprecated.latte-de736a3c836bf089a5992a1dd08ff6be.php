...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4bd5f359e7_content')) { function _lb4bd5f359e7_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lba4dc2a581c_classes')) { function _lba4dc2a581c_classes($_l, $_args) { extract($_args)
