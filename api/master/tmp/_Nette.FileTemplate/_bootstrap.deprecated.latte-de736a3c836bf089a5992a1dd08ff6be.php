...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbef57272547_content')) { function _lbef57272547_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lba9a7f661ca_classes')) { function _lba9a7f661ca_classes($_l, $_args) { extract($_args)
