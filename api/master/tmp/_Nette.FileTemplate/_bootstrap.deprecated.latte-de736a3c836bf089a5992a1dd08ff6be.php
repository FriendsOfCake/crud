...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb4a0de75e5_content')) { function _lbb4a0de75e5_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbbe5970bbbd_classes')) { function _lbbe5970bbbd_classes($_l, $_args) { extract($_args)
