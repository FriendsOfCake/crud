...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb595a075424_content')) { function _lb595a075424_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb3699bd5acc_classes')) { function _lb3699bd5acc_classes($_l, $_args) { extract($_args)
