...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7a55df42b2_content')) { function _lb7a55df42b2_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb071c396055_classes')) { function _lb071c396055_classes($_l, $_args) { extract($_args)
