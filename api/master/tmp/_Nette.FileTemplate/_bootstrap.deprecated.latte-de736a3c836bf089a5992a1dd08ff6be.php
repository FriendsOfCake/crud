...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb584821de20_content')) { function _lb584821de20_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbd14f351a73_classes')) { function _lbd14f351a73_classes($_l, $_args) { extract($_args)
