...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3da54e2512_content')) { function _lb3da54e2512_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbfd1c892f5e_classes')) { function _lbfd1c892f5e_classes($_l, $_args) { extract($_args)
