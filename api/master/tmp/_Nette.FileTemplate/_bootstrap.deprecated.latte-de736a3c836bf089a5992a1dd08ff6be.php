...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5ba33c3189_content')) { function _lb5ba33c3189_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbbd130977a0_classes')) { function _lbbd130977a0_classes($_l, $_args) { extract($_args)
