...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb892dcbc7c0_content')) { function _lb892dcbc7c0_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb8c903556bd_classes')) { function _lb8c903556bd_classes($_l, $_args) { extract($_args)
