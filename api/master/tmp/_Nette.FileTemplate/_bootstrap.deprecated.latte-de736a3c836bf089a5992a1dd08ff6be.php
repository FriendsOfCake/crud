...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6dabf33f83_content')) { function _lb6dabf33f83_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb03f3a04140_classes')) { function _lb03f3a04140_classes($_l, $_args) { extract($_args)
