...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb05dda261d_content')) { function _lbb05dda261d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb23f6415972_classes')) { function _lb23f6415972_classes($_l, $_args) { extract($_args)
