...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9e35a1db47_content')) { function _lb9e35a1db47_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbd7a0ed39f1_classes')) { function _lbd7a0ed39f1_classes($_l, $_args) { extract($_args)
