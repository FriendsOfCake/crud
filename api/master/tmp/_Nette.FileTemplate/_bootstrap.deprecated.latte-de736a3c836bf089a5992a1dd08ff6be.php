...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb19a34dda75_content')) { function _lb19a34dda75_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb98809d8eb_classes')) { function _lbb98809d8eb_classes($_l, $_args) { extract($_args)
