...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc4be8f2d72_content')) { function _lbc4be8f2d72_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbdf98b51f69_classes')) { function _lbdf98b51f69_classes($_l, $_args) { extract($_args)
