...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb240daccfa5_content')) { function _lb240daccfa5_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb46d9d02e1c_classes')) { function _lb46d9d02e1c_classes($_l, $_args) { extract($_args)
