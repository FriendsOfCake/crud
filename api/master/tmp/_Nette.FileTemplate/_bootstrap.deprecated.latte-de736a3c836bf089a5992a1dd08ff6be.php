...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf4aba0509a_content')) { function _lbf4aba0509a_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb017ad599a5_classes')) { function _lb017ad599a5_classes($_l, $_args) { extract($_args)
