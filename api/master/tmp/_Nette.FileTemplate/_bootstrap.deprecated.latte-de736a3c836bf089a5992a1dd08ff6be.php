...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb91894d1fce_content')) { function _lb91894d1fce_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb2c35d179cd_classes')) { function _lb2c35d179cd_classes($_l, $_args) { extract($_args)
