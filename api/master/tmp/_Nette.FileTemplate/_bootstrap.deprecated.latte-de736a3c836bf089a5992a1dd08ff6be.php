...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4e74b0e2fd_content')) { function _lb4e74b0e2fd_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbf7193a3023_classes')) { function _lbf7193a3023_classes($_l, $_args) { extract($_args)
