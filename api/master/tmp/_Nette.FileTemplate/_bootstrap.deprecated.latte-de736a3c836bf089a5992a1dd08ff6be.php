...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3a2901ca43_content')) { function _lb3a2901ca43_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbe82e36e6b1_classes')) { function _lbe82e36e6b1_classes($_l, $_args) { extract($_args)
