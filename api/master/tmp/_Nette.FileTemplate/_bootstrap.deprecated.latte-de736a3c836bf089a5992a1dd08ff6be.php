...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb36d17e0c8d_content')) { function _lb36d17e0c8d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbd140bbe93d_classes')) { function _lbd140bbe93d_classes($_l, $_args) { extract($_args)
