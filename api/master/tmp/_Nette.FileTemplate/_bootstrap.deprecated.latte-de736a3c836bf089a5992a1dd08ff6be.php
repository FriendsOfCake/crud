...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8ab66cd7e9_content')) { function _lb8ab66cd7e9_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbcef835c913_classes')) { function _lbcef835c913_classes($_l, $_args) { extract($_args)
