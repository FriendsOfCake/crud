...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb93c30715c2_content')) { function _lb93c30715c2_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb11eb940ead_classes')) { function _lb11eb940ead_classes($_l, $_args) { extract($_args)
