...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe18f097562_content')) { function _lbe18f097562_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb111ff7374e_classes')) { function _lb111ff7374e_classes($_l, $_args) { extract($_args)
