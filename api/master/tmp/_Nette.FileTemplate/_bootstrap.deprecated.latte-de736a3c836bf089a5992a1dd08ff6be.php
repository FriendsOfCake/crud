...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba93a58cdda_content')) { function _lba93a58cdda_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb4390f68522_classes')) { function _lb4390f68522_classes($_l, $_args) { extract($_args)
