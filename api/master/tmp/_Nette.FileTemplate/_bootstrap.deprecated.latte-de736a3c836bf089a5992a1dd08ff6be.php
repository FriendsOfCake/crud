...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2407ca03c9_content')) { function _lb2407ca03c9_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbffcb392669_classes')) { function _lbffcb392669_classes($_l, $_args) { extract($_args)
