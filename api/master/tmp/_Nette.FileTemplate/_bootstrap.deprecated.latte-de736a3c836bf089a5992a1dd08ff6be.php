...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9397e9d4cb_content')) { function _lb9397e9d4cb_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb99e565d702_classes')) { function _lb99e565d702_classes($_l, $_args) { extract($_args)
