...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2059749f2b_content')) { function _lb2059749f2b_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbe893c1be6b_classes')) { function _lbe893c1be6b_classes($_l, $_args) { extract($_args)
