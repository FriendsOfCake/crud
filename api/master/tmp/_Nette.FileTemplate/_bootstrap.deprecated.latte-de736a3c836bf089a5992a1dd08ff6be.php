...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbfdb0d68243_content')) { function _lbfdb0d68243_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbbe60812a24_classes')) { function _lbbe60812a24_classes($_l, $_args) { extract($_args)
