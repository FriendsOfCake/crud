...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb732038819a_content')) { function _lb732038819a_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb7b961a0f2_classes')) { function _lbb7b961a0f2_classes($_l, $_args) { extract($_args)
