...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb04deed09c3_content')) { function _lb04deed09c3_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbdbf7594271_classes')) { function _lbdbf7594271_classes($_l, $_args) { extract($_args)
