...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb237e6a7448_content')) { function _lb237e6a7448_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbfb8daf706a_classes')) { function _lbfb8daf706a_classes($_l, $_args) { extract($_args)
