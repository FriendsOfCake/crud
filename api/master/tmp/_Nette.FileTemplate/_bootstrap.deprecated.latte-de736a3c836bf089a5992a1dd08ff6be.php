...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba54f6fc6a1_content')) { function _lba54f6fc6a1_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb7e7bf6de5d_classes')) { function _lb7e7bf6de5d_classes($_l, $_args) { extract($_args)
