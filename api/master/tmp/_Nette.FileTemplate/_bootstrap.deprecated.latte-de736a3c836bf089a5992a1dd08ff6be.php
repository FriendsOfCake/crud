...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbbf15002cf9_content')) { function _lbbf15002cf9_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb1ff0dce382_classes')) { function _lb1ff0dce382_classes($_l, $_args) { extract($_args)
