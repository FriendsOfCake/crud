...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb77aa7a083e_content')) { function _lb77aa7a083e_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb07c53ff002_classes')) { function _lb07c53ff002_classes($_l, $_args) { extract($_args)
