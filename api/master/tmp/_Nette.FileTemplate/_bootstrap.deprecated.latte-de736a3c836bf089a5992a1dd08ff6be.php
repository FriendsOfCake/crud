...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3c7e16b861_content')) { function _lb3c7e16b861_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbebd9204c77_classes')) { function _lbebd9204c77_classes($_l, $_args) { extract($_args)
