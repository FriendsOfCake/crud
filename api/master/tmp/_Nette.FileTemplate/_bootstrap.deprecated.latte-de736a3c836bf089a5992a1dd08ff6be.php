...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb47a48e33cb_content')) { function _lb47a48e33cb_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb6c83caab34_classes')) { function _lb6c83caab34_classes($_l, $_args) { extract($_args)
