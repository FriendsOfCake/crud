...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9b2b3f6e55_content')) { function _lb9b2b3f6e55_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbd90355b558_classes')) { function _lbd90355b558_classes($_l, $_args) { extract($_args)
