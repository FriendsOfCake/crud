...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb14ff593caa_content')) { function _lb14ff593caa_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbc81aa804d9_classes')) { function _lbc81aa804d9_classes($_l, $_args) { extract($_args)
