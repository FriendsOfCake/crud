...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1d2a16fad4_content')) { function _lb1d2a16fad4_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbfad12f2c1e_classes')) { function _lbfad12f2c1e_classes($_l, $_args) { extract($_args)
