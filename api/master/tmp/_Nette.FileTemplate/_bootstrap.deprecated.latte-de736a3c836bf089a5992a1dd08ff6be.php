...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbddeb585a05_content')) { function _lbddeb585a05_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbda16ce06f8_classes')) { function _lbda16ce06f8_classes($_l, $_args) { extract($_args)
