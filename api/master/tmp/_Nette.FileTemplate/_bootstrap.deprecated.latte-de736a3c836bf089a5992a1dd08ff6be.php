...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6929b109cf_content')) { function _lb6929b109cf_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb5162bd043_classes')) { function _lbb5162bd043_classes($_l, $_args) { extract($_args)
