...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb8e2d9f8ee_content')) { function _lbb8e2d9f8ee_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb6aa3724661_classes')) { function _lb6aa3724661_classes($_l, $_args) { extract($_args)
