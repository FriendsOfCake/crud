...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1e049350ab_content')) { function _lb1e049350ab_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb8dcc2c01ea_classes')) { function _lb8dcc2c01ea_classes($_l, $_args) { extract($_args)
