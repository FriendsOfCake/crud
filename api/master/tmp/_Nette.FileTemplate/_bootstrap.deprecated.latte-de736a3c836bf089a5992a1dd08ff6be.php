...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe5bc84a0e5_content')) { function _lbe5bc84a0e5_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb7446cef78e_classes')) { function _lb7446cef78e_classes($_l, $_args) { extract($_args)
