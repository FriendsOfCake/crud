...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0d1d19ccc9_content')) { function _lb0d1d19ccc9_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb8eea788986_classes')) { function _lb8eea788986_classes($_l, $_args) { extract($_args)
