...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6653ac7208_content')) { function _lb6653ac7208_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb0bd52cf6d3_classes')) { function _lb0bd52cf6d3_classes($_l, $_args) { extract($_args)
