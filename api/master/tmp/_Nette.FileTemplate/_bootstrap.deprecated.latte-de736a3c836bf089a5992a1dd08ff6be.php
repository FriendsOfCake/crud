...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbaf70e4e93e_content')) { function _lbaf70e4e93e_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb2e13454d56_classes')) { function _lb2e13454d56_classes($_l, $_args) { extract($_args)
