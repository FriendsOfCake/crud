...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1d8f01a92a_content')) { function _lb1d8f01a92a_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lba4539f8ca4_classes')) { function _lba4539f8ca4_classes($_l, $_args) { extract($_args)
