...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbbde90d65a2_content')) { function _lbbde90d65a2_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbcffa2fea6a_classes')) { function _lbcffa2fea6a_classes($_l, $_args) { extract($_args)
