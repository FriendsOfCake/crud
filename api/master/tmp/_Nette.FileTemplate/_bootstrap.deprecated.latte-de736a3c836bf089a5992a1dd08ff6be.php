...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd2c00f3c5d_content')) { function _lbd2c00f3c5d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbed217f9afb_classes')) { function _lbed217f9afb_classes($_l, $_args) { extract($_args)
