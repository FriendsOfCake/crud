...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba1d27c38c0_content')) { function _lba1d27c38c0_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb044a3fd6ab_classes')) { function _lb044a3fd6ab_classes($_l, $_args) { extract($_args)
