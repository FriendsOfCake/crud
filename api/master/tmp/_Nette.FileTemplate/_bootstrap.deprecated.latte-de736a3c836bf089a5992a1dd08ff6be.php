...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0f58e01b28_content')) { function _lb0f58e01b28_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbad7d46aef1_classes')) { function _lbad7d46aef1_classes($_l, $_args) { extract($_args)
