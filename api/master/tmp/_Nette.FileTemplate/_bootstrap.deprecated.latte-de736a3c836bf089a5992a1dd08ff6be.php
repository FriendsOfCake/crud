...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd9affc2f52_content')) { function _lbd9affc2f52_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb26a02d0aa2_classes')) { function _lb26a02d0aa2_classes($_l, $_args) { extract($_args)
