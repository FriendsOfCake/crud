...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc9ae2dd32c_content')) { function _lbc9ae2dd32c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb130802caff_classes')) { function _lb130802caff_classes($_l, $_args) { extract($_args)
