...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb95919e94a9_content')) { function _lb95919e94a9_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbf8ccd8d35d_classes')) { function _lbf8ccd8d35d_classes($_l, $_args) { extract($_args)
