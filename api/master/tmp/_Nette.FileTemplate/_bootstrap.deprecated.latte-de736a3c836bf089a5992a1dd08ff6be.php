...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbacab52c28b_content')) { function _lbacab52c28b_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb659143902e_classes')) { function _lb659143902e_classes($_l, $_args) { extract($_args)
