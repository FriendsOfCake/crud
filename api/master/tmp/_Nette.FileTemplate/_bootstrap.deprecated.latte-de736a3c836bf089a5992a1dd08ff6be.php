...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8780ec44ae_content')) { function _lb8780ec44ae_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb0572eaed63_classes')) { function _lb0572eaed63_classes($_l, $_args) { extract($_args)
