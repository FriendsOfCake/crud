...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe59e1358da_content')) { function _lbe59e1358da_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb1e8015cafb_classes')) { function _lb1e8015cafb_classes($_l, $_args) { extract($_args)
