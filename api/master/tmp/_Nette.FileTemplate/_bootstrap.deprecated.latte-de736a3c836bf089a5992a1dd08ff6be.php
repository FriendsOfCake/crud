...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0d5a5e97b5_content')) { function _lb0d5a5e97b5_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb0593a3d6fc_classes')) { function _lb0593a3d6fc_classes($_l, $_args) { extract($_args)
