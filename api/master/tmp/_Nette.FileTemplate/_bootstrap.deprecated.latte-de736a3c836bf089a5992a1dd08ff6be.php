...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6e8213da94_content')) { function _lb6e8213da94_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb3850d60ab6_classes')) { function _lb3850d60ab6_classes($_l, $_args) { extract($_args)
