...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5e91e4c86c_content')) { function _lb5e91e4c86c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbdaf8e44d2b_classes')) { function _lbdaf8e44d2b_classes($_l, $_args) { extract($_args)
