...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7517bbea8f_content')) { function _lb7517bbea8f_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb828f03415c_classes')) { function _lb828f03415c_classes($_l, $_args) { extract($_args)
