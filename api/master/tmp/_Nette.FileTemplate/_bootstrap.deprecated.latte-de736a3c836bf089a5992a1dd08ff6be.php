...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbffbb5bcd56_content')) { function _lbffbb5bcd56_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lba090c34cd1_classes')) { function _lba090c34cd1_classes($_l, $_args) { extract($_args)
