...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3b11b61f76_content')) { function _lb3b11b61f76_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb31b972476_classes')) { function _lbb31b972476_classes($_l, $_args) { extract($_args)
