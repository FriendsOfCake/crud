...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb55795bbf3c_content')) { function _lb55795bbf3c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbad36145d23_classes')) { function _lbad36145d23_classes($_l, $_args) { extract($_args)
