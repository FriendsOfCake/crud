...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbcda5b43f41_content')) { function _lbcda5b43f41_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb43b0711d9_classes')) { function _lbb43b0711d9_classes($_l, $_args) { extract($_args)
