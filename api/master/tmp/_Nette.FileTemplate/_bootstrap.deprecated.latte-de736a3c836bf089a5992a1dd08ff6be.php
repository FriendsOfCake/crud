...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb31a1898c14_content')) { function _lb31a1898c14_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb459761061b_classes')) { function _lb459761061b_classes($_l, $_args) { extract($_args)
