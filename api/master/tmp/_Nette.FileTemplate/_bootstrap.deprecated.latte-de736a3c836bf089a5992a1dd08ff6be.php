...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb206bc66121_content')) { function _lb206bc66121_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb2f8cb5aeb0_classes')) { function _lb2f8cb5aeb0_classes($_l, $_args) { extract($_args)
