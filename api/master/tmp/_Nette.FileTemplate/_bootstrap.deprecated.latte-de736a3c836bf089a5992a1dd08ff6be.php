...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb82c5a1e73e_content')) { function _lb82c5a1e73e_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb75b5c1317a_classes')) { function _lb75b5c1317a_classes($_l, $_args) { extract($_args)
