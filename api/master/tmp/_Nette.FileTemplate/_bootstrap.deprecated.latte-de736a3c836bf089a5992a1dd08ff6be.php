...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf26cc3c675_content')) { function _lbf26cc3c675_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb5c4ca535d1_classes')) { function _lb5c4ca535d1_classes($_l, $_args) { extract($_args)
