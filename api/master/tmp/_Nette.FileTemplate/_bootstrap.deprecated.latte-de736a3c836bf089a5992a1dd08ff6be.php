...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd2ef65d2c7_content')) { function _lbd2ef65d2c7_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb95ae30a2b_classes')) { function _lbb95ae30a2b_classes($_l, $_args) { extract($_args)
