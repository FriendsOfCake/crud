...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe09b2a6a1c_content')) { function _lbe09b2a6a1c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbff3a407931_classes')) { function _lbff3a407931_classes($_l, $_args) { extract($_args)
