...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba74db7c47c_content')) { function _lba74db7c47c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbf53b66905b_classes')) { function _lbf53b66905b_classes($_l, $_args) { extract($_args)
