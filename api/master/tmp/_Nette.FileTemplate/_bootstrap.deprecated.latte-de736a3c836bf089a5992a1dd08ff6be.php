...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe50bb2d36b_content')) { function _lbe50bb2d36b_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbe21a9793d4_classes')) { function _lbe21a9793d4_classes($_l, $_args) { extract($_args)
