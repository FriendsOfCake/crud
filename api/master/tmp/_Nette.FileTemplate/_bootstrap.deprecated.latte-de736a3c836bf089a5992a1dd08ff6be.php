...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb38037d1571_content')) { function _lb38037d1571_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbcaa0ee6889_classes')) { function _lbcaa0ee6889_classes($_l, $_args) { extract($_args)
