...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbee8b5d2449_content')) { function _lbee8b5d2449_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb8087567073_classes')) { function _lb8087567073_classes($_l, $_args) { extract($_args)
