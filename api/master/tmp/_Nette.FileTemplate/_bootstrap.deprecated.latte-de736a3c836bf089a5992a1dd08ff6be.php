...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb208fa3e6d0_content')) { function _lb208fa3e6d0_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbaa28dacc62_classes')) { function _lbaa28dacc62_classes($_l, $_args) { extract($_args)
