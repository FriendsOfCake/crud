...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbfaf129fb1b_content')) { function _lbfaf129fb1b_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb1c1df4bfcd_classes')) { function _lb1c1df4bfcd_classes($_l, $_args) { extract($_args)
