...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba24b39340e_content')) { function _lba24b39340e_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb22d937808_classes')) { function _lbb22d937808_classes($_l, $_args) { extract($_args)
