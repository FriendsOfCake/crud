...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba4c352076e_content')) { function _lba4c352076e_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb476896a503_classes')) { function _lb476896a503_classes($_l, $_args) { extract($_args)
