...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9556d6896c_content')) { function _lb9556d6896c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbccd043906a_classes')) { function _lbccd043906a_classes($_l, $_args) { extract($_args)
