...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdb13e18264_content')) { function _lbdb13e18264_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb45075b177b_classes')) { function _lb45075b177b_classes($_l, $_args) { extract($_args)
