...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc6ee1b5799_content')) { function _lbc6ee1b5799_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbfe8684ae6d_classes')) { function _lbfe8684ae6d_classes($_l, $_args) { extract($_args)
