...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc2c6384f82_content')) { function _lbc2c6384f82_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb4fff87165e_classes')) { function _lb4fff87165e_classes($_l, $_args) { extract($_args)
