...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd8654ff446_content')) { function _lbd8654ff446_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbbdf4b3e522_classes')) { function _lbbdf4b3e522_classes($_l, $_args) { extract($_args)
