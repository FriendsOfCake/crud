...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb47a922a125_content')) { function _lb47a922a125_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb460dd20d61_classes')) { function _lb460dd20d61_classes($_l, $_args) { extract($_args)
