...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb05cb2eaf07_content')) { function _lb05cb2eaf07_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb95e84d1be4_classes')) { function _lb95e84d1be4_classes($_l, $_args) { extract($_args)
