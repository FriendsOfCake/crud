...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3e9b4a0eba_content')) { function _lb3e9b4a0eba_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb717c538b55_classes')) { function _lb717c538b55_classes($_l, $_args) { extract($_args)
