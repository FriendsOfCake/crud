...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb69dc4cb8d9_content')) { function _lb69dc4cb8d9_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb5dec86751c_classes')) { function _lb5dec86751c_classes($_l, $_args) { extract($_args)
