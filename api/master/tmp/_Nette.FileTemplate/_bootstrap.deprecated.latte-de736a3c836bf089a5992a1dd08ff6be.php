...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0db8c3535c_content')) { function _lb0db8c3535c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbf0dd36e1fc_classes')) { function _lbf0dd36e1fc_classes($_l, $_args) { extract($_args)
