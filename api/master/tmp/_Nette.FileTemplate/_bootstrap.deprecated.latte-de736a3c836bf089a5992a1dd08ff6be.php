...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb59e7f99bfc_content')) { function _lb59e7f99bfc_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb0f5c3f2780_classes')) { function _lb0f5c3f2780_classes($_l, $_args) { extract($_args)
