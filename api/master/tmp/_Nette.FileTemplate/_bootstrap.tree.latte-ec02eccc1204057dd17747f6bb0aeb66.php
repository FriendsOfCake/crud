...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbd215c7e965_tree')) { function _lbd215c7e965_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4dae65e9cc_content')) { function _lb4dae65e9cc_content($_l, $_args) { extract($_args)
?><div id="content">
