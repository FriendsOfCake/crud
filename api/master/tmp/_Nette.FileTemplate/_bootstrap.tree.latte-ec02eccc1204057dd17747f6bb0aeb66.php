...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb423a7bd33a_tree')) { function _lb423a7bd33a_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc1edaa72d0_content')) { function _lbc1edaa72d0_content($_l, $_args) { extract($_args)
?><div id="content">
