...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb23f64d69b4_tree')) { function _lb23f64d69b4_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb65ebc0b615_content')) { function _lb65ebc0b615_content($_l, $_args) { extract($_args)
?><div id="content">
