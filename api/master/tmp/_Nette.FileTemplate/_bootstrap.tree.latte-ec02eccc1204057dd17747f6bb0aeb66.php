...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb94a7a1f4c1_tree')) { function _lb94a7a1f4c1_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb757ba9fac3_content')) { function _lb757ba9fac3_content($_l, $_args) { extract($_args)
?><div id="content">
