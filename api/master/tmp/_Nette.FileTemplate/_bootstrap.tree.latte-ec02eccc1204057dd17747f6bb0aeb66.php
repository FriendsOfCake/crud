...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbdea37585cb_tree')) { function _lbdea37585cb_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb71eed68d71_content')) { function _lb71eed68d71_content($_l, $_args) { extract($_args)
?><div id="content">
