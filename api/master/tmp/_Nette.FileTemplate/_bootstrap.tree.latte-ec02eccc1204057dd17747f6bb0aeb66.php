...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb491a22e94c_tree')) { function _lb491a22e94c_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb047182ba6a_content')) { function _lb047182ba6a_content($_l, $_args) { extract($_args)
?><div id="content">
