...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb018e4ca7ab_tree')) { function _lb018e4ca7ab_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb351aa2b39e_content')) { function _lb351aa2b39e_content($_l, $_args) { extract($_args)
?><div id="content">
