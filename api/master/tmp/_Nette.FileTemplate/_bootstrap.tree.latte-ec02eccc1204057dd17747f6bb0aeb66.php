...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbd2374f4946_tree')) { function _lbd2374f4946_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1b3f4c02e9_content')) { function _lb1b3f4c02e9_content($_l, $_args) { extract($_args)
?><div id="content">
