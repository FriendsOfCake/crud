...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb06d36b1e1f_tree')) { function _lb06d36b1e1f_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1e995e0d84_content')) { function _lb1e995e0d84_content($_l, $_args) { extract($_args)
?><div id="content">
