...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb1b2c65f57f_tree')) { function _lb1b2c65f57f_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe29b83dc15_content')) { function _lbe29b83dc15_content($_l, $_args) { extract($_args)
?><div id="content">
