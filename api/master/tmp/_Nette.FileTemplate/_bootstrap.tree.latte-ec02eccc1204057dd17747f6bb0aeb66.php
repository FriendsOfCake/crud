...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb12c52bd0b7_tree')) { function _lb12c52bd0b7_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba9e0356a2b_content')) { function _lba9e0356a2b_content($_l, $_args) { extract($_args)
?><div id="content">
