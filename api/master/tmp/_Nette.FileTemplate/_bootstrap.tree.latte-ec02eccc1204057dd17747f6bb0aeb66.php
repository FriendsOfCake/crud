...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbfe66dd10dc_tree')) { function _lbfe66dd10dc_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb68509b4ec5_content')) { function _lb68509b4ec5_content($_l, $_args) { extract($_args)
?><div id="content">
