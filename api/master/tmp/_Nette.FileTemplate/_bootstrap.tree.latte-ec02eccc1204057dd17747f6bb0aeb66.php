...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb3f91678821_tree')) { function _lb3f91678821_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb515d42563d_content')) { function _lb515d42563d_content($_l, $_args) { extract($_args)
?><div id="content">
