...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb0e6833e9df_tree')) { function _lb0e6833e9df_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6eeeef1c55_content')) { function _lb6eeeef1c55_content($_l, $_args) { extract($_args)
?><div id="content">
