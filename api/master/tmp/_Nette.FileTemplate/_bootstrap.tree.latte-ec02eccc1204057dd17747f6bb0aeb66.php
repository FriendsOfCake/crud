...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbe4e4d91aa8_tree')) { function _lbe4e4d91aa8_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba7ea234079_content')) { function _lba7ea234079_content($_l, $_args) { extract($_args)
?><div id="content">
