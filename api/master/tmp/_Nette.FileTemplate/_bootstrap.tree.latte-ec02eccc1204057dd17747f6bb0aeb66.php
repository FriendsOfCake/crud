...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb1935edc70c_tree')) { function _lb1935edc70c_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0da328718b_content')) { function _lb0da328718b_content($_l, $_args) { extract($_args)
?><div id="content">
