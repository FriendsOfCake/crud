...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbc5603c0592_tree')) { function _lbc5603c0592_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4a133e4405_content')) { function _lb4a133e4405_content($_l, $_args) { extract($_args)
?><div id="content">
