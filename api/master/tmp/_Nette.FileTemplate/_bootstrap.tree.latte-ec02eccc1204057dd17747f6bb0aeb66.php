...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb451a5bcb9f_tree')) { function _lb451a5bcb9f_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb258f9764fb_content')) { function _lb258f9764fb_content($_l, $_args) { extract($_args)
?><div id="content">
