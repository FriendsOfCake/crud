...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbdef6a39385_tree')) { function _lbdef6a39385_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2855c74929_content')) { function _lb2855c74929_content($_l, $_args) { extract($_args)
?><div id="content">
