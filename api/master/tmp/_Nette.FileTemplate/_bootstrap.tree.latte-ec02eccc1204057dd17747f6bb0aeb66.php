...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb45dfd97cc1_tree')) { function _lb45dfd97cc1_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb64589e82c6_content')) { function _lb64589e82c6_content($_l, $_args) { extract($_args)
?><div id="content">
