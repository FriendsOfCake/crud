...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb7db030409e_tree')) { function _lb7db030409e_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbec2c2ecb4b_content')) { function _lbec2c2ecb4b_content($_l, $_args) { extract($_args)
?><div id="content">
