...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbd1581dfc6d_tree')) { function _lbd1581dfc6d_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb871f782d47_content')) { function _lb871f782d47_content($_l, $_args) { extract($_args)
?><div id="content">
