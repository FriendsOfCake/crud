...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbb01b725452_tree')) { function _lbb01b725452_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1aed30e8bb_content')) { function _lb1aed30e8bb_content($_l, $_args) { extract($_args)
?><div id="content">
