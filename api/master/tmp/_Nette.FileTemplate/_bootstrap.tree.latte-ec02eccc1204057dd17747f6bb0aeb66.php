...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbdec0172c98_tree')) { function _lbdec0172c98_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd485b6e54a_content')) { function _lbd485b6e54a_content($_l, $_args) { extract($_args)
?><div id="content">
