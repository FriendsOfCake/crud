...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb2ed653814c_tree')) { function _lb2ed653814c_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7af5141cad_content')) { function _lb7af5141cad_content($_l, $_args) { extract($_args)
?><div id="content">
