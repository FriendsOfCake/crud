...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb38523e8fd9_tree')) { function _lb38523e8fd9_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8d2a68996a_content')) { function _lb8d2a68996a_content($_l, $_args) { extract($_args)
?><div id="content">
