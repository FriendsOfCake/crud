...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb2b69b96620_tree')) { function _lb2b69b96620_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbca21829c7c_content')) { function _lbca21829c7c_content($_l, $_args) { extract($_args)
?><div id="content">
