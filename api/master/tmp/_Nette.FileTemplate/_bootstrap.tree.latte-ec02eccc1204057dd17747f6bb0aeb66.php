...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbb0d99d1782_tree')) { function _lbb0d99d1782_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4dc186217f_content')) { function _lb4dc186217f_content($_l, $_args) { extract($_args)
?><div id="content">
