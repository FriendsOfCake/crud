...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb285a4a2bf1_tree')) { function _lb285a4a2bf1_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc09f4e844b_content')) { function _lbc09f4e844b_content($_l, $_args) { extract($_args)
?><div id="content">
