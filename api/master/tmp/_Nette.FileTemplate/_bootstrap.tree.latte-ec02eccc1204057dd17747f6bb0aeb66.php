...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbd2e00a4853_tree')) { function _lbd2e00a4853_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe16242fe55_content')) { function _lbe16242fe55_content($_l, $_args) { extract($_args)
?><div id="content">
