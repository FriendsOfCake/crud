...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb6343e896bf_tree')) { function _lb6343e896bf_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb23c9dce843_content')) { function _lb23c9dce843_content($_l, $_args) { extract($_args)
?><div id="content">
