...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb10e5d4f9ac_tree')) { function _lb10e5d4f9ac_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe9feb8e30e_content')) { function _lbe9feb8e30e_content($_l, $_args) { extract($_args)
?><div id="content">
