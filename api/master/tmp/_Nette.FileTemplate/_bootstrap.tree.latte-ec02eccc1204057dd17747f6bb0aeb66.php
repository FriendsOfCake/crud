...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbd408e662fd_tree')) { function _lbd408e662fd_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb760b0db58e_content')) { function _lb760b0db58e_content($_l, $_args) { extract($_args)
?><div id="content">
