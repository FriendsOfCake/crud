...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb0b65ced56c_tree')) { function _lb0b65ced56c_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9e0617997c_content')) { function _lb9e0617997c_content($_l, $_args) { extract($_args)
?><div id="content">
