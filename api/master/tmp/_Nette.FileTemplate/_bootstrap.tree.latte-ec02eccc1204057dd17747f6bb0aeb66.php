...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbff1880a391_tree')) { function _lbff1880a391_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbec928b55de_content')) { function _lbec928b55de_content($_l, $_args) { extract($_args)
?><div id="content">
