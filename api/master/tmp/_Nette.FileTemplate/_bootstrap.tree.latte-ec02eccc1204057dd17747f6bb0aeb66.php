...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbf9cd04ed11_tree')) { function _lbf9cd04ed11_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2d14e95081_content')) { function _lb2d14e95081_content($_l, $_args) { extract($_args)
?><div id="content">
