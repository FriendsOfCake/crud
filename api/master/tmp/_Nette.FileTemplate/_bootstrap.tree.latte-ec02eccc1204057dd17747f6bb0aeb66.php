...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lba6247a2a84_tree')) { function _lba6247a2a84_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2e1d954cb6_content')) { function _lb2e1d954cb6_content($_l, $_args) { extract($_args)
?><div id="content">
