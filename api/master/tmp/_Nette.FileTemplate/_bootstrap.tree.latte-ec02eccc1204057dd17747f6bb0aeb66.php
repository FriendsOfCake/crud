...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb9117b364b6_tree')) { function _lb9117b364b6_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd0e9777458_content')) { function _lbd0e9777458_content($_l, $_args) { extract($_args)
?><div id="content">
