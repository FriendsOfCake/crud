...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbd362e973b6_tree')) { function _lbd362e973b6_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe471a09d64_content')) { function _lbe471a09d64_content($_l, $_args) { extract($_args)
?><div id="content">
