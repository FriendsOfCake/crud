...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb7110df5b16_tree')) { function _lb7110df5b16_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb48cf5a6f53_content')) { function _lb48cf5a6f53_content($_l, $_args) { extract($_args)
?><div id="content">
