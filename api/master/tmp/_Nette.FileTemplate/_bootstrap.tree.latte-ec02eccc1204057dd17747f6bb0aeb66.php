...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbe881660a67_tree')) { function _lbe881660a67_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb45fd3f7195_content')) { function _lb45fd3f7195_content($_l, $_args) { extract($_args)
?><div id="content">
