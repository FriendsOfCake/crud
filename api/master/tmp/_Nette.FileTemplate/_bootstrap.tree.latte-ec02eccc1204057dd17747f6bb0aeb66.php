...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbc289796773_tree')) { function _lbc289796773_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9f3dbb5c00_content')) { function _lb9f3dbb5c00_content($_l, $_args) { extract($_args)
?><div id="content">
