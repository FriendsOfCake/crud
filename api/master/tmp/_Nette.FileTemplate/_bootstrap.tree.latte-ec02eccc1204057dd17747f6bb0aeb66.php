...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb79588d4e46_tree')) { function _lb79588d4e46_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe31de35201_content')) { function _lbe31de35201_content($_l, $_args) { extract($_args)
?><div id="content">
