...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbe29200cf6b_tree')) { function _lbe29200cf6b_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb07f46f430c_content')) { function _lb07f46f430c_content($_l, $_args) { extract($_args)
?><div id="content">
