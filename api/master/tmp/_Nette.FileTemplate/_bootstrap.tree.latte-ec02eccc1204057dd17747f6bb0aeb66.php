...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb80b94878ce_tree')) { function _lb80b94878ce_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0a326405ab_content')) { function _lb0a326405ab_content($_l, $_args) { extract($_args)
?><div id="content">
