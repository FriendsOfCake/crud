...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbfe49be36ac_tree')) { function _lbfe49be36ac_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf6c762087b_content')) { function _lbf6c762087b_content($_l, $_args) { extract($_args)
?><div id="content">
