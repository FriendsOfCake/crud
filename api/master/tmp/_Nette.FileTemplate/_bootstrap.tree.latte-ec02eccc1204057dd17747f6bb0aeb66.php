...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb492ae166de_tree')) { function _lb492ae166de_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8a111caeec_content')) { function _lb8a111caeec_content($_l, $_args) { extract($_args)
?><div id="content">
