...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb3a99055821_tree')) { function _lb3a99055821_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb72be9283a4_content')) { function _lb72be9283a4_content($_l, $_args) { extract($_args)
?><div id="content">
