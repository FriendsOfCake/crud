...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb9ab39c0575_tree')) { function _lb9ab39c0575_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9d8ba9bb7b_content')) { function _lb9d8ba9bb7b_content($_l, $_args) { extract($_args)
?><div id="content">
