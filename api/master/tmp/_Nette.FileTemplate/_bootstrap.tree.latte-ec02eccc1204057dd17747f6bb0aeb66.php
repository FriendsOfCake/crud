...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lba5b43717a2_tree')) { function _lba5b43717a2_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7d2dc00984_content')) { function _lb7d2dc00984_content($_l, $_args) { extract($_args)
?><div id="content">
