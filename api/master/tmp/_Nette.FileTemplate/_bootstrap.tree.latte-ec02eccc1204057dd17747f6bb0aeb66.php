...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb479a5cbf99_tree')) { function _lb479a5cbf99_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7d7f1cbf25_content')) { function _lb7d7f1cbf25_content($_l, $_args) { extract($_args)
?><div id="content">
