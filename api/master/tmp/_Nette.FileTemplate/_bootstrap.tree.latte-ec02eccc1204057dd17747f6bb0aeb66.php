...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lba617d41620_tree')) { function _lba617d41620_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3932533a48_content')) { function _lb3932533a48_content($_l, $_args) { extract($_args)
?><div id="content">
