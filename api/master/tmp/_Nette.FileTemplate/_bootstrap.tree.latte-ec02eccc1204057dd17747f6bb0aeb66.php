...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbdc6841c3e8_tree')) { function _lbdc6841c3e8_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9fba0d9772_content')) { function _lb9fba0d9772_content($_l, $_args) { extract($_args)
?><div id="content">
