...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbe3e34e8855_tree')) { function _lbe3e34e8855_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9d7fbe5757_content')) { function _lb9d7fbe5757_content($_l, $_args) { extract($_args)
?><div id="content">
