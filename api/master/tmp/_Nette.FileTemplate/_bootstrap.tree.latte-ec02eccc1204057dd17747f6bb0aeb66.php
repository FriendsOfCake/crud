...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb4a4b8d3645_tree')) { function _lb4a4b8d3645_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4e67cb8123_content')) { function _lb4e67cb8123_content($_l, $_args) { extract($_args)
?><div id="content">
