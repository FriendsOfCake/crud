...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lba33608dac1_tree')) { function _lba33608dac1_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb02a52d3a43_content')) { function _lb02a52d3a43_content($_l, $_args) { extract($_args)
?><div id="content">
