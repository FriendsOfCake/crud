...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb4a753d7d9e_tree')) { function _lb4a753d7d9e_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1d9dab202d_content')) { function _lb1d9dab202d_content($_l, $_args) { extract($_args)
?><div id="content">
