...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb8ec2f5568f_tree')) { function _lb8ec2f5568f_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd6c5421095_content')) { function _lbd6c5421095_content($_l, $_args) { extract($_args)
?><div id="content">
