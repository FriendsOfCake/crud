...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb88771fe98c_tree')) { function _lb88771fe98c_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd7b7be06c8_content')) { function _lbd7b7be06c8_content($_l, $_args) { extract($_args)
?><div id="content">
