...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbdb53e957a6_tree')) { function _lbdb53e957a6_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb608be3d9a6_content')) { function _lb608be3d9a6_content($_l, $_args) { extract($_args)
?><div id="content">
