...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb3acc710425_tree')) { function _lb3acc710425_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9f7e10f52f_content')) { function _lb9f7e10f52f_content($_l, $_args) { extract($_args)
?><div id="content">
