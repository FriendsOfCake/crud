...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb19917efc02_tree')) { function _lb19917efc02_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb62ad52f8a1_content')) { function _lb62ad52f8a1_content($_l, $_args) { extract($_args)
?><div id="content">
