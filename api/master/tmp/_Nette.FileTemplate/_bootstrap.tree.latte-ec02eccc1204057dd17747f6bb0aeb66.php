...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb42377a950d_tree')) { function _lb42377a950d_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb035381694c_content')) { function _lb035381694c_content($_l, $_args) { extract($_args)
?><div id="content">
