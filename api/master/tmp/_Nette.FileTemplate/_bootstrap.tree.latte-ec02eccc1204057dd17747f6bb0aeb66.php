...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb2824202333_tree')) { function _lb2824202333_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb630c839d5d_content')) { function _lb630c839d5d_content($_l, $_args) { extract($_args)
?><div id="content">
