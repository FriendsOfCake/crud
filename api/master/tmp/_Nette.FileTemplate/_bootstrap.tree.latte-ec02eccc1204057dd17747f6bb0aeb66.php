...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb9a1f0da276_tree')) { function _lb9a1f0da276_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbebb91781e8_content')) { function _lbebb91781e8_content($_l, $_args) { extract($_args)
?><div id="content">
