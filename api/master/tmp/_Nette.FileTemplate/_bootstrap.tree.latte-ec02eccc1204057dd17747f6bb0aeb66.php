...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbdb9c04fd6d_tree')) { function _lbdb9c04fd6d_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0033af1e14_content')) { function _lb0033af1e14_content($_l, $_args) { extract($_args)
?><div id="content">
