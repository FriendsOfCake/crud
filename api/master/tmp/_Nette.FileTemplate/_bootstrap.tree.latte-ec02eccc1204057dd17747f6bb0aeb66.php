...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbf6e60a0708_tree')) { function _lbf6e60a0708_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb13b916cfdf_content')) { function _lb13b916cfdf_content($_l, $_args) { extract($_args)
?><div id="content">
