...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb7cac8d61a4_tree')) { function _lb7cac8d61a4_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9476fb1924_content')) { function _lb9476fb1924_content($_l, $_args) { extract($_args)
?><div id="content">
