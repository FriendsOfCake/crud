...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb12acbb961f_tree')) { function _lb12acbb961f_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbaf714831ac_content')) { function _lbaf714831ac_content($_l, $_args) { extract($_args)
?><div id="content">
