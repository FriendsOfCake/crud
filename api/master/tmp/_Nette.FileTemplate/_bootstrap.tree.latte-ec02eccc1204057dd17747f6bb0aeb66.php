...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb167cf5a4a6_tree')) { function _lb167cf5a4a6_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdb8661e183_content')) { function _lbdb8661e183_content($_l, $_args) { extract($_args)
?><div id="content">
