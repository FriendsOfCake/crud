...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb027cf2bfa4_tree')) { function _lb027cf2bfa4_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1454537a07_content')) { function _lb1454537a07_content($_l, $_args) { extract($_args)
?><div id="content">
