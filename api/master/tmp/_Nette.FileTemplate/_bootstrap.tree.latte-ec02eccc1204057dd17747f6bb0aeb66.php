...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb02870ae446_tree')) { function _lb02870ae446_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbabf5add0de_content')) { function _lbabf5add0de_content($_l, $_args) { extract($_args)
?><div id="content">
