...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb7ccfeda4fd_tree')) { function _lb7ccfeda4fd_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf3b33e015d_content')) { function _lbf3b33e015d_content($_l, $_args) { extract($_args)
?><div id="content">
