...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbbf723f8260_tree')) { function _lbbf723f8260_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd94d4b1913_content')) { function _lbd94d4b1913_content($_l, $_args) { extract($_args)
?><div id="content">
