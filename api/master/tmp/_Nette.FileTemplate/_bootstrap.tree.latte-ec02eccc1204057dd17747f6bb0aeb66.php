...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbad6487d5ef_tree')) { function _lbad6487d5ef_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbef94a79920_content')) { function _lbef94a79920_content($_l, $_args) { extract($_args)
?><div id="content">
