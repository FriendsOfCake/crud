...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb3a2f086458_tree')) { function _lb3a2f086458_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbabcafcfb78_content')) { function _lbabcafcfb78_content($_l, $_args) { extract($_args)
?><div id="content">
