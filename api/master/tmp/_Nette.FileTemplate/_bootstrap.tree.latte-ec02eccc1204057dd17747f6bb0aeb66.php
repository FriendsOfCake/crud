...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb0e197ff9f8_tree')) { function _lb0e197ff9f8_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb078ba0ec9c_content')) { function _lb078ba0ec9c_content($_l, $_args) { extract($_args)
?><div id="content">
