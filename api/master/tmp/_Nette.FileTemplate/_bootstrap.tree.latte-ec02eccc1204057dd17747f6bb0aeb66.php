...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbc50b76dd7b_tree')) { function _lbc50b76dd7b_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7624e3608b_content')) { function _lb7624e3608b_content($_l, $_args) { extract($_args)
?><div id="content">
