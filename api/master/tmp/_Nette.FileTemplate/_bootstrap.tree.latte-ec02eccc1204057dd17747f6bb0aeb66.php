...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbc6213e3919_tree')) { function _lbc6213e3919_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb798678a0be_content')) { function _lb798678a0be_content($_l, $_args) { extract($_args)
?><div id="content">
