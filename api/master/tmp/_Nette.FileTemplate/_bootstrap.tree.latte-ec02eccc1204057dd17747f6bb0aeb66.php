...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb26e346ef29_tree')) { function _lb26e346ef29_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7ca03ceab5_content')) { function _lb7ca03ceab5_content($_l, $_args) { extract($_args)
?><div id="content">
