...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb4653bf8608_tree')) { function _lb4653bf8608_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbff91523f93_content')) { function _lbff91523f93_content($_l, $_args) { extract($_args)
?><div id="content">
