...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb6cc9d1ec9c_tree')) { function _lb6cc9d1ec9c_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4e92aa4e7c_content')) { function _lb4e92aa4e7c_content($_l, $_args) { extract($_args)
?><div id="content">
