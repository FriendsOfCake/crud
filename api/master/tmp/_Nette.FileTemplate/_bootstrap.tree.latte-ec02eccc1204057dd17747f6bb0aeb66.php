...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbc532b3f6f8_tree')) { function _lbc532b3f6f8_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc67724d2bd_content')) { function _lbc67724d2bd_content($_l, $_args) { extract($_args)
?><div id="content">
