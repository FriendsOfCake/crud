...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb666e88b8c4_tree')) { function _lb666e88b8c4_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbddfd5b71bb_content')) { function _lbddfd5b71bb_content($_l, $_args) { extract($_args)
?><div id="content">
