...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb5480eb5c56_tree')) { function _lb5480eb5c56_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbad7438bc88_content')) { function _lbad7438bc88_content($_l, $_args) { extract($_args)
?><div id="content">
