...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb1d83463386_tree')) { function _lb1d83463386_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2d8a58cc50_content')) { function _lb2d8a58cc50_content($_l, $_args) { extract($_args)
?><div id="content">
