...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb3bf5fac654_tree')) { function _lb3bf5fac654_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb357a3c618_content')) { function _lbb357a3c618_content($_l, $_args) { extract($_args)
?><div id="content">
