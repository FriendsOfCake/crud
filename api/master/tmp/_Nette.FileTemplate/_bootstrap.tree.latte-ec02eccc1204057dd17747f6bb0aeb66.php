...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb5475741cfc_tree')) { function _lb5475741cfc_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb68cf195043_content')) { function _lb68cf195043_content($_l, $_args) { extract($_args)
?><div id="content">
