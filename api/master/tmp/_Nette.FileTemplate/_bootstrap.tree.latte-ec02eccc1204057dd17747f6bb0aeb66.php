...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb1c9f6cba4a_tree')) { function _lb1c9f6cba4a_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe1f6908e12_content')) { function _lbe1f6908e12_content($_l, $_args) { extract($_args)
?><div id="content">
