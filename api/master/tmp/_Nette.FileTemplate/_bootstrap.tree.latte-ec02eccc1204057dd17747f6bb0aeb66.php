...
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, '9pnorxkzlw')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lbda20bd7ec0_title')) { function _lbda20bd7ec0_title($_l, $_args) { extract($_args)
?>Tree<?php
}}
...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbfd5efa7310_tree')) { function _lbfd5efa7310_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5887d5c414_content')) { function _lb5887d5c414_content($_l, $_args) { extract($_args)
?><div id="content">
