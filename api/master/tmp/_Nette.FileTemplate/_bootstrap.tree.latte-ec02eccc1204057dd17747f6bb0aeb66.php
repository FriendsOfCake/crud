...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb6a86265f65_tree')) { function _lb6a86265f65_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb865adc1ac4_content')) { function _lb865adc1ac4_content($_l, $_args) { extract($_args)
?><div id="content">
