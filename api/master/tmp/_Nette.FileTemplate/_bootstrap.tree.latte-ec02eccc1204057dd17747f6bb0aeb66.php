...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb6f362b8dc2_tree')) { function _lb6f362b8dc2_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb980f762801_content')) { function _lb980f762801_content($_l, $_args) { extract($_args)
?><div id="content">
