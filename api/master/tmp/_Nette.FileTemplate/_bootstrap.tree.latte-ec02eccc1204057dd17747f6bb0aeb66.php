...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb643cace2bf_tree')) { function _lb643cace2bf_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb118867b062_content')) { function _lb118867b062_content($_l, $_args) { extract($_args)
?><div id="content">
