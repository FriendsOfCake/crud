...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb09872db268_tree')) { function _lb09872db268_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc54e87087d_content')) { function _lbc54e87087d_content($_l, $_args) { extract($_args)
?><div id="content">
