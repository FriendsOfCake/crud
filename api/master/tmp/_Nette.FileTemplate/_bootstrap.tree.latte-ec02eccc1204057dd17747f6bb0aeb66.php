...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb5446cedd2e_tree')) { function _lb5446cedd2e_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba27155b08a_content')) { function _lba27155b08a_content($_l, $_args) { extract($_args)
?><div id="content">
