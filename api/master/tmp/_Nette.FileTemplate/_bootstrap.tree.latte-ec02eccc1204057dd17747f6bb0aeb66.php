...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb6dba34790b_tree')) { function _lb6dba34790b_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb04c06b7723_content')) { function _lb04c06b7723_content($_l, $_args) { extract($_args)
?><div id="content">
