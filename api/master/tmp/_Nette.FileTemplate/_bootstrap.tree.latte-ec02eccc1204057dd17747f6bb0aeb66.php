...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbf270ddfd05_tree')) { function _lbf270ddfd05_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd3265ef780_content')) { function _lbd3265ef780_content($_l, $_args) { extract($_args)
?><div id="content">
