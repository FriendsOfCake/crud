...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb0a74cf82a9_tree')) { function _lb0a74cf82a9_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbffe3778641_content')) { function _lbffe3778641_content($_l, $_args) { extract($_args)
?><div id="content">
