...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbcd16cccd16_tree')) { function _lbcd16cccd16_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb72b58bce2e_content')) { function _lb72b58bce2e_content($_l, $_args) { extract($_args)
?><div id="content">
