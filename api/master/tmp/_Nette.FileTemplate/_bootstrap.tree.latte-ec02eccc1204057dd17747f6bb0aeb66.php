...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb578808f858_tree')) { function _lb578808f858_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0812577d66_content')) { function _lb0812577d66_content($_l, $_args) { extract($_args)
?><div id="content">
