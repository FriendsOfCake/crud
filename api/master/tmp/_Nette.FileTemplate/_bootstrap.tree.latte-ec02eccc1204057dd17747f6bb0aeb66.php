...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbdef91a8c6d_tree')) { function _lbdef91a8c6d_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdd1cc5b420_content')) { function _lbdd1cc5b420_content($_l, $_args) { extract($_args)
?><div id="content">
