...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb5c9fdc6ea1_tree')) { function _lb5c9fdc6ea1_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba19e961828_content')) { function _lba19e961828_content($_l, $_args) { extract($_args)
?><div id="content">
