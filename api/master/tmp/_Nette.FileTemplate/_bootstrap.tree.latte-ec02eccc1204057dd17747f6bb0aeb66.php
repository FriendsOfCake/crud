...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb65f6bbbe92_tree')) { function _lb65f6bbbe92_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb78af2a2c5f_content')) { function _lb78af2a2c5f_content($_l, $_args) { extract($_args)
?><div id="content">
