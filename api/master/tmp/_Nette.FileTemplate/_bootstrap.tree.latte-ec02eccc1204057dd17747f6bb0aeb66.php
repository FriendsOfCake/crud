...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbfd95a63a49_tree')) { function _lbfd95a63a49_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf39f222564_content')) { function _lbf39f222564_content($_l, $_args) { extract($_args)
?><div id="content">
