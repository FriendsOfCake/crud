...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb3b7ba925b8_tree')) { function _lb3b7ba925b8_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6a301d569b_content')) { function _lb6a301d569b_content($_l, $_args) { extract($_args)
?><div id="content">
