...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb32ce4edde9_tree')) { function _lb32ce4edde9_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb95f79d597a_content')) { function _lb95f79d597a_content($_l, $_args) { extract($_args)
?><div id="content">
