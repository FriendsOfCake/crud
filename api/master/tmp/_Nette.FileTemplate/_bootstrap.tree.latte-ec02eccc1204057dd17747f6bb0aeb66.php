...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb86b8c2f312_tree')) { function _lb86b8c2f312_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb028da6ed9_content')) { function _lbb028da6ed9_content($_l, $_args) { extract($_args)
?><div id="content">
