...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb8c3eaf59e3_tree')) { function _lb8c3eaf59e3_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3502fe8b6e_content')) { function _lb3502fe8b6e_content($_l, $_args) { extract($_args)
?><div id="content">
