...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbb18bc4d94c_tree')) { function _lbb18bc4d94c_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbefc2fe6463_content')) { function _lbefc2fe6463_content($_l, $_args) { extract($_args)
?><div id="content">
