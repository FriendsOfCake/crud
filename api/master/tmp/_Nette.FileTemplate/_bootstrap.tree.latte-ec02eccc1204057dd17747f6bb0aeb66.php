...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbd1994dd7b4_tree')) { function _lbd1994dd7b4_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd2f90266ef_content')) { function _lbd2f90266ef_content($_l, $_args) { extract($_args)
?><div id="content">
