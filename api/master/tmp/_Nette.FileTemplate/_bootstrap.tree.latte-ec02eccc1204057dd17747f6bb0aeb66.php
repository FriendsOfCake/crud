...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb1c4e3cdcd0_tree')) { function _lb1c4e3cdcd0_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb12ced6c0b3_content')) { function _lb12ced6c0b3_content($_l, $_args) { extract($_args)
?><div id="content">
