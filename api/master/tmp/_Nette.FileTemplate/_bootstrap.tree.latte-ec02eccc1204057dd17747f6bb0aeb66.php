...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbc45a07e664_tree')) { function _lbc45a07e664_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb7f1084c20_content')) { function _lbb7f1084c20_content($_l, $_args) { extract($_args)
?><div id="content">
