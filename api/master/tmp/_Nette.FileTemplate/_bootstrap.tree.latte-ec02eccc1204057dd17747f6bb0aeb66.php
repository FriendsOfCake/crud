...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb101c0828fc_tree')) { function _lb101c0828fc_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb114f8c3b70_content')) { function _lb114f8c3b70_content($_l, $_args) { extract($_args)
?><div id="content">
