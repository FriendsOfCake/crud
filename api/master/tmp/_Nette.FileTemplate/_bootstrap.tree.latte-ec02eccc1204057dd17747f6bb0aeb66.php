...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb199acf7d29_tree')) { function _lb199acf7d29_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6a9f0698f4_content')) { function _lb6a9f0698f4_content($_l, $_args) { extract($_args)
?><div id="content">
