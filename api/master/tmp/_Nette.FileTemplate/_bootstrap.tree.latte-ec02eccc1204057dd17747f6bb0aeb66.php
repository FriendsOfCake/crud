...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb73034f308b_tree')) { function _lb73034f308b_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe978e24a8f_content')) { function _lbe978e24a8f_content($_l, $_args) { extract($_args)
?><div id="content">
