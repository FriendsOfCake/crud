...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb36bec625ed_tree')) { function _lb36bec625ed_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc73e5bca39_content')) { function _lbc73e5bca39_content($_l, $_args) { extract($_args)
?><div id="content">
