...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbeea0493f6b_tree')) { function _lbeea0493f6b_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6d97713573_content')) { function _lb6d97713573_content($_l, $_args) { extract($_args)
?><div id="content">
