...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb33e87482da_tree')) { function _lb33e87482da_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0b484cd6de_content')) { function _lb0b484cd6de_content($_l, $_args) { extract($_args)
?><div id="content">
