...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb0f0c19c472_tree')) { function _lb0f0c19c472_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc38cdb31d0_content')) { function _lbc38cdb31d0_content($_l, $_args) { extract($_args)
?><div id="content">
