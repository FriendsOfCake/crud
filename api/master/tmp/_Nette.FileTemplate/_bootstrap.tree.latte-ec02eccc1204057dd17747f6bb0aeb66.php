...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbcb7665a13d_tree')) { function _lbcb7665a13d_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc641ca931c_content')) { function _lbc641ca931c_content($_l, $_args) { extract($_args)
?><div id="content">
