...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbc40f485ae9_tree')) { function _lbc40f485ae9_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd843eb1721_content')) { function _lbd843eb1721_content($_l, $_args) { extract($_args)
?><div id="content">
