...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbe6bd78f8f1_tree')) { function _lbe6bd78f8f1_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb41272568ef_content')) { function _lb41272568ef_content($_l, $_args) { extract($_args)
?><div id="content">
