...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lba3c0cb55a6_tree')) { function _lba3c0cb55a6_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb46e57ebcf3_content')) { function _lb46e57ebcf3_content($_l, $_args) { extract($_args)
?><div id="content">
