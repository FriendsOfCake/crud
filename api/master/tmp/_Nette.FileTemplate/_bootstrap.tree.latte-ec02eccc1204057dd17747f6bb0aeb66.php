...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbccacaba211_tree')) { function _lbccacaba211_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8cd2883d16_content')) { function _lb8cd2883d16_content($_l, $_args) { extract($_args)
?><div id="content">
