...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb1d237f5bf1_tree')) { function _lb1d237f5bf1_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd4ad4853d9_content')) { function _lbd4ad4853d9_content($_l, $_args) { extract($_args)
?><div id="content">
