...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb86a2c76e47_tree')) { function _lb86a2c76e47_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0bcacc149c_content')) { function _lb0bcacc149c_content($_l, $_args) { extract($_args)
?><div id="content">
