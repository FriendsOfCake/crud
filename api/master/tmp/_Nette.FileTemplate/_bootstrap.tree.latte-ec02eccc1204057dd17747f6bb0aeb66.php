...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb0b41f8f6a0_tree')) { function _lb0b41f8f6a0_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd07eb357c3_content')) { function _lbd07eb357c3_content($_l, $_args) { extract($_args)
?><div id="content">
