...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb41e427ef0c_tree')) { function _lb41e427ef0c_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb85b725089b_content')) { function _lb85b725089b_content($_l, $_args) { extract($_args)
?><div id="content">
