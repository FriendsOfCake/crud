...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb6a4c7c6cc2_tree')) { function _lb6a4c7c6cc2_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbab8c6444ff_content')) { function _lbab8c6444ff_content($_l, $_args) { extract($_args)
?><div id="content">
