...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb4d9d197b77_tree')) { function _lb4d9d197b77_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbff21b8da46_content')) { function _lbff21b8da46_content($_l, $_args) { extract($_args)
?><div id="content">
