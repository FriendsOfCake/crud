...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb04cd7df732_tree')) { function _lb04cd7df732_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2e7e7c8e20_content')) { function _lb2e7e7c8e20_content($_l, $_args) { extract($_args)
?><div id="content">
