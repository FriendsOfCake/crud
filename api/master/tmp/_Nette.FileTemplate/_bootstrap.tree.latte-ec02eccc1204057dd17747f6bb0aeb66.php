...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lba83c41cbdc_tree')) { function _lba83c41cbdc_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2c6249930d_content')) { function _lb2c6249930d_content($_l, $_args) { extract($_args)
?><div id="content">
