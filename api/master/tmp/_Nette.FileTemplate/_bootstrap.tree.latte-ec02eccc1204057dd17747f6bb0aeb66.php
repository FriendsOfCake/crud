...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb634ba6e78c_tree')) { function _lb634ba6e78c_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0d965e032d_content')) { function _lb0d965e032d_content($_l, $_args) { extract($_args)
?><div id="content">
