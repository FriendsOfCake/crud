...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbbafffc8b6c_tree')) { function _lbbafffc8b6c_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3c7f10109e_content')) { function _lb3c7f10109e_content($_l, $_args) { extract($_args)
?><div id="content">
