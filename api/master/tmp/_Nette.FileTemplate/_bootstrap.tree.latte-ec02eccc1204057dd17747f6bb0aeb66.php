...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb0ff0976447_tree')) { function _lb0ff0976447_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc5351cd34f_content')) { function _lbc5351cd34f_content($_l, $_args) { extract($_args)
?><div id="content">
