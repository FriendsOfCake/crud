...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb2d231b1963_tree')) { function _lb2d231b1963_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9514da7460_content')) { function _lb9514da7460_content($_l, $_args) { extract($_args)
?><div id="content">
