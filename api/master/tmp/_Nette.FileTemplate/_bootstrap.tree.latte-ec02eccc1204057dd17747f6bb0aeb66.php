...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbe4675aa310_tree')) { function _lbe4675aa310_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5b1be49290_content')) { function _lb5b1be49290_content($_l, $_args) { extract($_args)
?><div id="content">
