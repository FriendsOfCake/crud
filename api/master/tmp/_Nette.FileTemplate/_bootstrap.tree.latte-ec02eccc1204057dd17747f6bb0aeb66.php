...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb0040419c1f_tree')) { function _lb0040419c1f_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbad16c6f7b7_content')) { function _lbad16c6f7b7_content($_l, $_args) { extract($_args)
?><div id="content">
