...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb603e4ae558_tree')) { function _lb603e4ae558_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb1374e3444_content')) { function _lbb1374e3444_content($_l, $_args) { extract($_args)
?><div id="content">
