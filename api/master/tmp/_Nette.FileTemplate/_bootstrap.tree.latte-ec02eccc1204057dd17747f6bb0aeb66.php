...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbbb0e40953b_tree')) { function _lbbb0e40953b_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe665b7a4a2_content')) { function _lbe665b7a4a2_content($_l, $_args) { extract($_args)
?><div id="content">
