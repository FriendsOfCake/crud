...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb6a71e1d340_tree')) { function _lb6a71e1d340_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf97d6a6ae2_content')) { function _lbf97d6a6ae2_content($_l, $_args) { extract($_args)
?><div id="content">
