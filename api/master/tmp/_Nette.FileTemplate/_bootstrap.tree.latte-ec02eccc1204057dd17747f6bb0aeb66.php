...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb31f6baff42_tree')) { function _lb31f6baff42_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb818febbb78_content')) { function _lb818febbb78_content($_l, $_args) { extract($_args)
?><div id="content">
