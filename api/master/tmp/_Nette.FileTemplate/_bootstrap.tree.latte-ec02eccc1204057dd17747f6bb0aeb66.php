...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb743db4ef02_tree')) { function _lb743db4ef02_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb82ff8c63ce_content')) { function _lb82ff8c63ce_content($_l, $_args) { extract($_args)
?><div id="content">
