...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbf996850cfe_tree')) { function _lbf996850cfe_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb222e81cb5_content')) { function _lbb222e81cb5_content($_l, $_args) { extract($_args)
?><div id="content">
