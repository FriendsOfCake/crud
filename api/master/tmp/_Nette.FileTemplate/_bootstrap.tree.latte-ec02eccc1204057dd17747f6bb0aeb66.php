...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb27fb25ae8d_tree')) { function _lb27fb25ae8d_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5d228f700b_content')) { function _lb5d228f700b_content($_l, $_args) { extract($_args)
?><div id="content">
