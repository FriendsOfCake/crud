...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb5cf5ecd576_tree')) { function _lb5cf5ecd576_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbcb9245b69a_content')) { function _lbcb9245b69a_content($_l, $_args) { extract($_args)
?><div id="content">
