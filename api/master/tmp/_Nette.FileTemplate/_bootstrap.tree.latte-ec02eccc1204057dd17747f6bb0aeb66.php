...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb9e8957d15c_tree')) { function _lb9e8957d15c_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9b1046b19a_content')) { function _lb9b1046b19a_content($_l, $_args) { extract($_args)
?><div id="content">
