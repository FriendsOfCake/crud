...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb77700679b9_tree')) { function _lb77700679b9_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb12f2d09aa1_content')) { function _lb12f2d09aa1_content($_l, $_args) { extract($_args)
?><div id="content">
