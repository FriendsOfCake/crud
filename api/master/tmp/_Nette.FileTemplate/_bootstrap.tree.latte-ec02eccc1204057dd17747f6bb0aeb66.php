...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb99738cfb8b_tree')) { function _lb99738cfb8b_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe2b1aacdaa_content')) { function _lbe2b1aacdaa_content($_l, $_args) { extract($_args)
?><div id="content">
