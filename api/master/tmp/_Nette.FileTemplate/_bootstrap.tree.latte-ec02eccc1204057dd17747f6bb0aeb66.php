...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbffebff333c_tree')) { function _lbffebff333c_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb33ecc7ceaf_content')) { function _lb33ecc7ceaf_content($_l, $_args) { extract($_args)
?><div id="content">
