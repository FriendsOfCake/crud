...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb95f9293acb_tree')) { function _lb95f9293acb_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5249536aad_content')) { function _lb5249536aad_content($_l, $_args) { extract($_args)
?><div id="content">
