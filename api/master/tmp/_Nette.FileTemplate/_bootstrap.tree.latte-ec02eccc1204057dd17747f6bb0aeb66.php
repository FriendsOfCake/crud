...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb2936cf4da3_tree')) { function _lb2936cf4da3_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb7f3a746dc_content')) { function _lbb7f3a746dc_content($_l, $_args) { extract($_args)
?><div id="content">
