...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb3bb549b2c0_tree')) { function _lb3bb549b2c0_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb5acc6f0fd_content')) { function _lbb5acc6f0fd_content($_l, $_args) { extract($_args)
?><div id="content">
