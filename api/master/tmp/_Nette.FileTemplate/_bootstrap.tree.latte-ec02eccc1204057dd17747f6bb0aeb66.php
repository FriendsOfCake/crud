...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbf9d167723d_tree')) { function _lbf9d167723d_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb496f31b921_content')) { function _lb496f31b921_content($_l, $_args) { extract($_args)
?><div id="content">
