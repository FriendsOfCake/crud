...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb1f46dffc1f_tree')) { function _lb1f46dffc1f_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb38f6100bb3_content')) { function _lb38f6100bb3_content($_l, $_args) { extract($_args)
?><div id="content">
