...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbb9d1debec1_tree')) { function _lbb9d1debec1_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba9ccf8bd32_content')) { function _lba9ccf8bd32_content($_l, $_args) { extract($_args)
?><div id="content">
