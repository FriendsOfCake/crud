...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb68913a573d_tree')) { function _lb68913a573d_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc655ee9832_content')) { function _lbc655ee9832_content($_l, $_args) { extract($_args)
?><div id="content">
