...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbb10a4deb5a_tree')) { function _lbb10a4deb5a_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4e96238b25_content')) { function _lb4e96238b25_content($_l, $_args) { extract($_args)
?><div id="content">
