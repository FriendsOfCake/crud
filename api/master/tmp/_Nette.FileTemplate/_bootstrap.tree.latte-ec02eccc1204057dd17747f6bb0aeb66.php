...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb47f34fcd98_tree')) { function _lb47f34fcd98_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb98d5308a4d_content')) { function _lb98d5308a4d_content($_l, $_args) { extract($_args)
?><div id="content">
