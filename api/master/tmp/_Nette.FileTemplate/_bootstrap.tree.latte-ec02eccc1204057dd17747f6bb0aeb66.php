...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb37d266ac04_tree')) { function _lb37d266ac04_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4e9350718a_content')) { function _lb4e9350718a_content($_l, $_args) { extract($_args)
?><div id="content">
