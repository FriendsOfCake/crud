...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbc0db8b1911_tree')) { function _lbc0db8b1911_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6eda7b9cb0_content')) { function _lb6eda7b9cb0_content($_l, $_args) { extract($_args)
?><div id="content">
