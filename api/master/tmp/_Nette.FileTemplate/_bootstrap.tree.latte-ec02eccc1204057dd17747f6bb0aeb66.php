...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbc3d5bd6ed7_tree')) { function _lbc3d5bd6ed7_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2280343deb_content')) { function _lb2280343deb_content($_l, $_args) { extract($_args)
?><div id="content">
