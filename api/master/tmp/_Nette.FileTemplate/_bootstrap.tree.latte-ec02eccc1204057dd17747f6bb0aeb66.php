...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb207d0edf6d_tree')) { function _lb207d0edf6d_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb153dbf8e7f_content')) { function _lb153dbf8e7f_content($_l, $_args) { extract($_args)
?><div id="content">
