...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbda03230791_tree')) { function _lbda03230791_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe45208cd3f_content')) { function _lbe45208cd3f_content($_l, $_args) { extract($_args)
?><div id="content">
