...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb6b908fa59d_tree')) { function _lb6b908fa59d_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0d5d787b2a_content')) { function _lb0d5d787b2a_content($_l, $_args) { extract($_args)
?><div id="content">
