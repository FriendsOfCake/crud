...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lbb224ff7386_tree')) { function _lbb224ff7386_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbcbf4372a6b_content')) { function _lbcbf4372a6b_content($_l, $_args) { extract($_args)
?><div id="content">
