...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb6cd1627426_tree')) { function _lb6cd1627426_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6dacb665b4_content')) { function _lb6dacb665b4_content($_l, $_args) { extract($_args)
?><div id="content">
