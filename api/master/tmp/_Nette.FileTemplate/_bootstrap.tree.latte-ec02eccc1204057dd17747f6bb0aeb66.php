...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb42952bcb98_tree')) { function _lb42952bcb98_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1406827394_content')) { function _lb1406827394_content($_l, $_args) { extract($_args)
?><div id="content">
