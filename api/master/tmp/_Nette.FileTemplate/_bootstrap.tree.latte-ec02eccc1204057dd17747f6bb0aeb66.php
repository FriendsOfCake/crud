...
// block tree
//
if (!function_exists($_l->blocks['tree'][] = '_lb721fe4de90_tree')) { function _lb721fe4de90_tree($_l, $_args) { extract($_args)
?><div class="tree">
	<ul>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb063db56530_content')) { function _lb063db56530_content($_l, $_args) { extract($_args)
?><div id="content">
