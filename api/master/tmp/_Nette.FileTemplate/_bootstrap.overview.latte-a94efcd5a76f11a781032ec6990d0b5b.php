...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9561775401_content')) { function _lb9561775401_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['20jvdwpm1b'])->render() ;endif ?>
</div>
<?php
}}
