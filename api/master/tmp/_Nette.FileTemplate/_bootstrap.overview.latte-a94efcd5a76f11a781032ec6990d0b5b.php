...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3e32a0c5ee_content')) { function _lb3e32a0c5ee_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['mcntjdpvnc'])->render() ;endif ?>
</div>
<?php
}}
