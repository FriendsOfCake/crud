...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbffbd3e97cc_content')) { function _lbffbd3e97cc_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['9lk56yqlvv'])->render() ;endif ?>
</div>
<?php
}}
