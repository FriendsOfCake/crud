...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbeef14aab0f_content')) { function _lbeef14aab0f_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['qrxt34m6ca'])->render() ;endif ?>
</div>
<?php
}}
