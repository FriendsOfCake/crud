...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4b8f82b1f8_content')) { function _lb4b8f82b1f8_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['cuvgrcz8ap'])->render() ;endif ?>
</div>
<?php
}}
