...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe35c4067d5_content')) { function _lbe35c4067d5_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['6gueucox2y'])->render() ;endif ?>
</div>
<?php
}}
