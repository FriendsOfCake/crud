...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba13211d58c_content')) { function _lba13211d58c_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['00vkvs5x90'])->render() ;endif ?>
</div>
<?php
}}
