...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6e15c93de6_content')) { function _lb6e15c93de6_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['j45xniq08f'])->render() ;endif ?>
</div>
<?php
}}
