...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbacf7bc70ae_content')) { function _lbacf7bc70ae_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['7qwdlsbku9'])->render() ;endif ?>
</div>
<?php
}}
