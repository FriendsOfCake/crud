...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb30888d7965_content')) { function _lb30888d7965_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ip6r8tsdna'])->render() ;endif ?>
</div>
<?php
}}
