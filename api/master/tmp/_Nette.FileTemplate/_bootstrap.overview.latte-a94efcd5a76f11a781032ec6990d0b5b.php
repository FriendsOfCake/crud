...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb406dd8827e_content')) { function _lb406dd8827e_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['20og7l1tr0'])->render() ;endif ?>
</div>
<?php
}}
