...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7dd22aa59c_content')) { function _lb7dd22aa59c_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['zgk9euhwrv'])->render() ;endif ?>
</div>
<?php
}}
