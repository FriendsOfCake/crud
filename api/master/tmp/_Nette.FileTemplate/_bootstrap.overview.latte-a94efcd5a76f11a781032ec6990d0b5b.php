...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb14b2ae3647_content')) { function _lb14b2ae3647_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['qsgvabhf8w'])->render() ;endif ?>
</div>
<?php
}}
