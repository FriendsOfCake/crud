...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb83d6ec56f9_content')) { function _lb83d6ec56f9_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['7dsb4kv7z5'])->render() ;endif ?>
</div>
<?php
}}
