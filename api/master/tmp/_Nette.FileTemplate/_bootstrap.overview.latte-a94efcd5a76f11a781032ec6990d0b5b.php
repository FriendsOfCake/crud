...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbecd5309e75_content')) { function _lbecd5309e75_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['92lnzgjx8v'])->render() ;endif ?>
</div>
<?php
}}
