...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe65a4afe4c_content')) { function _lbe65a4afe4c_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['rmugfgyv09'])->render() ;endif ?>
</div>
<?php
}}
