...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdea5b0afb5_content')) { function _lbdea5b0afb5_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ejc4w9dcxb'])->render() ;endif ?>
</div>
<?php
}}
