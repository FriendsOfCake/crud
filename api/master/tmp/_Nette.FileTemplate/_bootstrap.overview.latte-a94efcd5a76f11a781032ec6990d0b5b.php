...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb96b8baf0c_content')) { function _lbb96b8baf0c_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['qxd3fd9ep1'])->render() ;endif ?>
</div>
<?php
}}
