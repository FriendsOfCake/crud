...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb324ed9b98b_content')) { function _lb324ed9b98b_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['cyfe9887fn'])->render() ;endif ?>
</div>
<?php
}}
