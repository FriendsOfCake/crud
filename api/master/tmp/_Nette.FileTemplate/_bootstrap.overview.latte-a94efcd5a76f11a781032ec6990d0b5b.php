...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8bf9a1b866_content')) { function _lb8bf9a1b866_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['qpgckzhg11'])->render() ;endif ?>
</div>
<?php
}}
