...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb61921af9af_content')) { function _lb61921af9af_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['4ehjlfp790'])->render() ;endif ?>
</div>
<?php
}}
