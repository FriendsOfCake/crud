...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb03425c7b1_content')) { function _lbb03425c7b1_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['4rlnre595k'])->render() ;endif ?>
</div>
<?php
}}
