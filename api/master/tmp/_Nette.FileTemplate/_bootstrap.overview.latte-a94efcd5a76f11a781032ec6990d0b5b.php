...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb791e2bcb7_content')) { function _lbb791e2bcb7_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['0mm4il8ueb'])->render() ;endif ?>
</div>
<?php
}}
