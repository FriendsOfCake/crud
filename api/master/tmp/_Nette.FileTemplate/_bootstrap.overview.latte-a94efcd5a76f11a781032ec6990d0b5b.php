...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7e65a6940c_content')) { function _lb7e65a6940c_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['uf9yoa9b4i'])->render() ;endif ?>
</div>
<?php
}}
