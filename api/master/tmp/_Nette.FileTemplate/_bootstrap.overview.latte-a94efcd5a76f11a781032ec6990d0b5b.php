...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb37b08d8371_content')) { function _lb37b08d8371_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['o5ssy9rll1'])->render() ;endif ?>
</div>
<?php
}}
