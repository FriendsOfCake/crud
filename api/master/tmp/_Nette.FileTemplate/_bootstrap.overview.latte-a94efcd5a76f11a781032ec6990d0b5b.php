...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb401360b9be_content')) { function _lb401360b9be_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['fabvom1xoc'])->render() ;endif ?>
</div>
<?php
}}
