...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb52c823e529_content')) { function _lb52c823e529_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['5rqp6a9oxx'])->render() ;endif ?>
</div>
<?php
}}
