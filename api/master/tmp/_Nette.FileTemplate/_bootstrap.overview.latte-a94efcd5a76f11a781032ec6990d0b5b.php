...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb953010a9e4_content')) { function _lb953010a9e4_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['idp1b2btqr'])->render() ;endif ?>
</div>
<?php
}}
