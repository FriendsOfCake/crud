...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb447be2406f_content')) { function _lb447be2406f_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ljug8inh7m'])->render() ;endif ?>
</div>
<?php
}}
