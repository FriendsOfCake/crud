...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbeb4040d2bf_content')) { function _lbeb4040d2bf_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['mo4d0ne9uy'])->render() ;endif ?>
</div>
<?php
}}
