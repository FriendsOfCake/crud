...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4784df51b8_content')) { function _lb4784df51b8_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ggoivh3byk'])->render() ;endif ?>
</div>
<?php
}}
