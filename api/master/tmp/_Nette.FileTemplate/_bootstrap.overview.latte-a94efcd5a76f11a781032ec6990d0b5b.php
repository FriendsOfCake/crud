...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0f3d875a91_content')) { function _lb0f3d875a91_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['kejj2pitx0'])->render() ;endif ?>
</div>
<?php
}}
