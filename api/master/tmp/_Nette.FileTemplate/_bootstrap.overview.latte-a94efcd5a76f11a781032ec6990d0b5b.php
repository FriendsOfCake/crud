...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb322aa5299c_content')) { function _lb322aa5299c_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['7raz0kkr9k'])->render() ;endif ?>
</div>
<?php
}}
