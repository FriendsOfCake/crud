...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbecc5fc3430_content')) { function _lbecc5fc3430_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['nwjgdhjrjr'])->render() ;endif ?>
</div>
<?php
}}
