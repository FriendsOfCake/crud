...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb99d3b42c88_content')) { function _lb99d3b42c88_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['u3cqvti8ay'])->render() ;endif ?>
</div>
<?php
}}
