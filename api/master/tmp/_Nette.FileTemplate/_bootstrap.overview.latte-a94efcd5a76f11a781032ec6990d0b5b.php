...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb62b8935e51_content')) { function _lb62b8935e51_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['992kgfn8d6'])->render() ;endif ?>
</div>
<?php
}}
