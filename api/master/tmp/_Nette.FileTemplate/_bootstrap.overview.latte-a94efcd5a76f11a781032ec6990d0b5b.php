...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd6f920c3c7_content')) { function _lbd6f920c3c7_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['cjtixm8nn9'])->render() ;endif ?>
</div>
<?php
}}
