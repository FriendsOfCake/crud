...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc20b0ffd87_content')) { function _lbc20b0ffd87_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ke66ndymtm'])->render() ;endif ?>
</div>
<?php
}}
