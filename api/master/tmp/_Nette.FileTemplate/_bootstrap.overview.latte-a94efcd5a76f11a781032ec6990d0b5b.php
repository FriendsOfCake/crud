...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb51d8921faf_content')) { function _lb51d8921faf_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['y3skv35y5v'])->render() ;endif ?>
</div>
<?php
}}
