...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb13b4bad133_content')) { function _lb13b4bad133_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['pylmqxk02j'])->render() ;endif ?>
</div>
<?php
}}
