...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6f90bca4a0_content')) { function _lb6f90bca4a0_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['6lzy8wgx0r'])->render() ;endif ?>
</div>
<?php
}}
