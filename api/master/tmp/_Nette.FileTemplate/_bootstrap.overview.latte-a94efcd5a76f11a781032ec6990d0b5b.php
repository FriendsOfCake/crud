...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8d56bc2f6a_content')) { function _lb8d56bc2f6a_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['9pexkajigg'])->render() ;endif ?>
</div>
<?php
}}
