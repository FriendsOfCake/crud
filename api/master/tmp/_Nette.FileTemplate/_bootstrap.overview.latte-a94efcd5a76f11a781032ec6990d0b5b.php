...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9cede5e4d9_content')) { function _lb9cede5e4d9_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ejzqoa03fr'])->render() ;endif ?>
</div>
<?php
}}
