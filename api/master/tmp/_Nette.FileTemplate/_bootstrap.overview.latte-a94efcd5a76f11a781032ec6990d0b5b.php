...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb16a3414633_content')) { function _lb16a3414633_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['3vd1berecl'])->render() ;endif ?>
</div>
<?php
}}
