...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb264bb60ba3_content')) { function _lb264bb60ba3_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['2ilbayzc9w'])->render() ;endif ?>
</div>
<?php
}}
