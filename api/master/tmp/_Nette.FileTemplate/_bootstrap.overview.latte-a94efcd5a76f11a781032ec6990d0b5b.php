...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb489777b667_content')) { function _lb489777b667_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['2ttpq5p7sx'])->render() ;endif ?>
</div>
<?php
}}
