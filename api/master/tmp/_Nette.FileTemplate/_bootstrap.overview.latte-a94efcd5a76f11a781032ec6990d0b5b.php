...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba6aaa58f00_content')) { function _lba6aaa58f00_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['lew3cqidvb'])->render() ;endif ?>
</div>
<?php
}}
