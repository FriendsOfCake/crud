...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbac4b6e548c_content')) { function _lbac4b6e548c_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['npghx6an0l'])->render() ;endif ?>
</div>
<?php
}}
