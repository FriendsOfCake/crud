...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb6ad4cf08f_content')) { function _lbb6ad4cf08f_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['cofe54ghcr'])->render() ;endif ?>
</div>
<?php
}}
