...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7729c16428_content')) { function _lb7729c16428_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ha2b4p3673'])->render() ;endif ?>
</div>
<?php
}}
