...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba389edecf4_content')) { function _lba389edecf4_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ao4wnfmgoo'])->render() ;endif ?>
</div>
<?php
}}
