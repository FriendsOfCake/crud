...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd7f839ddf4_content')) { function _lbd7f839ddf4_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['5naobissts'])->render() ;endif ?>
</div>
<?php
}}
