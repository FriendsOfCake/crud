...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb05ae983eea_content')) { function _lb05ae983eea_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['fh180u1yqo'])->render() ;endif ?>
</div>
<?php
}}
