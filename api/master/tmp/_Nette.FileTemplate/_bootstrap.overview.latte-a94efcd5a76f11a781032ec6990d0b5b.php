...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf41d42a85e_content')) { function _lbf41d42a85e_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['wuebmnl8id'])->render() ;endif ?>
</div>
<?php
}}
