...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba044a91081_content')) { function _lba044a91081_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['l8di3p3vzl'])->render() ;endif ?>
</div>
<?php
}}
