...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdf163974a2_content')) { function _lbdf163974a2_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ftph0o1bgi'])->render() ;endif ?>
</div>
<?php
}}
