...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb115102db15_content')) { function _lb115102db15_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['f28jxn9vbu'])->render() ;endif ?>
</div>
<?php
}}
