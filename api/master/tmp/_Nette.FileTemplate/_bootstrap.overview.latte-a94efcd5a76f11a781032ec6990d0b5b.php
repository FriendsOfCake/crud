...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdcd8191c24_content')) { function _lbdcd8191c24_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['chchx7y8wv'])->render() ;endif ?>
</div>
<?php
}}
