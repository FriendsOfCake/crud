...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3ef2947b4a_content')) { function _lb3ef2947b4a_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['gds416vr72'])->render() ;endif ?>
</div>
<?php
}}
