...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbeb6bb0f717_content')) { function _lbeb6bb0f717_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['vc13sxij28'])->render() ;endif ?>
</div>
<?php
}}
