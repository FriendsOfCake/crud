...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb73252aaad4_content')) { function _lb73252aaad4_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['d302asnbjf'])->render() ;endif ?>
</div>
<?php
}}
