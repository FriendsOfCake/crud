...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb123583ea1a_content')) { function _lb123583ea1a_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ldujupas5g'])->render() ;endif ?>
</div>
<?php
}}
