...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb46ea6f00d3_content')) { function _lb46ea6f00d3_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['snz0oh5bwj'])->render() ;endif ?>
</div>
<?php
}}
