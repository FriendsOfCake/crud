...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb793422b3d3_content')) { function _lb793422b3d3_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['gx90zcj4rv'])->render() ;endif ?>
</div>
<?php
}}
