...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb187e7af245_content')) { function _lb187e7af245_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['kmk1uh1vkr'])->render() ;endif ?>
</div>
<?php
}}
