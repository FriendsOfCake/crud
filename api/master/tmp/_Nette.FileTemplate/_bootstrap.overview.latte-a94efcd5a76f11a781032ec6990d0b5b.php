...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb03d94210a_content')) { function _lbb03d94210a_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['lefhfdz70c'])->render() ;endif ?>
</div>
<?php
}}
