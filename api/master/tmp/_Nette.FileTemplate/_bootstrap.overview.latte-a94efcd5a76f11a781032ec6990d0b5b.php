...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb33d5e48e37_content')) { function _lb33d5e48e37_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['qys9lguhgt'])->render() ;endif ?>
</div>
<?php
}}
