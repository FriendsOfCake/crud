...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7ce7b4e33b_content')) { function _lb7ce7b4e33b_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['idudao25z9'])->render() ;endif ?>
</div>
<?php
}}
