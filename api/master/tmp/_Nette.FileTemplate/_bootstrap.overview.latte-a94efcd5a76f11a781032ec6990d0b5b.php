...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5c81fb8fcd_content')) { function _lb5c81fb8fcd_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['pbty2nweyp'])->render() ;endif ?>
</div>
<?php
}}
