...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb33d800e6f1_content')) { function _lb33d800e6f1_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['fbzf5stnzm'])->render() ;endif ?>
</div>
<?php
}}
