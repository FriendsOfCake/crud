...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb763f2b1fb5_content')) { function _lb763f2b1fb5_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['yw9v05rqlu'])->render() ;endif ?>
</div>
<?php
}}
