...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1b35fd6b1e_content')) { function _lb1b35fd6b1e_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['m7om94l7ma'])->render() ;endif ?>
</div>
<?php
}}
