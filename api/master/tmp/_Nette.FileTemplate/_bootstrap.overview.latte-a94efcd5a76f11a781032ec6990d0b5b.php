...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe656409011_content')) { function _lbe656409011_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['eapwy07pug'])->render() ;endif ?>
</div>
<?php
}}
