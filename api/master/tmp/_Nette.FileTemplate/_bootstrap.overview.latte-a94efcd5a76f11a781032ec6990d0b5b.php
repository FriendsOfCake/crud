...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5cd8aa7ba5_content')) { function _lb5cd8aa7ba5_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['vwt50jci2g'])->render() ;endif ?>
</div>
<?php
}}
