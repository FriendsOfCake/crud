...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbfe4f5d1228_content')) { function _lbfe4f5d1228_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['lsfet2m3yg'])->render() ;endif ?>
</div>
<?php
}}
