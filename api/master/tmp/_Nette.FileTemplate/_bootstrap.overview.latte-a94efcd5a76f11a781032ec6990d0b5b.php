...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3592f12a40_content')) { function _lb3592f12a40_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['tobn8bvwzw'])->render() ;endif ?>
</div>
<?php
}}
