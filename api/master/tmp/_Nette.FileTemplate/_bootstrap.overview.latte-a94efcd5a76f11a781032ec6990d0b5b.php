...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb78afb88df9_content')) { function _lb78afb88df9_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['so6d4ubf2z'])->render() ;endif ?>
</div>
<?php
}}
