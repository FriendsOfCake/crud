...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdfadba9535_content')) { function _lbdfadba9535_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['w17dpatuij'])->render() ;endif ?>
</div>
<?php
}}
