...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbfff4521cb2_content')) { function _lbfff4521cb2_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['wuafrqgsbj'])->render() ;endif ?>
</div>
<?php
}}
