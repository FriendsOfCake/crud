...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9afb55d0b9_content')) { function _lb9afb55d0b9_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['3az3efgazj'])->render() ;endif ?>
</div>
<?php
}}
