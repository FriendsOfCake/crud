...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb42035e773e_content')) { function _lb42035e773e_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['9pwp8tte8i'])->render() ;endif ?>
</div>
<?php
}}
