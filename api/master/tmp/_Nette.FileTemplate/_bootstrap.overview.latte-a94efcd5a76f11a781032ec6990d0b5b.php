...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb14f4f1b46e_content')) { function _lb14f4f1b46e_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['oms2wl3eex'])->render() ;endif ?>
</div>
<?php
}}
