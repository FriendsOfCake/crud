...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb42d156fde3_content')) { function _lb42d156fde3_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['cf0ov1ny87'])->render() ;endif ?>
</div>
<?php
}}
