...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd006424670_content')) { function _lbd006424670_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['4rj74udh81'])->render() ;endif ?>
</div>
<?php
}}
