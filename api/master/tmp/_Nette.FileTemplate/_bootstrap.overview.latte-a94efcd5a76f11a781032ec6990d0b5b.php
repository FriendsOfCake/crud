...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb499779545d_content')) { function _lb499779545d_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['gv0gthaadf'])->render() ;endif ?>
</div>
<?php
}}
