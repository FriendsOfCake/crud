...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3b96f6ba91_content')) { function _lb3b96f6ba91_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['rz3wr15evn'])->render() ;endif ?>
</div>
<?php
}}
