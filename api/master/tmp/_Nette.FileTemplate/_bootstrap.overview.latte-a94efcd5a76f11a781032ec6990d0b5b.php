...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb31a599441_content')) { function _lbb31a599441_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['1pk3yiocjd'])->render() ;endif ?>
</div>
<?php
}}
