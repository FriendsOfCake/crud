...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb61624ff4c6_content')) { function _lb61624ff4c6_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['s0z2w0i96p'])->render() ;endif ?>
</div>
<?php
}}
