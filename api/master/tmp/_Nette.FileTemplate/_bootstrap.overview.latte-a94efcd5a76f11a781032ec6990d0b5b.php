...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc9c573a3d2_content')) { function _lbc9c573a3d2_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['pnqy9rrbgg'])->render() ;endif ?>
</div>
<?php
}}
