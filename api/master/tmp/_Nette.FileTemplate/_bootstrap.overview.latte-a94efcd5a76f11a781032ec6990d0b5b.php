...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6a02c64b03_content')) { function _lb6a02c64b03_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['s9zywnqlp7'])->render() ;endif ?>
</div>
<?php
}}
