...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4f8e0a77bd_content')) { function _lb4f8e0a77bd_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['mof6gvocdv'])->render() ;endif ?>
</div>
<?php
}}
