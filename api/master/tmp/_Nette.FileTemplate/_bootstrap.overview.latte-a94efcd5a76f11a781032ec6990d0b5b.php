...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb71b9f7c426_content')) { function _lb71b9f7c426_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['qnf6tiw30t'])->render() ;endif ?>
</div>
<?php
}}
