...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb49bf2d27ac_content')) { function _lb49bf2d27ac_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['13hfr4wagz'])->render() ;endif ?>
</div>
<?php
}}
