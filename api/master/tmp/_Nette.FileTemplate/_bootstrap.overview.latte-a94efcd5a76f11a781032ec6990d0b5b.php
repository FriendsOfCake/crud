...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb36d63ae558_content')) { function _lb36d63ae558_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['kq5ki628hm'])->render() ;endif ?>
</div>
<?php
}}
