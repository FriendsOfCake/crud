...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe4e8ea2787_content')) { function _lbe4e8ea2787_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['lc6f4mbrmt'])->render() ;endif ?>
</div>
<?php
}}
