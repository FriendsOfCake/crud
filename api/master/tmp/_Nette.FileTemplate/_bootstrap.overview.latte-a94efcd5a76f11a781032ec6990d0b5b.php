...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb11956fa0f3_content')) { function _lb11956fa0f3_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['7cqpree16j'])->render() ;endif ?>
</div>
<?php
}}
