...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0322fe9a8f_content')) { function _lb0322fe9a8f_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['e6kynxl59v'])->render() ;endif ?>
</div>
<?php
}}
