...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb4b12b421c_content')) { function _lbb4b12b421c_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ptcdfbc3kg'])->render() ;endif ?>
</div>
<?php
}}
