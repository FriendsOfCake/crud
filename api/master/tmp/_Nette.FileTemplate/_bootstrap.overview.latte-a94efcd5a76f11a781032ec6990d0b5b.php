...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1ec5efed0b_content')) { function _lb1ec5efed0b_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['wksbhz39s1'])->render() ;endif ?>
</div>
<?php
}}
