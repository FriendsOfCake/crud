...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe18f105066_content')) { function _lbe18f105066_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['t45q1qnm61'])->render() ;endif ?>
</div>
<?php
}}
