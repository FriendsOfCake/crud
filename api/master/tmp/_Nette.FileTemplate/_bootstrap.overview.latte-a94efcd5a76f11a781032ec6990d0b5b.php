...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb70239727fb_content')) { function _lb70239727fb_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['y9ey8kfj54'])->render() ;endif ?>
</div>
<?php
}}
