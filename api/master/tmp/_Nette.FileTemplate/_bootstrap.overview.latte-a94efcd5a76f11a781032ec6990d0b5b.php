...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbeae5492f82_content')) { function _lbeae5492f82_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['be4em73w01'])->render() ;endif ?>
</div>
<?php
}}
