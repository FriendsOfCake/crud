...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf7b8c6a12f_content')) { function _lbf7b8c6a12f_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['89m4z8naz1'])->render() ;endif ?>
</div>
<?php
}}
