...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1b12aebb96_content')) { function _lb1b12aebb96_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['vno7y549lu'])->render() ;endif ?>
</div>
<?php
}}
