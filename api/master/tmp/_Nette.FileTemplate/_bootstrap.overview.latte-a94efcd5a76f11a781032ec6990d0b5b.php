...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb51ef54157a_content')) { function _lb51ef54157a_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['5aehhmgn7c'])->render() ;endif ?>
</div>
<?php
}}
