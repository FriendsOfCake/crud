...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9fa0b41bc6_content')) { function _lb9fa0b41bc6_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['f2meprp8io'])->render() ;endif ?>
</div>
<?php
}}
