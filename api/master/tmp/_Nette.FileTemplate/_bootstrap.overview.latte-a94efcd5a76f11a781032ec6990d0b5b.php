...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8bf86bed9b_content')) { function _lb8bf86bed9b_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['fpt6c7zp41'])->render() ;endif ?>
</div>
<?php
}}
