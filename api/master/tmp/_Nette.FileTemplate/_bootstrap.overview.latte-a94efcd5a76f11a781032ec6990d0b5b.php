...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0f4dd07445_content')) { function _lb0f4dd07445_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['vbqzbdj0j1'])->render() ;endif ?>
</div>
<?php
}}
