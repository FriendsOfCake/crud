...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6d1138ff3e_content')) { function _lb6d1138ff3e_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['50ie71i6eg'])->render() ;endif ?>
</div>
<?php
}}
