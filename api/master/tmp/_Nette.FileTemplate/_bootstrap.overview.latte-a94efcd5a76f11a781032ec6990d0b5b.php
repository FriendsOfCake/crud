...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb58a58914ca_content')) { function _lb58a58914ca_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['sxzqp1q1md'])->render() ;endif ?>
</div>
<?php
}}
