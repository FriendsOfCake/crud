...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0441208ffb_content')) { function _lb0441208ffb_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['eip9w7eq0x'])->render() ;endif ?>
</div>
<?php
}}
