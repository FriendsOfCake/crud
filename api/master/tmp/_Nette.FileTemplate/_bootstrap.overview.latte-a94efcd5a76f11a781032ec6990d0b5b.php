...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8da9abbf81_content')) { function _lb8da9abbf81_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['0mwcbzqlbz'])->render() ;endif ?>
</div>
<?php
}}
