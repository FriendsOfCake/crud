...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd737fc32fc_content')) { function _lbd737fc32fc_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ux9gqrqjfk'])->render() ;endif ?>
</div>
<?php
}}
