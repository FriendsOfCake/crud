...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7e97444cb5_content')) { function _lb7e97444cb5_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ab0bqhihn0'])->render() ;endif ?>
</div>
<?php
}}
