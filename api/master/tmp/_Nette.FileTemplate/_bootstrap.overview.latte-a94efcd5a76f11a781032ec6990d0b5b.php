...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf3d2433837_content')) { function _lbf3d2433837_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['y8jzuzrzzg'])->render() ;endif ?>
</div>
<?php
}}
