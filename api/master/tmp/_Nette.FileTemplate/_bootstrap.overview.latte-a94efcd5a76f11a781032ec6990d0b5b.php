...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7d8afed349_content')) { function _lb7d8afed349_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['gm0hkqesdx'])->render() ;endif ?>
</div>
<?php
}}
