...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbecd9d65956_content')) { function _lbecd9d65956_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['akhiz2svoe'])->render() ;endif ?>
</div>
<?php
}}
