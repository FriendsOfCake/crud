...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb78074af333_content')) { function _lb78074af333_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['7j37fkw8oh'])->render() ;endif ?>
</div>
<?php
}}
