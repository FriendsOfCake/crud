...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb430128d952_content')) { function _lb430128d952_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['0s5cxziriq'])->render() ;endif ?>
</div>
<?php
}}
