...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5a36cbb9ea_content')) { function _lb5a36cbb9ea_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['pfq0dpvirk'])->render() ;endif ?>
</div>
<?php
}}
