...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5470c4eb5c_content')) { function _lb5470c4eb5c_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['h60ct4yn4p'])->render() ;endif ?>
</div>
<?php
}}
