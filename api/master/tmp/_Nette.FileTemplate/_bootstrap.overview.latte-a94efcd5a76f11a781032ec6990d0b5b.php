...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb777f96249_content')) { function _lbb777f96249_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['w7hcsw34h6'])->render() ;endif ?>
</div>
<?php
}}
