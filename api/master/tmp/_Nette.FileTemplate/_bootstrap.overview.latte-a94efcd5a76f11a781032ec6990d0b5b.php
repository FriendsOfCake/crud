...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4128c06479_content')) { function _lb4128c06479_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['a6fcwpcfcd'])->render() ;endif ?>
</div>
<?php
}}
