...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb60d11de550_content')) { function _lb60d11de550_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['lv03bhy2dt'])->render() ;endif ?>
</div>
<?php
}}
