...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc51df93d03_content')) { function _lbc51df93d03_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['e9h6iwnesm'])->render() ;endif ?>
</div>
<?php
}}
