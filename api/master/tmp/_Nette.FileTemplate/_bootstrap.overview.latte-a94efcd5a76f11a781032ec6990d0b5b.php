...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5ebf217138_content')) { function _lb5ebf217138_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['1alyqs7c4i'])->render() ;endif ?>
</div>
<?php
}}
