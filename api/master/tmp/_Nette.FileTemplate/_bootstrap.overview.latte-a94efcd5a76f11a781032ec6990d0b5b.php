...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1a1cfaa491_content')) { function _lb1a1cfaa491_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['o56gm9gc91'])->render() ;endif ?>
</div>
<?php
}}
