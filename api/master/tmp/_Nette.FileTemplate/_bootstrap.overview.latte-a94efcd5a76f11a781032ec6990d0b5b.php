...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4160a571ec_content')) { function _lb4160a571ec_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['hldzu8xfh9'])->render() ;endif ?>
</div>
<?php
}}
