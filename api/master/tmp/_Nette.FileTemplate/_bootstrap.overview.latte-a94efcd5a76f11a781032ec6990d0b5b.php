...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1e1328c37e_content')) { function _lb1e1328c37e_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['u1w7z5f7qi'])->render() ;endif ?>
</div>
<?php
}}
