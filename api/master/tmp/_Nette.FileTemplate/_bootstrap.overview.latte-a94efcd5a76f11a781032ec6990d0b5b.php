...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2c47393904_content')) { function _lb2c47393904_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['pnikz9bl9f'])->render() ;endif ?>
</div>
<?php
}}
