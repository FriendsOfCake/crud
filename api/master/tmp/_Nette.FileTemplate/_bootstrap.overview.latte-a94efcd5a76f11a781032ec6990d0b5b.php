...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdd7b574a56_content')) { function _lbdd7b574a56_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['42i9vavepa'])->render() ;endif ?>
</div>
<?php
}}
