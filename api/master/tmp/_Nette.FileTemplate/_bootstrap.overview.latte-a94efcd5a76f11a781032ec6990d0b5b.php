...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf97bdc33b9_content')) { function _lbf97bdc33b9_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['zfp40ax2lj'])->render() ;endif ?>
</div>
<?php
}}
