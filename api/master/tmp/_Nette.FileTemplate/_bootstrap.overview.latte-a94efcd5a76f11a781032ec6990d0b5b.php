...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc0593abcce_content')) { function _lbc0593abcce_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['zjt6cshmo2'])->render() ;endif ?>
</div>
<?php
}}
