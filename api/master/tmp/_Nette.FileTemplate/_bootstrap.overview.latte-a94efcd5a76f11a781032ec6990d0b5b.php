...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb39d913bb06_content')) { function _lb39d913bb06_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ai9y6zkfwk'])->render() ;endif ?>
</div>
<?php
}}
