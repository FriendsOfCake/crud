...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2d48970f40_content')) { function _lb2d48970f40_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['fyqi47co0p'])->render() ;endif ?>
</div>
<?php
}}
