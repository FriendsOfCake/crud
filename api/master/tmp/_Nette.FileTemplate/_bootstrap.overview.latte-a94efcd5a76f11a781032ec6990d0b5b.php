...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb864f33daf3_content')) { function _lb864f33daf3_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['xdo0hf7xhd'])->render() ;endif ?>
</div>
<?php
}}
