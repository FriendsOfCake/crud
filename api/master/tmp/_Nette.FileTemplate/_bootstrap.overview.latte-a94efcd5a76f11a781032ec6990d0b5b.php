...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbcb6d6f3645_content')) { function _lbcb6d6f3645_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ijsxqvesys'])->render() ;endif ?>
</div>
<?php
}}
