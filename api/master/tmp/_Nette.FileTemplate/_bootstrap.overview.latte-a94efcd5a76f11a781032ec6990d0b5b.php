...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbab0921a5f5_content')) { function _lbab0921a5f5_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['zfdo3yb0hp'])->render() ;endif ?>
</div>
<?php
}}
