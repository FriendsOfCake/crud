...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbca46b1fe3a_content')) { function _lbca46b1fe3a_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['yu0wxxdcxd'])->render() ;endif ?>
</div>
<?php
}}
