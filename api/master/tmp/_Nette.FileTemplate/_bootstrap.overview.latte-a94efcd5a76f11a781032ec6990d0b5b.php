...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc8a30676aa_content')) { function _lbc8a30676aa_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['xinh3883qe'])->render() ;endif ?>
</div>
<?php
}}
