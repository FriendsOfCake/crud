...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4e19ff52ca_content')) { function _lb4e19ff52ca_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['we0kpy5t5o'])->render() ;endif ?>
</div>
<?php
}}
