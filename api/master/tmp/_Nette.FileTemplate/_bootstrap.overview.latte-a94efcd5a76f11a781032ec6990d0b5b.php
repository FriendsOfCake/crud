...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbace6ace426_content')) { function _lbace6ace426_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['jlkd76j3ov'])->render() ;endif ?>
</div>
<?php
}}
