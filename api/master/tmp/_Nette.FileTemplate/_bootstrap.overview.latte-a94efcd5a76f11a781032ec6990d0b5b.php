...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb69c4f2c63_content')) { function _lbb69c4f2c63_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['v33cwddt51'])->render() ;endif ?>
</div>
<?php
}}
