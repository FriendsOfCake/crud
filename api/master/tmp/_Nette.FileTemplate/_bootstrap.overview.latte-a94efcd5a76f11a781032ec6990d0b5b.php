...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1f6d232f34_content')) { function _lb1f6d232f34_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['anca4hu3ge'])->render() ;endif ?>
</div>
<?php
}}
