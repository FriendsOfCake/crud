...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbcc66d39b83_content')) { function _lbcc66d39b83_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['zketue5htb'])->render() ;endif ?>
</div>
<?php
}}
