...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb90e53efc83_content')) { function _lb90e53efc83_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['hrd2p8vs3f'])->render() ;endif ?>
</div>
<?php
}}
