...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc0164cb2a7_content')) { function _lbc0164cb2a7_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['4crpasob4c'])->render() ;endif ?>
</div>
<?php
}}
