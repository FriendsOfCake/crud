...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb93c6925a92_content')) { function _lb93c6925a92_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['zk5w5vo8fx'])->render() ;endif ?>
</div>
<?php
}}
