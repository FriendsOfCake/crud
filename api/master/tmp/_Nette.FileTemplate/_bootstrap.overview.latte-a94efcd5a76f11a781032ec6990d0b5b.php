...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5e4a57cdf2_content')) { function _lb5e4a57cdf2_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['b6doa5qhgl'])->render() ;endif ?>
</div>
<?php
}}
