...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb412beaa7ca_content')) { function _lb412beaa7ca_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['2x5rw4l18t'])->render() ;endif ?>
</div>
<?php
}}
