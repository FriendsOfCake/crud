...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc1884337a8_content')) { function _lbc1884337a8_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['5bfljl9us9'])->render() ;endif ?>
</div>
<?php
}}
