...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe48bdcf99c_content')) { function _lbe48bdcf99c_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['cf7rck0wer'])->render() ;endif ?>
</div>
<?php
}}
