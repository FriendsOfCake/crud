...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7f679d7f2a_content')) { function _lb7f679d7f2a_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['xpjw4wksdc'])->render() ;endif ?>
</div>
<?php
}}
