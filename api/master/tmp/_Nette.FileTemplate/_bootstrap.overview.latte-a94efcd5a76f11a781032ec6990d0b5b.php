...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8d1288888e_content')) { function _lb8d1288888e_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['09qxnuzmdb'])->render() ;endif ?>
</div>
<?php
}}
