...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb623c3cba4a_content')) { function _lb623c3cba4a_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['usw4wrar8x'])->render() ;endif ?>
</div>
<?php
}}
