...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb195ddd0e49_content')) { function _lb195ddd0e49_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['nbt1sqzf3y'])->render() ;endif ?>
</div>
<?php
}}
