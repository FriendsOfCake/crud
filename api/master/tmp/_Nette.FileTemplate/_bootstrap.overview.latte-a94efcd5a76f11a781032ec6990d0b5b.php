...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2373ea8a44_content')) { function _lb2373ea8a44_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['e8yqwmuy53'])->render() ;endif ?>
</div>
<?php
}}
