...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3ec24695e5_content')) { function _lb3ec24695e5_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['9708eddxn3'])->render() ;endif ?>
</div>
<?php
}}
