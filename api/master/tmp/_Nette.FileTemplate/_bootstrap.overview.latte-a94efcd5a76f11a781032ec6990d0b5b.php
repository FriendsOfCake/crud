...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb11a3fb0c14_content')) { function _lb11a3fb0c14_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['27iq41ev1p'])->render() ;endif ?>
</div>
<?php
}}
