...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2699c99a6f_content')) { function _lb2699c99a6f_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['k3xyzqg58u'])->render() ;endif ?>
</div>
<?php
}}
