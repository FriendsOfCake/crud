...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbea765accbf_content')) { function _lbea765accbf_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['y89w929pn7'])->render() ;endif ?>
</div>
<?php
}}
