...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbcfcd2b1197_content')) { function _lbcfcd2b1197_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['jds34qswl1'])->render() ;endif ?>
</div>
<?php
}}
