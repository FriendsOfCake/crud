...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb25bfb99793_content')) { function _lb25bfb99793_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['rc9lvcytcg'])->render() ;endif ?>
</div>
<?php
}}
