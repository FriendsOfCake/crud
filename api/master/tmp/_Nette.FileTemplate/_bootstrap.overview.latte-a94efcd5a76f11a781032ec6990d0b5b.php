...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb008c0e7633_content')) { function _lb008c0e7633_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['0rvgbdbskw'])->render() ;endif ?>
</div>
<?php
}}
