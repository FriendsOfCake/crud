...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba8436741c2_content')) { function _lba8436741c2_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['mteo96ginf'])->render() ;endif ?>
</div>
<?php
}}
