...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbff079c81e4_content')) { function _lbff079c81e4_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['olx9v9yktq'])->render() ;endif ?>
</div>
<?php
}}
