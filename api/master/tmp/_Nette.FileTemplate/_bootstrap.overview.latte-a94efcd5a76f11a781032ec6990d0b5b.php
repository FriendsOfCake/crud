...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc410ef4366_content')) { function _lbc410ef4366_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['977fks4mtf'])->render() ;endif ?>
</div>
<?php
}}
