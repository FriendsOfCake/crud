...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb6c5faf15f_content')) { function _lbb6c5faf15f_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['gghy5y8fog'])->render() ;endif ?>
</div>
<?php
}}
