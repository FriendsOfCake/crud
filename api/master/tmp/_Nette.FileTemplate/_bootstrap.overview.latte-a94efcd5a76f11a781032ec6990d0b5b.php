...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe5c16ac3cc_content')) { function _lbe5c16ac3cc_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['as1zqiumkk'])->render() ;endif ?>
</div>
<?php
}}
