...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8963dd506c_content')) { function _lb8963dd506c_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ypj7ggt8rw'])->render() ;endif ?>
</div>
<?php
}}
