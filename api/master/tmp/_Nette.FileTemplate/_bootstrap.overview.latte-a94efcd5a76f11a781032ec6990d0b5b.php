...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7c93003690_content')) { function _lb7c93003690_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['o0vmbqa2tq'])->render() ;endif ?>
</div>
<?php
}}
