...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5984d49d45_content')) { function _lb5984d49d45_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['fs3ttevnnt'])->render() ;endif ?>
</div>
<?php
}}
