...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb708182dfc9_content')) { function _lb708182dfc9_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['1zz0vgwyj5'])->render() ;endif ?>
</div>
<?php
}}
