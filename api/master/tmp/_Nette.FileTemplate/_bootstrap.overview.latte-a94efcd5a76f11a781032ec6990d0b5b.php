...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf55ce27236_content')) { function _lbf55ce27236_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['yw4f8c9akk'])->render() ;endif ?>
</div>
<?php
}}
