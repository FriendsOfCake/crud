...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba1ef15a934_content')) { function _lba1ef15a934_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['tykjyhcnvu'])->render() ;endif ?>
</div>
<?php
}}
