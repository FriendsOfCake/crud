...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbcbea304d57_content')) { function _lbcbea304d57_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['9dvbctub7c'])->render() ;endif ?>
</div>
<?php
}}
