...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb4c8c8948e_content')) { function _lbb4c8c8948e_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['unmp45b3rp'])->render() ;endif ?>
</div>
<?php
}}
