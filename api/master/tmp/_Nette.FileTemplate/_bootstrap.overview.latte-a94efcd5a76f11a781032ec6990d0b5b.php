...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6eb37cf7a3_content')) { function _lb6eb37cf7a3_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['uqy0gfk5j6'])->render() ;endif ?>
</div>
<?php
}}
