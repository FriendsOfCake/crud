...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf975670aff_content')) { function _lbf975670aff_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['yg7woz2ioz'])->render() ;endif ?>
</div>
<?php
}}
