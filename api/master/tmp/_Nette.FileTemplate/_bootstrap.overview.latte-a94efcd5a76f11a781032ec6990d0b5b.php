...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0fc4f87df4_content')) { function _lb0fc4f87df4_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['zlwsago3tu'])->render() ;endif ?>
</div>
<?php
}}
