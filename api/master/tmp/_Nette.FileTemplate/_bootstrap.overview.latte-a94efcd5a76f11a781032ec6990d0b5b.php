...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbef238a2d4d_content')) { function _lbef238a2d4d_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['6fjd35taqm'])->render() ;endif ?>
</div>
<?php
}}
