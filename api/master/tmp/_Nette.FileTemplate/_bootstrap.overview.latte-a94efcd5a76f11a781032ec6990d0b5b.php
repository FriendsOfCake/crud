...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb96a48da72d_content')) { function _lb96a48da72d_content($_l, $_args) { extract($_args)
?><div id="content">
...
<?php if (!$group): Nette\Latte\Macros\CoreMacros::includeTemplate('@elementlist.latte', $template->getParameters(), $_l->templates['ta9o6102t3'])->render() ;endif ?>
</div>
<?php
}}
