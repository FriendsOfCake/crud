...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4583e9ca02_content')) { function _lb4583e9ca02_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbb7dc03ceb8_children')) { function _lbb7dc03ceb8_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb3a5516b72a_method')) { function _lb3a5516b72a_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb7d1552d6d7_property')) { function _lb7d1552d6d7_property($_l, $_args) { extract($_args)
