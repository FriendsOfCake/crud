...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5711c2a04f_content')) { function _lb5711c2a04f_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb4a1fa30803_children')) { function _lb4a1fa30803_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbc49baba6d6_method')) { function _lbc49baba6d6_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb2e74be9da9_property')) { function _lb2e74be9da9_property($_l, $_args) { extract($_args)
