...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb54a75d0ca7_content')) { function _lb54a75d0ca7_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbdcafc1ddfa_children')) { function _lbdcafc1ddfa_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbd3027ed7ce_method')) { function _lbd3027ed7ce_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb62b4f527a8_property')) { function _lb62b4f527a8_property($_l, $_args) { extract($_args)
