...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdcd169c680_content')) { function _lbdcd169c680_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbc009257491_children')) { function _lbc009257491_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb63d39aee19_method')) { function _lb63d39aee19_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb0248c05bf4_property')) { function _lb0248c05bf4_property($_l, $_args) { extract($_args)
