...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb633e9a3acd_content')) { function _lb633e9a3acd_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb0b823d6120_children')) { function _lb0b823d6120_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbf72c0357bd_method')) { function _lbf72c0357bd_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbe7aa913a93_property')) { function _lbe7aa913a93_property($_l, $_args) { extract($_args)
