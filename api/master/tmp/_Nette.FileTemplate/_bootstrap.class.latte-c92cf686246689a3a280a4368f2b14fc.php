...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb76b401eb0c_content')) { function _lb76b401eb0c_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbfd05d42466_children')) { function _lbfd05d42466_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb509a0a199f_method')) { function _lb509a0a199f_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbcebc1de886_property')) { function _lbcebc1de886_property($_l, $_args) { extract($_args)
