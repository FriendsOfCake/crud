...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd8986c2573_content')) { function _lbd8986c2573_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb71b2650ee1_children')) { function _lb71b2650ee1_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb516cbb17e3_method')) { function _lb516cbb17e3_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb030235ce37_property')) { function _lb030235ce37_property($_l, $_args) { extract($_args)
