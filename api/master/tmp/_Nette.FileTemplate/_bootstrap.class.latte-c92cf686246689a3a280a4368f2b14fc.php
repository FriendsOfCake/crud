...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbeea3ee0422_content')) { function _lbeea3ee0422_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbdacfe0f7d1_children')) { function _lbdacfe0f7d1_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb053a644446_method')) { function _lb053a644446_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbddc3d35789_property')) { function _lbddc3d35789_property($_l, $_args) { extract($_args)
