...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4d931a4a4c_content')) { function _lb4d931a4a4c_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb490caf9915_children')) { function _lb490caf9915_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb70f7b38c07_method')) { function _lb70f7b38c07_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbe2c46c2eef_property')) { function _lbe2c46c2eef_property($_l, $_args) { extract($_args)
