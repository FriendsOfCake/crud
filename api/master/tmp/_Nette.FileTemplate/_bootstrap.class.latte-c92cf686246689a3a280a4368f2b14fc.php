...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba5656dd7a6_content')) { function _lba5656dd7a6_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb0654844331_children')) { function _lb0654844331_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb83a6a0f400_method')) { function _lb83a6a0f400_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbd434fe1bbc_property')) { function _lbd434fe1bbc_property($_l, $_args) { extract($_args)
