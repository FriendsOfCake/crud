...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb40e49afb01_content')) { function _lb40e49afb01_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbc9c8b0e02b_children')) { function _lbc9c8b0e02b_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb5119e82726_method')) { function _lb5119e82726_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb6909ae3f83_property')) { function _lb6909ae3f83_property($_l, $_args) { extract($_args)
