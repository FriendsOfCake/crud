...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0f8b7a08c4_content')) { function _lb0f8b7a08c4_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbc6658715bd_children')) { function _lbc6658715bd_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb94f12b97dc_method')) { function _lb94f12b97dc_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb3065a71272_property')) { function _lb3065a71272_property($_l, $_args) { extract($_args)
