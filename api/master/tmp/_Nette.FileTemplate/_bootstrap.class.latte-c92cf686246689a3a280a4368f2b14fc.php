...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb8d67c813a_content')) { function _lbb8d67c813a_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lba788d9eb05_children')) { function _lba788d9eb05_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb296a2396ae_method')) { function _lb296a2396ae_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb75b98da20e_property')) { function _lb75b98da20e_property($_l, $_args) { extract($_args)
