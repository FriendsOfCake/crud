...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe5f822ca54_content')) { function _lbe5f822ca54_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb69972f26a7_children')) { function _lb69972f26a7_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbcdd41723af_method')) { function _lbcdd41723af_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbc7ffb2f471_property')) { function _lbc7ffb2f471_property($_l, $_args) { extract($_args)
