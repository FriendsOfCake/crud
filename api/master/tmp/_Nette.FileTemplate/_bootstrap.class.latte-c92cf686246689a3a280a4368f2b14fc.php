...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbffccc040f5_content')) { function _lbffccc040f5_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb2e60df7dfb_children')) { function _lb2e60df7dfb_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbd0e153709c_method')) { function _lbd0e153709c_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb977ca41b05_property')) { function _lb977ca41b05_property($_l, $_args) { extract($_args)
