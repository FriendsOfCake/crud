...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9e9df3719b_content')) { function _lb9e9df3719b_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb6fadc71a66_children')) { function _lb6fadc71a66_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb8df725964e_method')) { function _lb8df725964e_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb83bafa027a_property')) { function _lb83bafa027a_property($_l, $_args) { extract($_args)
