...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9c9606e6b8_content')) { function _lb9c9606e6b8_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb1da7fa3acc_children')) { function _lb1da7fa3acc_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbc72eaa5273_method')) { function _lbc72eaa5273_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbd45d8ee1ce_property')) { function _lbd45d8ee1ce_property($_l, $_args) { extract($_args)
