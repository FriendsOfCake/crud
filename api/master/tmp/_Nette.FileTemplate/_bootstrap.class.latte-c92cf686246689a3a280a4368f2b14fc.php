...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd2ed5231be_content')) { function _lbd2ed5231be_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbb2d6e9cd27_children')) { function _lbb2d6e9cd27_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb9a296c3eb6_method')) { function _lb9a296c3eb6_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb470ba28295_property')) { function _lb470ba28295_property($_l, $_args) { extract($_args)
