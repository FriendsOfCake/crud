...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd4e7d72b0c_content')) { function _lbd4e7d72b0c_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb5953be5b87_children')) { function _lb5953be5b87_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb0530e6a24d_method')) { function _lb0530e6a24d_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbff4e69b168_property')) { function _lbff4e69b168_property($_l, $_args) { extract($_args)
