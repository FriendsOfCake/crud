...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0c29c3612d_content')) { function _lb0c29c3612d_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb0e2ef1648c_children')) { function _lb0e2ef1648c_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb06c3cbf418_method')) { function _lb06c3cbf418_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb7033c221ab_property')) { function _lb7033c221ab_property($_l, $_args) { extract($_args)
