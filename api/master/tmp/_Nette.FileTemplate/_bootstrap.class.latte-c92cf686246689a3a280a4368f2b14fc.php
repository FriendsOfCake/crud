...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1b0071b177_content')) { function _lb1b0071b177_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb20ad96abd1_children')) { function _lb20ad96abd1_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb68d1c21fd8_method')) { function _lb68d1c21fd8_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb2dc504d032_property')) { function _lb2dc504d032_property($_l, $_args) { extract($_args)
