...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbfb6ba22ee6_content')) { function _lbfb6ba22ee6_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb45511e1d8c_children')) { function _lb45511e1d8c_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb2d3de077ba_method')) { function _lb2d3de077ba_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb5654c0c771_property')) { function _lb5654c0c771_property($_l, $_args) { extract($_args)
