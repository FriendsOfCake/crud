...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb85284dcc9e_content')) { function _lb85284dcc9e_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lba819c747d0_children')) { function _lba819c747d0_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb462fd28135_method')) { function _lb462fd28135_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbf8a9ed05b6_property')) { function _lbf8a9ed05b6_property($_l, $_args) { extract($_args)
