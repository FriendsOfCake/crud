...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbbcc19ac91d_content')) { function _lbbcc19ac91d_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbf1b99ddc8c_children')) { function _lbf1b99ddc8c_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb8dbc10978c_method')) { function _lb8dbc10978c_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb2738351610_property')) { function _lb2738351610_property($_l, $_args) { extract($_args)
