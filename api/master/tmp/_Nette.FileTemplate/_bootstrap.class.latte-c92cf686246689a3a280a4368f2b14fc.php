...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb58b6643859_content')) { function _lb58b6643859_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb927489513c_children')) { function _lb927489513c_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb4b3be90871_method')) { function _lb4b3be90871_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb5a7124baab_property')) { function _lb5a7124baab_property($_l, $_args) { extract($_args)
