...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb887914d5c6_content')) { function _lb887914d5c6_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb09256fd462_children')) { function _lb09256fd462_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb30d3101133_method')) { function _lb30d3101133_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbff393b0f74_property')) { function _lbff393b0f74_property($_l, $_args) { extract($_args)
