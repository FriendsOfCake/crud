...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba68fda7fc8_content')) { function _lba68fda7fc8_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb64c50c102d_children')) { function _lb64c50c102d_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbbbf67c8ec3_method')) { function _lbbbf67c8ec3_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb9c3a822954_property')) { function _lb9c3a822954_property($_l, $_args) { extract($_args)
