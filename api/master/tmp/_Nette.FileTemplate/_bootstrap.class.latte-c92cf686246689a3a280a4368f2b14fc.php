...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbefcb0f36df_content')) { function _lbefcb0f36df_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb377eed29e2_children')) { function _lb377eed29e2_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbcd24d0468e_method')) { function _lbcd24d0468e_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb9b22dd94ed_property')) { function _lb9b22dd94ed_property($_l, $_args) { extract($_args)
