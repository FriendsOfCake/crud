...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe4990c3386_content')) { function _lbe4990c3386_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbe0d0b43ff7_children')) { function _lbe0d0b43ff7_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb3eaa511b17_method')) { function _lb3eaa511b17_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbf662da5fc4_property')) { function _lbf662da5fc4_property($_l, $_args) { extract($_args)
