...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb08ca29baa5_content')) { function _lb08ca29baa5_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbe53b5dde39_children')) { function _lbe53b5dde39_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb5d5e8beea8_method')) { function _lb5d5e8beea8_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb46a646508d_property')) { function _lb46a646508d_property($_l, $_args) { extract($_args)
