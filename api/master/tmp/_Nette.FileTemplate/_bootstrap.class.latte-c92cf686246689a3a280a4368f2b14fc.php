...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe660bf1013_content')) { function _lbe660bf1013_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbf989e97f9b_children')) { function _lbf989e97f9b_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb0f31a3f00b_method')) { function _lb0f31a3f00b_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lba7ad57aab1_property')) { function _lba7ad57aab1_property($_l, $_args) { extract($_args)
