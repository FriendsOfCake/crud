...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb05471203b7_content')) { function _lb05471203b7_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb52e6e5d7ec_children')) { function _lb52e6e5d7ec_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbca3a64ef76_method')) { function _lbca3a64ef76_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb8a0858d577_property')) { function _lb8a0858d577_property($_l, $_args) { extract($_args)
