...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd09f252716_content')) { function _lbd09f252716_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb408831baf0_children')) { function _lb408831baf0_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbf367ee750f_method')) { function _lbf367ee750f_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbea34950f39_property')) { function _lbea34950f39_property($_l, $_args) { extract($_args)
