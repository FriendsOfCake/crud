...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba1bdc491ee_content')) { function _lba1bdc491ee_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbc2081f9334_children')) { function _lbc2081f9334_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbef3ad57fcb_method')) { function _lbef3ad57fcb_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbad3e2844fb_property')) { function _lbad3e2844fb_property($_l, $_args) { extract($_args)
