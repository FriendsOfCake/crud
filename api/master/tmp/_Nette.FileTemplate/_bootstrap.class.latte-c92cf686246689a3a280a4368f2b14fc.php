...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc0ad7d6087_content')) { function _lbc0ad7d6087_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbc420e721f8_children')) { function _lbc420e721f8_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb0f4ef104e0_method')) { function _lb0f4ef104e0_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb7520787599_property')) { function _lb7520787599_property($_l, $_args) { extract($_args)
