...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd5df09dffd_content')) { function _lbd5df09dffd_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb88456a64f4_children')) { function _lb88456a64f4_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbf284e71846_method')) { function _lbf284e71846_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb8ceb4a5b78_property')) { function _lb8ceb4a5b78_property($_l, $_args) { extract($_args)
