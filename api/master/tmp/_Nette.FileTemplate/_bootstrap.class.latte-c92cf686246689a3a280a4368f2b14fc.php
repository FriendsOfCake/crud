...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4211d6e1e1_content')) { function _lb4211d6e1e1_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbf0373be31c_children')) { function _lbf0373be31c_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbbcd0b96cb3_method')) { function _lbbcd0b96cb3_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb41eb2ddc71_property')) { function _lb41eb2ddc71_property($_l, $_args) { extract($_args)
