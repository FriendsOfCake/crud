...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba632af5592_content')) { function _lba632af5592_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb892ecc8f5e_children')) { function _lb892ecc8f5e_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lba4e6176421_method')) { function _lba4e6176421_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbf1c2371e98_property')) { function _lbf1c2371e98_property($_l, $_args) { extract($_args)
