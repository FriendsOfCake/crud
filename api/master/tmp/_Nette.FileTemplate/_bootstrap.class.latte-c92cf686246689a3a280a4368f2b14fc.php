...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1dcebe3fcd_content')) { function _lb1dcebe3fcd_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb1a662ec4ef_children')) { function _lb1a662ec4ef_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbda25b101fb_method')) { function _lbda25b101fb_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb1a189d2567_property')) { function _lb1a189d2567_property($_l, $_args) { extract($_args)
