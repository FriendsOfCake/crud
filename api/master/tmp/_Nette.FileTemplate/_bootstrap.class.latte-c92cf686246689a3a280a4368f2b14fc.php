...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb81e4e9c817_content')) { function _lb81e4e9c817_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb36266244b2_children')) { function _lb36266244b2_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb653a42f2f7_method')) { function _lb653a42f2f7_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbbecb7072cd_property')) { function _lbbecb7072cd_property($_l, $_args) { extract($_args)
