...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb790ea9f3dd_content')) { function _lb790ea9f3dd_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbfe845a25c5_children')) { function _lbfe845a25c5_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb3d71eb0331_method')) { function _lb3d71eb0331_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lba68c76a123_property')) { function _lba68c76a123_property($_l, $_args) { extract($_args)
