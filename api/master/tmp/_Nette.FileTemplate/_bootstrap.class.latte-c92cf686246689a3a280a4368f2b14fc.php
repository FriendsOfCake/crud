...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf513a02054_content')) { function _lbf513a02054_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbbcbf530c01_children')) { function _lbbcbf530c01_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb436a4ca0c8_method')) { function _lb436a4ca0c8_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbe10e826e2e_property')) { function _lbe10e826e2e_property($_l, $_args) { extract($_args)
