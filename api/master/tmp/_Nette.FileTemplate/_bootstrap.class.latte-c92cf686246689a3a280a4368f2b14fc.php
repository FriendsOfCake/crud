...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb10ab6a10ad_content')) { function _lb10ab6a10ad_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb6c701faffe_children')) { function _lb6c701faffe_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb350a9c1d28_method')) { function _lb350a9c1d28_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb7f8ddfa2ba_property')) { function _lb7f8ddfa2ba_property($_l, $_args) { extract($_args)
