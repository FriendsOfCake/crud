...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7ec760b94c_content')) { function _lb7ec760b94c_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lba53151226f_children')) { function _lba53151226f_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbd57156157d_method')) { function _lbd57156157d_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbb383fd2384_property')) { function _lbb383fd2384_property($_l, $_args) { extract($_args)
