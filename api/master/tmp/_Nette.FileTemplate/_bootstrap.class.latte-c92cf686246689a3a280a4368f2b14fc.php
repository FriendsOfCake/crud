...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbab7a18f090_content')) { function _lbab7a18f090_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb8dfe822bac_children')) { function _lb8dfe822bac_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb897819a767_method')) { function _lb897819a767_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb9b20f175c6_property')) { function _lb9b20f175c6_property($_l, $_args) { extract($_args)
