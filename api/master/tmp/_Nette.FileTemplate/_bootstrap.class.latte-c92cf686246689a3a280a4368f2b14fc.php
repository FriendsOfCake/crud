...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb732a261f3d_content')) { function _lb732a261f3d_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb31c4e2c034_children')) { function _lb31c4e2c034_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb870a7baba4_method')) { function _lb870a7baba4_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbeebfdc2fae_property')) { function _lbeebfdc2fae_property($_l, $_args) { extract($_args)
