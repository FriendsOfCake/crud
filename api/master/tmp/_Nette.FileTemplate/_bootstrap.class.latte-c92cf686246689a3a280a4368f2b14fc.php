...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb93726bf054_content')) { function _lb93726bf054_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbcbbe648de8_children')) { function _lbcbbe648de8_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbfee213c44b_method')) { function _lbfee213c44b_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb70ba0d987c_property')) { function _lb70ba0d987c_property($_l, $_args) { extract($_args)
