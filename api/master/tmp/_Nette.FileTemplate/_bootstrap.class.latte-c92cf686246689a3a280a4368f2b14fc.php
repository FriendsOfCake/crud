...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbce7940805e_content')) { function _lbce7940805e_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb6600a22ff5_children')) { function _lb6600a22ff5_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbf38b24a41d_method')) { function _lbf38b24a41d_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb95798009c6_property')) { function _lb95798009c6_property($_l, $_args) { extract($_args)
