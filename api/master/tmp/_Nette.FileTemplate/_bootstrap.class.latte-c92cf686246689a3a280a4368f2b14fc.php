...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb01502192c1_content')) { function _lb01502192c1_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbe4273dfc2f_children')) { function _lbe4273dfc2f_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbf160401168_method')) { function _lbf160401168_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbd0600b18a6_property')) { function _lbd0600b18a6_property($_l, $_args) { extract($_args)
