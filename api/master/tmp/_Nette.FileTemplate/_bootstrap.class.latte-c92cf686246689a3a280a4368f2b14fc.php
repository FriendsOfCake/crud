...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe8caa652a2_content')) { function _lbe8caa652a2_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb47621dd10f_children')) { function _lb47621dd10f_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbf978bc07c7_method')) { function _lbf978bc07c7_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb302d68541d_property')) { function _lb302d68541d_property($_l, $_args) { extract($_args)
