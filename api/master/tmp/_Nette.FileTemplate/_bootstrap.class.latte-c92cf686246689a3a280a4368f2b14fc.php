...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb506332e8f_content')) { function _lbb506332e8f_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbea287fa4ed_children')) { function _lbea287fa4ed_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb7531a4cade_method')) { function _lb7531a4cade_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbbdcd4b3c08_property')) { function _lbbdcd4b3c08_property($_l, $_args) { extract($_args)
