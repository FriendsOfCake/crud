...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc9075011c7_content')) { function _lbc9075011c7_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb407ae62bfe_children')) { function _lb407ae62bfe_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbcb8957fc0b_method')) { function _lbcb8957fc0b_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbce032d1c32_property')) { function _lbce032d1c32_property($_l, $_args) { extract($_args)
