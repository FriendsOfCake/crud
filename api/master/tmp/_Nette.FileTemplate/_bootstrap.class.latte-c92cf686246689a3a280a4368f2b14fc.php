...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbfb60015be5_content')) { function _lbfb60015be5_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbf4854e6d0c_children')) { function _lbf4854e6d0c_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb92107f0295_method')) { function _lb92107f0295_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbaf6ea0df9d_property')) { function _lbaf6ea0df9d_property($_l, $_args) { extract($_args)
