...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4948d6898c_content')) { function _lb4948d6898c_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbecf36dabe2_children')) { function _lbecf36dabe2_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbbcd26bd697_method')) { function _lbbcd26bd697_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbf762d03898_property')) { function _lbf762d03898_property($_l, $_args) { extract($_args)
