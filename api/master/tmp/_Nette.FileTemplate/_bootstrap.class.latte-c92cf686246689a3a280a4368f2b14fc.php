...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3c291ef313_content')) { function _lb3c291ef313_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbf85e42968d_children')) { function _lbf85e42968d_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb7eb5a24e29_method')) { function _lb7eb5a24e29_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb2ad9a6f86f_property')) { function _lb2ad9a6f86f_property($_l, $_args) { extract($_args)
