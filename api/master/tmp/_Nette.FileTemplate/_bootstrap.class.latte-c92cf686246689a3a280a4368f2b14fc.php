...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba73f79ab6d_content')) { function _lba73f79ab6d_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb916f16dd1b_children')) { function _lb916f16dd1b_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lba63412069e_method')) { function _lba63412069e_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb04b691ffee_property')) { function _lb04b691ffee_property($_l, $_args) { extract($_args)
