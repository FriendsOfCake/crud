...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3aeee284c3_content')) { function _lb3aeee284c3_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb7436039b1a_children')) { function _lb7436039b1a_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb8e03779ac7_method')) { function _lb8e03779ac7_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbfc799daf61_property')) { function _lbfc799daf61_property($_l, $_args) { extract($_args)
