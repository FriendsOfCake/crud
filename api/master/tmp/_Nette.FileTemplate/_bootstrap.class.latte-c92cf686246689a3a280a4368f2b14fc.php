...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbee11697a0d_content')) { function _lbee11697a0d_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb8f4c1038e0_children')) { function _lb8f4c1038e0_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb01a53ce306_method')) { function _lb01a53ce306_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb424617aea3_property')) { function _lb424617aea3_property($_l, $_args) { extract($_args)
