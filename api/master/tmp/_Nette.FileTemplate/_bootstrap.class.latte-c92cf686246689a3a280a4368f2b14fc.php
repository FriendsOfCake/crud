...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb45c7904ff9_content')) { function _lb45c7904ff9_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb3caef1dd0c_children')) { function _lb3caef1dd0c_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbee76765b82_method')) { function _lbee76765b82_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb917dd38a74_property')) { function _lb917dd38a74_property($_l, $_args) { extract($_args)
