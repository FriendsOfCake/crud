...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb727cfa6824_content')) { function _lb727cfa6824_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb76d254b661_children')) { function _lb76d254b661_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbfda152d6ba_method')) { function _lbfda152d6ba_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb17d58cf842_property')) { function _lb17d58cf842_property($_l, $_args) { extract($_args)
