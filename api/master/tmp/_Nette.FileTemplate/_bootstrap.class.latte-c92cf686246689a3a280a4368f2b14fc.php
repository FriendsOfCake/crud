...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba5501dbb9e_content')) { function _lba5501dbb9e_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb57afce0876_children')) { function _lb57afce0876_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbf059347100_method')) { function _lbf059347100_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb1a9b812dc4_property')) { function _lb1a9b812dc4_property($_l, $_args) { extract($_args)
