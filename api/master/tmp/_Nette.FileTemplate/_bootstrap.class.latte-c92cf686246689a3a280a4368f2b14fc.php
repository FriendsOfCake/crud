...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb3fc5ca7ba_content')) { function _lbb3fc5ca7ba_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbd466e0486e_children')) { function _lbd466e0486e_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb42825324d1_method')) { function _lb42825324d1_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb2bfdf7af72_property')) { function _lb2bfdf7af72_property($_l, $_args) { extract($_args)
