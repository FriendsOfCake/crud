...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc6a91731ad_content')) { function _lbc6a91731ad_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb48b36f5b65_children')) { function _lb48b36f5b65_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb838b3ab7ed_method')) { function _lb838b3ab7ed_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbee62ae7498_property')) { function _lbee62ae7498_property($_l, $_args) { extract($_args)
