...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4c5c2a1b55_content')) { function _lb4c5c2a1b55_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lba0dc27deb2_children')) { function _lba0dc27deb2_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lba1f3c04c5f_method')) { function _lba1f3c04c5f_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb8f1f86c211_property')) { function _lb8f1f86c211_property($_l, $_args) { extract($_args)
