...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5e99fb4fc0_content')) { function _lb5e99fb4fc0_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb9d4c64f8a8_children')) { function _lb9d4c64f8a8_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbd440f55dd0_method')) { function _lbd440f55dd0_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbca952b2c9e_property')) { function _lbca952b2c9e_property($_l, $_args) { extract($_args)
