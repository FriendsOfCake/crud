...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb8a39669a1_content')) { function _lbb8a39669a1_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbf0e94c0343_children')) { function _lbf0e94c0343_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lba2b2b6b42b_method')) { function _lba2b2b6b42b_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb49981795eb_property')) { function _lb49981795eb_property($_l, $_args) { extract($_args)
