...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbbf3a2886e2_content')) { function _lbbf3a2886e2_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb074d7e81a8_children')) { function _lb074d7e81a8_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb8fa686d632_method')) { function _lb8fa686d632_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lba4358a00f1_property')) { function _lba4358a00f1_property($_l, $_args) { extract($_args)
