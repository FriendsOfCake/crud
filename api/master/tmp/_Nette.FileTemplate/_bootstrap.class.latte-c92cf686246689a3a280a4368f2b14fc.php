...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5007f8ec42_content')) { function _lb5007f8ec42_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb774de6d1e1_children')) { function _lb774de6d1e1_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lba292cfbb15_method')) { function _lba292cfbb15_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb23db2a3866_property')) { function _lb23db2a3866_property($_l, $_args) { extract($_args)
