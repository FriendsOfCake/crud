...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf77c69b196_content')) { function _lbf77c69b196_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb0349ffb5aa_children')) { function _lb0349ffb5aa_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb87ee13a48c_method')) { function _lb87ee13a48c_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb96b4b4a5c4_property')) { function _lb96b4b4a5c4_property($_l, $_args) { extract($_args)
