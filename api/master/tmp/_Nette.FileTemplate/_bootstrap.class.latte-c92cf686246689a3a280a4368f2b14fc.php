...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb195dbd60fa_content')) { function _lb195dbd60fa_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb6900c76ea2_children')) { function _lb6900c76ea2_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbc9776104e3_method')) { function _lbc9776104e3_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb27910f183d_property')) { function _lb27910f183d_property($_l, $_args) { extract($_args)
