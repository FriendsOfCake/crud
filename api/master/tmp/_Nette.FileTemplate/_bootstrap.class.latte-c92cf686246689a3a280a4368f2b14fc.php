...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb03e1168d1a_content')) { function _lb03e1168d1a_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbd6852a4c7c_children')) { function _lbd6852a4c7c_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbb6ef57f41a_method')) { function _lbb6ef57f41a_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbee1cb3d0b5_property')) { function _lbee1cb3d0b5_property($_l, $_args) { extract($_args)
