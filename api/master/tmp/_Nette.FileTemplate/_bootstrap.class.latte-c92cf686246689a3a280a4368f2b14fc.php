...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb27e28c6e4c_content')) { function _lb27e28c6e4c_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbb7f2fb57d1_children')) { function _lbb7f2fb57d1_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbfb5245b628_method')) { function _lbfb5245b628_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbfcc42d6f5b_property')) { function _lbfcc42d6f5b_property($_l, $_args) { extract($_args)
