...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf59a89dcf3_content')) { function _lbf59a89dcf3_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb2a386c00a5_children')) { function _lb2a386c00a5_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lba752112703_method')) { function _lba752112703_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb177e9cc530_property')) { function _lb177e9cc530_property($_l, $_args) { extract($_args)
