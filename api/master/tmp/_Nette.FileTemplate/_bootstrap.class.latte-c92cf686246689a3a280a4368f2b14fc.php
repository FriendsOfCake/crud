...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbbfe9e4a6e0_content')) { function _lbbfe9e4a6e0_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbf3e28362ef_children')) { function _lbf3e28362ef_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb66041becd8_method')) { function _lb66041becd8_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb1e3b829426_property')) { function _lb1e3b829426_property($_l, $_args) { extract($_args)
