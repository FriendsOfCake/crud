...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9bab91eb5f_content')) { function _lb9bab91eb5f_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb39d18c427e_children')) { function _lb39d18c427e_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbd66ba2e692_method')) { function _lbd66ba2e692_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb5e61c99bb2_property')) { function _lb5e61c99bb2_property($_l, $_args) { extract($_args)
