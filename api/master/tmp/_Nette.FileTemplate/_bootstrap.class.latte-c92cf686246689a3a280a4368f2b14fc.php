...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf4a483efce_content')) { function _lbf4a483efce_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb7a86334cd4_children')) { function _lb7a86334cd4_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb615a2fe817_method')) { function _lb615a2fe817_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbdea31bfe1b_property')) { function _lbdea31bfe1b_property($_l, $_args) { extract($_args)
