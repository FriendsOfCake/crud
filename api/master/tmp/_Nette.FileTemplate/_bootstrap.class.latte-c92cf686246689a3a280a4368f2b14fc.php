...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8af3aa274b_content')) { function _lb8af3aa274b_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb221b5b3d37_children')) { function _lb221b5b3d37_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbe0b9b73687_method')) { function _lbe0b9b73687_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb4461b87dc3_property')) { function _lb4461b87dc3_property($_l, $_args) { extract($_args)
