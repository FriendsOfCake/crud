...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb84e80de143_content')) { function _lb84e80de143_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbdf39340192_children')) { function _lbdf39340192_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbb779092792_method')) { function _lbb779092792_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb05de63cad7_property')) { function _lb05de63cad7_property($_l, $_args) { extract($_args)
