...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7f3c68ed94_content')) { function _lb7f3c68ed94_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb0ebe41e7c4_children')) { function _lb0ebe41e7c4_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb879ec9135a_method')) { function _lb879ec9135a_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb088ad18265_property')) { function _lb088ad18265_property($_l, $_args) { extract($_args)
