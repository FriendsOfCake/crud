...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba1ba05497d_content')) { function _lba1ba05497d_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb0be2a13894_children')) { function _lb0be2a13894_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb64b23d0438_method')) { function _lb64b23d0438_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lba0048f266f_property')) { function _lba0048f266f_property($_l, $_args) { extract($_args)
