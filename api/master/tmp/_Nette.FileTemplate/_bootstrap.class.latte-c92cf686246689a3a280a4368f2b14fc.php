...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb002f09e1c6_content')) { function _lb002f09e1c6_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb3e1d56c63b_children')) { function _lb3e1d56c63b_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb71a3606902_method')) { function _lb71a3606902_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbe81ea9b4c2_property')) { function _lbe81ea9b4c2_property($_l, $_args) { extract($_args)
