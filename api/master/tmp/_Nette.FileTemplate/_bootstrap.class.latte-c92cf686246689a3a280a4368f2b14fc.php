...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3f96edb0a4_content')) { function _lb3f96edb0a4_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbb8ca9d74da_children')) { function _lbb8ca9d74da_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbce587b1e7a_method')) { function _lbce587b1e7a_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb8f87187f14_property')) { function _lb8f87187f14_property($_l, $_args) { extract($_args)
