...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb83db4f16ee_content')) { function _lb83db4f16ee_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb9ba852fada_children')) { function _lb9ba852fada_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb8cbefce1d5_method')) { function _lb8cbefce1d5_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lba8fa4a69ed_property')) { function _lba8fa4a69ed_property($_l, $_args) { extract($_args)
