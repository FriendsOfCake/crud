...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0f8b184b46_content')) { function _lb0f8b184b46_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbef62d2b5ad_children')) { function _lbef62d2b5ad_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbcce8e6bc98_method')) { function _lbcce8e6bc98_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbbfccdc4946_property')) { function _lbbfccdc4946_property($_l, $_args) { extract($_args)
