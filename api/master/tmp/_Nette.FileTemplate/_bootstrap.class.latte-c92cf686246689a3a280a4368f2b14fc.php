...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb1988d2ef9_content')) { function _lbb1988d2ef9_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb57653f6f3e_children')) { function _lb57653f6f3e_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbe86f8846e5_method')) { function _lbe86f8846e5_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbc3616ef56d_property')) { function _lbc3616ef56d_property($_l, $_args) { extract($_args)
