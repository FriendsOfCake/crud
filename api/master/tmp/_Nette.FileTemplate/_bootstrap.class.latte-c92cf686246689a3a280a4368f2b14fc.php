...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe0ed3fe88e_content')) { function _lbe0ed3fe88e_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb3a6a076aa5_children')) { function _lb3a6a076aa5_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbf1e177b878_method')) { function _lbf1e177b878_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb286e2be5b0_property')) { function _lb286e2be5b0_property($_l, $_args) { extract($_args)
