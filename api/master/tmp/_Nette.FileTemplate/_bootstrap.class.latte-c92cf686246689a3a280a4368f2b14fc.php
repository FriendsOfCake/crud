...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4cfedc9285_content')) { function _lb4cfedc9285_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbe9c70e46cc_children')) { function _lbe9c70e46cc_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb91cda44a73_method')) { function _lb91cda44a73_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbb3bc7ab7ad_property')) { function _lbb3bc7ab7ad_property($_l, $_args) { extract($_args)
