...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6f9b1d671c_content')) { function _lb6f9b1d671c_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb3c21dba825_children')) { function _lb3c21dba825_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbc88cffad75_method')) { function _lbc88cffad75_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb2ee63138f1_property')) { function _lb2ee63138f1_property($_l, $_args) { extract($_args)
