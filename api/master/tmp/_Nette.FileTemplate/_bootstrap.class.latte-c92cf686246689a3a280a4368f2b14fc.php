...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb884da00c77_content')) { function _lb884da00c77_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lba7e60f3be0_children')) { function _lba7e60f3be0_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb55dd6227c1_method')) { function _lb55dd6227c1_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb9e29af75f6_property')) { function _lb9e29af75f6_property($_l, $_args) { extract($_args)
