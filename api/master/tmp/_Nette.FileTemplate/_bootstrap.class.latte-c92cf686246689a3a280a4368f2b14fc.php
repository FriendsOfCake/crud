...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe9141d8c61_content')) { function _lbe9141d8c61_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb6f05777c3e_children')) { function _lb6f05777c3e_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb38ce18856b_method')) { function _lb38ce18856b_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb39ef1433a7_property')) { function _lb39ef1433a7_property($_l, $_args) { extract($_args)
