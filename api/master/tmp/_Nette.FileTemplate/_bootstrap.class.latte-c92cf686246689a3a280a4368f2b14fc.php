...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbeec58456a4_content')) { function _lbeec58456a4_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbf154d37e2c_children')) { function _lbf154d37e2c_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb33c3c83299_method')) { function _lb33c3c83299_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb92cc755b6b_property')) { function _lb92cc755b6b_property($_l, $_args) { extract($_args)
