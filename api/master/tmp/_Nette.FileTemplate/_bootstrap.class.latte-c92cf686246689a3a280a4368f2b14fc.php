...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbbc3843e128_content')) { function _lbbc3843e128_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb54b67df260_children')) { function _lb54b67df260_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbb4a676f3cc_method')) { function _lbb4a676f3cc_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb415ab2e281_property')) { function _lb415ab2e281_property($_l, $_args) { extract($_args)
