...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb860e79ecff_content')) { function _lb860e79ecff_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb99486a4f5b_children')) { function _lb99486a4f5b_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb04b64d4fa7_method')) { function _lb04b64d4fa7_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbea805c41ff_property')) { function _lbea805c41ff_property($_l, $_args) { extract($_args)
