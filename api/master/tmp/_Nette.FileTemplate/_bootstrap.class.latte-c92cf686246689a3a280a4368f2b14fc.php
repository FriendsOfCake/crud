...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb0437c69bc_content')) { function _lbb0437c69bc_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb2adf17c065_children')) { function _lb2adf17c065_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb7d5018190a_method')) { function _lb7d5018190a_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbef688460ea_property')) { function _lbef688460ea_property($_l, $_args) { extract($_args)
