...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbde1327c275_content')) { function _lbde1327c275_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbb96876c6ca_children')) { function _lbb96876c6ca_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb41d7e70009_method')) { function _lb41d7e70009_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb1950415caf_property')) { function _lb1950415caf_property($_l, $_args) { extract($_args)
