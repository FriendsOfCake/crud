...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd9580c1545_content')) { function _lbd9580c1545_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb0ade63c196_children')) { function _lb0ade63c196_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb479d1c45be_method')) { function _lb479d1c45be_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb736ed5de4f_property')) { function _lb736ed5de4f_property($_l, $_args) { extract($_args)
