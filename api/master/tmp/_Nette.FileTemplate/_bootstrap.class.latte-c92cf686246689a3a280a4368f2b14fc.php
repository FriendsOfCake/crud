...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb172ed7cc00_content')) { function _lb172ed7cc00_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbb930a03e5b_children')) { function _lbb930a03e5b_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb08595b22c8_method')) { function _lb08595b22c8_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb2b999ff733_property')) { function _lb2b999ff733_property($_l, $_args) { extract($_args)
