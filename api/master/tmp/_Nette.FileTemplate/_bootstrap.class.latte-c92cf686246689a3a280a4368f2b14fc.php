...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc9044ffdb2_content')) { function _lbc9044ffdb2_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb0a052bdc6f_children')) { function _lb0a052bdc6f_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb3007f6c807_method')) { function _lb3007f6c807_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbbcd6a6f7ce_property')) { function _lbbcd6a6f7ce_property($_l, $_args) { extract($_args)
