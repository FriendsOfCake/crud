...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbbcfd862b6c_content')) { function _lbbcfd862b6c_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbe5368ebfa3_children')) { function _lbe5368ebfa3_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb2d5bd27f24_method')) { function _lb2d5bd27f24_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb105cea965b_property')) { function _lb105cea965b_property($_l, $_args) { extract($_args)
