...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb3665acc4d_content')) { function _lbb3665acc4d_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb0b07a02524_children')) { function _lb0b07a02524_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb6dc4e46ae1_method')) { function _lb6dc4e46ae1_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbec1a64a09a_property')) { function _lbec1a64a09a_property($_l, $_args) { extract($_args)
