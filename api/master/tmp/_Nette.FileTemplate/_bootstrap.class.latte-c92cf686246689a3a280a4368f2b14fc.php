...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2944d662ad_content')) { function _lb2944d662ad_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb5eeb54da45_children')) { function _lb5eeb54da45_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb7fe3629c4c_method')) { function _lb7fe3629c4c_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb3729da1c34_property')) { function _lb3729da1c34_property($_l, $_args) { extract($_args)
