...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb59527a31b6_content')) { function _lb59527a31b6_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbe0f60c8ce7_children')) { function _lbe0f60c8ce7_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbdfa6ce341a_method')) { function _lbdfa6ce341a_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb399651e3cb_property')) { function _lb399651e3cb_property($_l, $_args) { extract($_args)
