...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4fb8e6dfbe_content')) { function _lb4fb8e6dfbe_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbc4b17611b3_children')) { function _lbc4b17611b3_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb73144d2912_method')) { function _lb73144d2912_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbde5064faae_property')) { function _lbde5064faae_property($_l, $_args) { extract($_args)
