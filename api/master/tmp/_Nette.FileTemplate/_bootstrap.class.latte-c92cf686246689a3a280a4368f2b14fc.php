...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6862a5e1e6_content')) { function _lb6862a5e1e6_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb61bd10f72e_children')) { function _lb61bd10f72e_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb088c4953ff_method')) { function _lb088c4953ff_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb02b81c338e_property')) { function _lb02b81c338e_property($_l, $_args) { extract($_args)
