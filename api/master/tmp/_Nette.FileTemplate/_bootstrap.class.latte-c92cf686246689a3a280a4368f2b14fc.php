...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf0953f1faf_content')) { function _lbf0953f1faf_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb1f795d016c_children')) { function _lb1f795d016c_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb1572aa91e7_method')) { function _lb1572aa91e7_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbc986428e69_property')) { function _lbc986428e69_property($_l, $_args) { extract($_args)
