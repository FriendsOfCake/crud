...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb413b7a581c_content')) { function _lb413b7a581c_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb2d750b65a9_children')) { function _lb2d750b65a9_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lba45f13be2b_method')) { function _lba45f13be2b_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbb90d89956e_property')) { function _lbb90d89956e_property($_l, $_args) { extract($_args)
