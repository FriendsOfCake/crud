...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2737fb2326_content')) { function _lb2737fb2326_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbf14949344a_children')) { function _lbf14949344a_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb7436258bd8_method')) { function _lb7436258bd8_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbcb9c338f31_property')) { function _lbcb9c338f31_property($_l, $_args) { extract($_args)
