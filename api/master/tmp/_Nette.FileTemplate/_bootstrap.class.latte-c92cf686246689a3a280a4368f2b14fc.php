...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5ad57ca3ad_content')) { function _lb5ad57ca3ad_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb154adcb21b_children')) { function _lb154adcb21b_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb7ad9dfab46_method')) { function _lb7ad9dfab46_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb042b7317d2_property')) { function _lb042b7317d2_property($_l, $_args) { extract($_args)
