...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1da3832122_content')) { function _lb1da3832122_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbbe5d39eccc_children')) { function _lbbe5d39eccc_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbfd6ac9b297_method')) { function _lbfd6ac9b297_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb81983c31d9_property')) { function _lb81983c31d9_property($_l, $_args) { extract($_args)
