...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc224a0862c_content')) { function _lbc224a0862c_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbceb6b713e0_children')) { function _lbceb6b713e0_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb678d8b5603_method')) { function _lb678d8b5603_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb51029b0540_property')) { function _lb51029b0540_property($_l, $_args) { extract($_args)
