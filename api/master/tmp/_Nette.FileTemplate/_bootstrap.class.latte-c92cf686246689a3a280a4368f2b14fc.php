...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9f628e252c_content')) { function _lb9f628e252c_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb5f12e5f887_children')) { function _lb5f12e5f887_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbb355a3b6bc_method')) { function _lbb355a3b6bc_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb1f569d8c04_property')) { function _lb1f569d8c04_property($_l, $_args) { extract($_args)
