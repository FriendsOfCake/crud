...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2b6eccac6e_content')) { function _lb2b6eccac6e_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbbc0618a725_children')) { function _lbbc0618a725_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbfcd6644eae_method')) { function _lbfcd6644eae_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb619be4329f_property')) { function _lb619be4329f_property($_l, $_args) { extract($_args)
