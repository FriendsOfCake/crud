...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb735ab29f1e_content')) { function _lb735ab29f1e_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb184cddc2df_children')) { function _lb184cddc2df_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbb52d3e044d_method')) { function _lbb52d3e044d_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbed3db55330_property')) { function _lbed3db55330_property($_l, $_args) { extract($_args)
