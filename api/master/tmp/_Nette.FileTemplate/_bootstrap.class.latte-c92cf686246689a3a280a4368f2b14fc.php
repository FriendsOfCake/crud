...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2d7dd11767_content')) { function _lb2d7dd11767_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb9a6255b6d1_children')) { function _lb9a6255b6d1_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb37c8e1fcc3_method')) { function _lb37c8e1fcc3_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbef504d234c_property')) { function _lbef504d234c_property($_l, $_args) { extract($_args)
