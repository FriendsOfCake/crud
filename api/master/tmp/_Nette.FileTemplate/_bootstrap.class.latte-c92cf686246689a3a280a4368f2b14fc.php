...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3d9b56d58f_content')) { function _lb3d9b56d58f_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb2a6bb72fd5_children')) { function _lb2a6bb72fd5_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb87ba0cd0b6_method')) { function _lb87ba0cd0b6_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbf167933e20_property')) { function _lbf167933e20_property($_l, $_args) { extract($_args)
