...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb133c0d2b06_content')) { function _lb133c0d2b06_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbe353cf133c_children')) { function _lbe353cf133c_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb54e364d8a8_method')) { function _lb54e364d8a8_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb0e0933df47_property')) { function _lb0e0933df47_property($_l, $_args) { extract($_args)
