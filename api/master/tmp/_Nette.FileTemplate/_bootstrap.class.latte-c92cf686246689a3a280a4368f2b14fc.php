...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb4eb15acfa_content')) { function _lbb4eb15acfa_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbcab34ae74e_children')) { function _lbcab34ae74e_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb9a8703c3cb_method')) { function _lb9a8703c3cb_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb26703a1698_property')) { function _lb26703a1698_property($_l, $_args) { extract($_args)
