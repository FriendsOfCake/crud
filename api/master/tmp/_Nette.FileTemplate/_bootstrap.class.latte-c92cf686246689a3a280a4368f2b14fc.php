...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5d4a825bd5_content')) { function _lb5d4a825bd5_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb40857735ec_children')) { function _lb40857735ec_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbda3e82e193_method')) { function _lbda3e82e193_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbd350e2c0d8_property')) { function _lbd350e2c0d8_property($_l, $_args) { extract($_args)
