...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba9d5d179b6_content')) { function _lba9d5d179b6_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb2867f3dad3_children')) { function _lb2867f3dad3_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb650640ba91_method')) { function _lb650640ba91_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb4203d83ecb_property')) { function _lb4203d83ecb_property($_l, $_args) { extract($_args)
