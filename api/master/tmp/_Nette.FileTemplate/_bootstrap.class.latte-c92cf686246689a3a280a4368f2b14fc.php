...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8275fd79be_content')) { function _lb8275fd79be_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbdc8eb3d670_children')) { function _lbdc8eb3d670_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb6070d28fb4_method')) { function _lb6070d28fb4_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb5db130f6b4_property')) { function _lb5db130f6b4_property($_l, $_args) { extract($_args)
