...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbef19b252f9_content')) { function _lbef19b252f9_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbd3bda00999_children')) { function _lbd3bda00999_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbd106b49e6b_method')) { function _lbd106b49e6b_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb8ef059be59_property')) { function _lb8ef059be59_property($_l, $_args) { extract($_args)
