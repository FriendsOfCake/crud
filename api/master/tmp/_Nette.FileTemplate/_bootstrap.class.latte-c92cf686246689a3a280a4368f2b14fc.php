...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb289ccb5b16_content')) { function _lb289ccb5b16_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb6c64e0bd5e_children')) { function _lb6c64e0bd5e_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbeaa6d45d98_method')) { function _lbeaa6d45d98_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbeeea5d2315_property')) { function _lbeeea5d2315_property($_l, $_args) { extract($_args)
