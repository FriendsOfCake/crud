...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7e7d83a949_content')) { function _lb7e7d83a949_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb677c1d0567_children')) { function _lb677c1d0567_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lba01799c014_method')) { function _lba01799c014_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lba2ca398fd3_property')) { function _lba2ca398fd3_property($_l, $_args) { extract($_args)
