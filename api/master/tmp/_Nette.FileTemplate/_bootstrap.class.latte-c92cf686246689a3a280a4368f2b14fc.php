...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9efde10e1a_content')) { function _lb9efde10e1a_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb37740f7ca2_children')) { function _lb37740f7ca2_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbb4d99e5430_method')) { function _lbb4d99e5430_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb1cfb2c8c7b_property')) { function _lb1cfb2c8c7b_property($_l, $_args) { extract($_args)
