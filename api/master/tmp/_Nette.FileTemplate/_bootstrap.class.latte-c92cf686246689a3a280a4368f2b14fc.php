...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf85e6a1b2f_content')) { function _lbf85e6a1b2f_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbc43a65927c_children')) { function _lbc43a65927c_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb22b8b0186e_method')) { function _lb22b8b0186e_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb41fa3d209a_property')) { function _lb41fa3d209a_property($_l, $_args) { extract($_args)
