...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5236b08af6_content')) { function _lb5236b08af6_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb77f9eebb78_children')) { function _lb77f9eebb78_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb35d6084fe5_method')) { function _lb35d6084fe5_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbfffaba7e4d_property')) { function _lbfffaba7e4d_property($_l, $_args) { extract($_args)
