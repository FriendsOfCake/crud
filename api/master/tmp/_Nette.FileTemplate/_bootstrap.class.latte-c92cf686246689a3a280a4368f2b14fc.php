...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb75646ef6f4_content')) { function _lb75646ef6f4_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb5f855072c2_children')) { function _lb5f855072c2_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbf345ad3f09_method')) { function _lbf345ad3f09_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb2a792da3d7_property')) { function _lb2a792da3d7_property($_l, $_args) { extract($_args)
