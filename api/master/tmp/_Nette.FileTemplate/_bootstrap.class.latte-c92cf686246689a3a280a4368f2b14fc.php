...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3a644626c6_content')) { function _lb3a644626c6_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbfc5702c05a_children')) { function _lbfc5702c05a_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb1f919b0567_method')) { function _lb1f919b0567_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb61b85c6174_property')) { function _lb61b85c6174_property($_l, $_args) { extract($_args)
