...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb97c4a679b_content')) { function _lbb97c4a679b_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb06ee843c84_children')) { function _lb06ee843c84_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb67dea5b17b_method')) { function _lb67dea5b17b_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb231842ca4d_property')) { function _lb231842ca4d_property($_l, $_args) { extract($_args)
