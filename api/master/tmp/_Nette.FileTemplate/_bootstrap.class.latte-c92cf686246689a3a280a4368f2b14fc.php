...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0136a79aed_content')) { function _lb0136a79aed_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb12d13806c6_children')) { function _lb12d13806c6_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb52f72e63a3_method')) { function _lb52f72e63a3_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb1e12257889_property')) { function _lb1e12257889_property($_l, $_args) { extract($_args)
