...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb80d32ff652_content')) { function _lb80d32ff652_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb45ee8d07ef_children')) { function _lb45ee8d07ef_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbf89760fc7d_method')) { function _lbf89760fc7d_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbaca43e2669_property')) { function _lbaca43e2669_property($_l, $_args) { extract($_args)
