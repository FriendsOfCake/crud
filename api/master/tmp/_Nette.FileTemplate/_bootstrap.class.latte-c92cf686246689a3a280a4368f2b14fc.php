...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb75f2608bc4_content')) { function _lb75f2608bc4_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbcc7da246a1_children')) { function _lbcc7da246a1_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb1552427e45_method')) { function _lb1552427e45_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb2176464cef_property')) { function _lb2176464cef_property($_l, $_args) { extract($_args)
