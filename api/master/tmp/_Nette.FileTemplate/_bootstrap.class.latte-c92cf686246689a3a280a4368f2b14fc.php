...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb81fa56a422_content')) { function _lb81fa56a422_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb193fd8c581_children')) { function _lb193fd8c581_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbee0cce9a6a_method')) { function _lbee0cce9a6a_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb6e2c50da78_property')) { function _lb6e2c50da78_property($_l, $_args) { extract($_args)
