...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5b59b7a31a_content')) { function _lb5b59b7a31a_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbc07ff9c0c9_children')) { function _lbc07ff9c0c9_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbd7b97b50d3_method')) { function _lbd7b97b50d3_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb5ebbdf2a31_property')) { function _lb5ebbdf2a31_property($_l, $_args) { extract($_args)
