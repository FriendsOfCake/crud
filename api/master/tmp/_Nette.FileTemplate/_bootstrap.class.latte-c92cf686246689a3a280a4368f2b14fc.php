...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe4cc809bf4_content')) { function _lbe4cc809bf4_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbb41c0c5c42_children')) { function _lbb41c0c5c42_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbac35bb1b91_method')) { function _lbac35bb1b91_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbcb421577fd_property')) { function _lbcb421577fd_property($_l, $_args) { extract($_args)
