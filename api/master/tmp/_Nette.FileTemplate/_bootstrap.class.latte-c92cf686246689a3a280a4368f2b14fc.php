...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc837bfb11b_content')) { function _lbc837bfb11b_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb86e2963892_children')) { function _lb86e2963892_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb0805a591d9_method')) { function _lb0805a591d9_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbabdb2535ff_property')) { function _lbabdb2535ff_property($_l, $_args) { extract($_args)
