...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbbd984c06de_content')) { function _lbbd984c06de_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lba571d8a408_children')) { function _lba571d8a408_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbcbb1a79e4c_method')) { function _lbcbb1a79e4c_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbf60736e9cc_property')) { function _lbf60736e9cc_property($_l, $_args) { extract($_args)
