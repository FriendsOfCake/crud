...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb02f9d5fdd8_content')) { function _lb02f9d5fdd8_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbbbc541912a_children')) { function _lbbbc541912a_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbb7a1eec6bd_method')) { function _lbb7a1eec6bd_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbef21617fea_property')) { function _lbef21617fea_property($_l, $_args) { extract($_args)
