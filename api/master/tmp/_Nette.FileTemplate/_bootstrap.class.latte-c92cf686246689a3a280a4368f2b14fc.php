...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4a54a5834b_content')) { function _lb4a54a5834b_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbfdc7ef35ad_children')) { function _lbfdc7ef35ad_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbe0104bdef3_method')) { function _lbe0104bdef3_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb72fa3d9a65_property')) { function _lb72fa3d9a65_property($_l, $_args) { extract($_args)
