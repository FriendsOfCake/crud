...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0e0fc76cbe_content')) { function _lb0e0fc76cbe_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbfaf811d364_children')) { function _lbfaf811d364_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbde3ac754b4_method')) { function _lbde3ac754b4_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbc01c15ab03_property')) { function _lbc01c15ab03_property($_l, $_args) { extract($_args)
