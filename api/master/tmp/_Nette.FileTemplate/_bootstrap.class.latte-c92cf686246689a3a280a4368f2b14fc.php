...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0d2c967826_content')) { function _lb0d2c967826_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbda6b840474_children')) { function _lbda6b840474_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lbf503dd1427_method')) { function _lbf503dd1427_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb532c063640_property')) { function _lb532c063640_property($_l, $_args) { extract($_args)
