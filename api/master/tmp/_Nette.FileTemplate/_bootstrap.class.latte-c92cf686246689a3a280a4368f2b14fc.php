...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbcfd1e22e32_content')) { function _lbcfd1e22e32_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbb4502ccf92_children')) { function _lbb4502ccf92_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb703f3aca25_method')) { function _lb703f3aca25_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb93992be94e_property')) { function _lb93992be94e_property($_l, $_args) { extract($_args)
