...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba8de721c1a_content')) { function _lba8de721c1a_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lba5fd34e50e_children')) { function _lba5fd34e50e_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb752e732741_method')) { function _lb752e732741_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb9e5b4f3f33_property')) { function _lb9e5b4f3f33_property($_l, $_args) { extract($_args)
