...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf526ef03ff_content')) { function _lbf526ef03ff_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lbc8efdb62bc_children')) { function _lbc8efdb62bc_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb1dc56b2a01_method')) { function _lb1dc56b2a01_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lb623be2e113_property')) { function _lb623be2e113_property($_l, $_args) { extract($_args)
