...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb63f6a4f952_content')) { function _lb63f6a4f952_content($_l, $_args) { extract($_args)
...
// block children
//
if (!function_exists($_l->blocks['children'][] = '_lb329eee7e8f_children')) { function _lb329eee7e8f_children($_l, $_args) { extract($_args)
?>		<p class="elementList">
...
// block method
//
if (!function_exists($_l->blocks['method'][] = '_lb5767b89ff5_method')) { function _lb5767b89ff5_method($_l, $_args) { extract($_args)
...
// block property
//
if (!function_exists($_l->blocks['property'][] = '_lbeb3f0fa615_property')) { function _lbeb3f0fa615_property($_l, $_args) { extract($_args)
