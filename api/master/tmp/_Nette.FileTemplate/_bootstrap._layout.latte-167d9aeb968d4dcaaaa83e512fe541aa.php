...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbcaae309f84_elements')) { function _lbcaae309f84_elements($_l, $_args) { extract($_args)
?>			<ul>
