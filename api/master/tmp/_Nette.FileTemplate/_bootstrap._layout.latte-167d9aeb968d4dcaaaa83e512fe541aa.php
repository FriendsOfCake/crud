...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbe15def2af8_elements')) { function _lbe15def2af8_elements($_l, $_args) { extract($_args)
?>			<ul>
