...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb2ca2211b8a_elements')) { function _lb2ca2211b8a_elements($_l, $_args) { extract($_args)
?>			<ul>
