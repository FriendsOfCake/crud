...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lba836c3d2c5_elements')) { function _lba836c3d2c5_elements($_l, $_args) { extract($_args)
?>			<ul>
