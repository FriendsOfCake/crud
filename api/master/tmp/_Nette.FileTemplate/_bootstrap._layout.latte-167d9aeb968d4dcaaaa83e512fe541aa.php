...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbf6d86bd498_elements')) { function _lbf6d86bd498_elements($_l, $_args) { extract($_args)
?>			<ul>
