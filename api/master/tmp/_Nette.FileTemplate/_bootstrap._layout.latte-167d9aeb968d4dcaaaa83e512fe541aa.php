...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbf2105b4f36_elements')) { function _lbf2105b4f36_elements($_l, $_args) { extract($_args)
?>			<ul>
