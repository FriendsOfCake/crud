...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbfd674d5479_elements')) { function _lbfd674d5479_elements($_l, $_args) { extract($_args)
?>			<ul>
