...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbf8e58e2e1d_elements')) { function _lbf8e58e2e1d_elements($_l, $_args) { extract($_args)
?>			<ul>
