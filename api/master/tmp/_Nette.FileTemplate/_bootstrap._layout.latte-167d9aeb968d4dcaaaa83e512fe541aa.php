...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbdc8155351f_elements')) { function _lbdc8155351f_elements($_l, $_args) { extract($_args)
?>			<ul>
