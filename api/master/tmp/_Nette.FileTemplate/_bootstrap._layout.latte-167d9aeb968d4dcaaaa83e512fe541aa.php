...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb80ea50d7ea_elements')) { function _lb80ea50d7ea_elements($_l, $_args) { extract($_args)
?>			<ul>
