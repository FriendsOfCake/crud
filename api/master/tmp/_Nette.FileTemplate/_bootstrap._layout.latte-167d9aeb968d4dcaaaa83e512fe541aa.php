...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb3b4349ef5e_elements')) { function _lb3b4349ef5e_elements($_l, $_args) { extract($_args)
?>			<ul>
