...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb92d8edbcfc_elements')) { function _lb92d8edbcfc_elements($_l, $_args) { extract($_args)
?>			<ul>
