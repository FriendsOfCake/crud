...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb4cb3b5dcdf_elements')) { function _lb4cb3b5dcdf_elements($_l, $_args) { extract($_args)
?>			<ul>
