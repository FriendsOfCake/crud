...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbc13f14673b_elements')) { function _lbc13f14673b_elements($_l, $_args) { extract($_args)
?>			<ul>
