...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbf86fbca872_elements')) { function _lbf86fbca872_elements($_l, $_args) { extract($_args)
?>			<ul>
