...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbbad905e5d2_elements')) { function _lbbad905e5d2_elements($_l, $_args) { extract($_args)
?>			<ul>
