...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbfb16749aaf_elements')) { function _lbfb16749aaf_elements($_l, $_args) { extract($_args)
?>			<ul>
