...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb0813d2ace6_elements')) { function _lb0813d2ace6_elements($_l, $_args) { extract($_args)
?>			<ul>
