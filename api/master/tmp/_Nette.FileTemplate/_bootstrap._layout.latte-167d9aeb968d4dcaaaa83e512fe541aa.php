...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb1fd4c08a0f_elements')) { function _lb1fd4c08a0f_elements($_l, $_args) { extract($_args)
?>			<ul>
