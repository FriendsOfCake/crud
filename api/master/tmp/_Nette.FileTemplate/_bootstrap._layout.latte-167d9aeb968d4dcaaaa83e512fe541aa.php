...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb3db0d98537_elements')) { function _lb3db0d98537_elements($_l, $_args) { extract($_args)
?>			<ul>
