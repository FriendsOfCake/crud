...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbbbcf6e0413_elements')) { function _lbbbcf6e0413_elements($_l, $_args) { extract($_args)
?>			<ul>
