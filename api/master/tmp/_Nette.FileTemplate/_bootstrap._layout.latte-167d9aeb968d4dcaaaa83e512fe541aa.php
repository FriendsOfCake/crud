...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb854e21daf7_elements')) { function _lb854e21daf7_elements($_l, $_args) { extract($_args)
?>			<ul>
