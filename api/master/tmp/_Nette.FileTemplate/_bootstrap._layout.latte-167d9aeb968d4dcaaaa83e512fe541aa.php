...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb6fd37d973f_elements')) { function _lb6fd37d973f_elements($_l, $_args) { extract($_args)
?>			<ul>
