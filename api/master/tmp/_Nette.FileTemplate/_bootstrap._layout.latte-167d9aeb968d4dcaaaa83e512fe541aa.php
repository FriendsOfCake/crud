...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb32096d1b19_elements')) { function _lb32096d1b19_elements($_l, $_args) { extract($_args)
?>			<ul>
