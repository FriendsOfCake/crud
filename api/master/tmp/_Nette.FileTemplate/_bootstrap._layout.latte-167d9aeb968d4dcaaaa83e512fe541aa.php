...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbc42cee4b73_elements')) { function _lbc42cee4b73_elements($_l, $_args) { extract($_args)
?>			<ul>
