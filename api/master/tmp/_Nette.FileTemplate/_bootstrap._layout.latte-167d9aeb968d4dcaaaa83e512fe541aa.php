...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb511c79917a_elements')) { function _lb511c79917a_elements($_l, $_args) { extract($_args)
?>			<ul>
