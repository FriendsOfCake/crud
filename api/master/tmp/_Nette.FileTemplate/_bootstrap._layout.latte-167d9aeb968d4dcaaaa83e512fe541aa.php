...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbd706b1fb71_elements')) { function _lbd706b1fb71_elements($_l, $_args) { extract($_args)
?>			<ul>
