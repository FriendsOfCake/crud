...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb20b16798df_elements')) { function _lb20b16798df_elements($_l, $_args) { extract($_args)
?>			<ul>
