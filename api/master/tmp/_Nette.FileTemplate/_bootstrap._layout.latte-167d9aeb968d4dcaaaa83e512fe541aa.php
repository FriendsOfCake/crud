...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb60d83c8a3c_elements')) { function _lb60d83c8a3c_elements($_l, $_args) { extract($_args)
?>			<ul>
