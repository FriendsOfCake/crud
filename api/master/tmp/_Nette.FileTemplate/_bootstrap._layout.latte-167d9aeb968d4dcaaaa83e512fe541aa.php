...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbe8937830b8_elements')) { function _lbe8937830b8_elements($_l, $_args) { extract($_args)
?>			<ul>
