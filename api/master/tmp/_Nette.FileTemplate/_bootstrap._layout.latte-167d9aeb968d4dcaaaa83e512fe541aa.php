...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb29b253f684_elements')) { function _lb29b253f684_elements($_l, $_args) { extract($_args)
?>			<ul>
