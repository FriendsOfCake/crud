...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbd9b53b89b6_elements')) { function _lbd9b53b89b6_elements($_l, $_args) { extract($_args)
?>			<ul>
