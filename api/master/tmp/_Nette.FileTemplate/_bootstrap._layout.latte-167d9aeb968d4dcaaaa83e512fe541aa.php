...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbdba558582d_elements')) { function _lbdba558582d_elements($_l, $_args) { extract($_args)
?>			<ul>
