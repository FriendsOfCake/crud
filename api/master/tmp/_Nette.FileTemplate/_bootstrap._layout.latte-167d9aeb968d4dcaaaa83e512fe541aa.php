...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb8f95eea1a9_elements')) { function _lb8f95eea1a9_elements($_l, $_args) { extract($_args)
?>			<ul>
