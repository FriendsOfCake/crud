...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbbd15e46f9f_elements')) { function _lbbd15e46f9f_elements($_l, $_args) { extract($_args)
?>			<ul>
