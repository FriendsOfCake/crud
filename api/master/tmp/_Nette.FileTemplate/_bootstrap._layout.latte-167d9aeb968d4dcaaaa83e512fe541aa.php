...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbf7f563adb1_elements')) { function _lbf7f563adb1_elements($_l, $_args) { extract($_args)
?>			<ul>
