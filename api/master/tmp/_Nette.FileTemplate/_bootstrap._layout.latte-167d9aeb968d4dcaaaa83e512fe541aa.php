...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbc0d28dfa9c_elements')) { function _lbc0d28dfa9c_elements($_l, $_args) { extract($_args)
?>			<ul>
