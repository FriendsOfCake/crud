...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb855c998787_elements')) { function _lb855c998787_elements($_l, $_args) { extract($_args)
?>			<ul>
