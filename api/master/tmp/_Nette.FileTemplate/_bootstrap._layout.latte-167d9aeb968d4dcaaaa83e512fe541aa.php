...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb8b39f9b6c0_elements')) { function _lb8b39f9b6c0_elements($_l, $_args) { extract($_args)
?>			<ul>
