...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbce516cd5a6_elements')) { function _lbce516cd5a6_elements($_l, $_args) { extract($_args)
?>			<ul>
