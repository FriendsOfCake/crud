...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb04e24f3c5e_elements')) { function _lb04e24f3c5e_elements($_l, $_args) { extract($_args)
?>			<ul>
