...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb641ba31014_elements')) { function _lb641ba31014_elements($_l, $_args) { extract($_args)
?>			<ul>
