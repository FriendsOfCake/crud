...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb93d35947e6_elements')) { function _lb93d35947e6_elements($_l, $_args) { extract($_args)
?>			<ul>
