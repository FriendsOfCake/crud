...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb6ca3e634ef_elements')) { function _lb6ca3e634ef_elements($_l, $_args) { extract($_args)
?>			<ul>
