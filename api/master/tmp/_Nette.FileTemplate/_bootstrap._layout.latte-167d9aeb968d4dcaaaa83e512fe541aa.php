...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lba8e395eb6d_elements')) { function _lba8e395eb6d_elements($_l, $_args) { extract($_args)
?>			<ul>
