...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb405a82e19a_elements')) { function _lb405a82e19a_elements($_l, $_args) { extract($_args)
?>			<ul>
