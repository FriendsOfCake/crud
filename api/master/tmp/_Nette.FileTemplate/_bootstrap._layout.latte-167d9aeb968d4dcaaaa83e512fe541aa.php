...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb0d0cef615b_elements')) { function _lb0d0cef615b_elements($_l, $_args) { extract($_args)
?>			<ul>
