...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb5261ebde7c_elements')) { function _lb5261ebde7c_elements($_l, $_args) { extract($_args)
?>			<ul>
