...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbc9b2c324dc_elements')) { function _lbc9b2c324dc_elements($_l, $_args) { extract($_args)
?>			<ul>
