...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbbe3c5419ea_elements')) { function _lbbe3c5419ea_elements($_l, $_args) { extract($_args)
?>			<ul>
