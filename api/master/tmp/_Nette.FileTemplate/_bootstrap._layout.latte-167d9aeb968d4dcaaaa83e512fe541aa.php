...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb9a204770b5_elements')) { function _lb9a204770b5_elements($_l, $_args) { extract($_args)
?>			<ul>
