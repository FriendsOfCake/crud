...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb4617bf1fa5_elements')) { function _lb4617bf1fa5_elements($_l, $_args) { extract($_args)
?>			<ul>
