...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb96e7a5865c_elements')) { function _lb96e7a5865c_elements($_l, $_args) { extract($_args)
?>			<ul>
