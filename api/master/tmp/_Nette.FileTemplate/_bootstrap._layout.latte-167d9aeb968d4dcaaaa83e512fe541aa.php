...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb8b8b46ad8f_elements')) { function _lb8b8b46ad8f_elements($_l, $_args) { extract($_args)
?>			<ul>
