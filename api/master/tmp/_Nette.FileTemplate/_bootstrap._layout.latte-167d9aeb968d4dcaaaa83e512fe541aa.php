...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbcf418d3a01_elements')) { function _lbcf418d3a01_elements($_l, $_args) { extract($_args)
?>			<ul>
