...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb3af917563f_elements')) { function _lb3af917563f_elements($_l, $_args) { extract($_args)
?>			<ul>
