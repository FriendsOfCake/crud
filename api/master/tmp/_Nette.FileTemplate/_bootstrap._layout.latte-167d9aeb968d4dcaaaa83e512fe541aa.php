...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbd25af5f58d_elements')) { function _lbd25af5f58d_elements($_l, $_args) { extract($_args)
?>			<ul>
