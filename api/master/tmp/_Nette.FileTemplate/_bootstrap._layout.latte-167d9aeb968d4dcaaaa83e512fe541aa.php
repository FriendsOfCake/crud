...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbd66bd6842c_elements')) { function _lbd66bd6842c_elements($_l, $_args) { extract($_args)
?>			<ul>
