...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lba259528fc8_elements')) { function _lba259528fc8_elements($_l, $_args) { extract($_args)
?>			<ul>
