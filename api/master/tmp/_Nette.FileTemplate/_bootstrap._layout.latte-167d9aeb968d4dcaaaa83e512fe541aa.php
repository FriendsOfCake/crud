...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb7becb090e2_elements')) { function _lb7becb090e2_elements($_l, $_args) { extract($_args)
?>			<ul>
