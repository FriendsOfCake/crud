...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb1a9434892e_elements')) { function _lb1a9434892e_elements($_l, $_args) { extract($_args)
?>			<ul>
