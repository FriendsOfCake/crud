...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb65eb7ef92e_elements')) { function _lb65eb7ef92e_elements($_l, $_args) { extract($_args)
?>			<ul>
