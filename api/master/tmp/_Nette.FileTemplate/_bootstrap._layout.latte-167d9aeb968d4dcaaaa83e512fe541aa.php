...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb408897c86d_elements')) { function _lb408897c86d_elements($_l, $_args) { extract($_args)
?>			<ul>
