...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb6b17830fec_elements')) { function _lb6b17830fec_elements($_l, $_args) { extract($_args)
?>			<ul>
