...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb749de1287b_elements')) { function _lb749de1287b_elements($_l, $_args) { extract($_args)
?>			<ul>
