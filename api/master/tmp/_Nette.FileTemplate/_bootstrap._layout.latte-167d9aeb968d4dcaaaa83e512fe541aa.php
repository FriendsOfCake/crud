...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb2d770b5b6f_elements')) { function _lb2d770b5b6f_elements($_l, $_args) { extract($_args)
?>			<ul>
