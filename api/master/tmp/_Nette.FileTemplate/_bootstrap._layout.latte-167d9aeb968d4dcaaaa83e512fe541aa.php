...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb23dadf4239_elements')) { function _lb23dadf4239_elements($_l, $_args) { extract($_args)
?>			<ul>
