...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lba292adf1f7_elements')) { function _lba292adf1f7_elements($_l, $_args) { extract($_args)
?>			<ul>
