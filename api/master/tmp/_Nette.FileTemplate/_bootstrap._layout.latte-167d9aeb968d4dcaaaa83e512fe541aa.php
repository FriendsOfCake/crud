...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb8154f4ed43_elements')) { function _lb8154f4ed43_elements($_l, $_args) { extract($_args)
?>			<ul>
