...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb522cfc118e_elements')) { function _lb522cfc118e_elements($_l, $_args) { extract($_args)
?>			<ul>
