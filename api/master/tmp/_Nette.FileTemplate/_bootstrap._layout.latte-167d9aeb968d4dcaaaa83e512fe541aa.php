...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbf702d5ffce_elements')) { function _lbf702d5ffce_elements($_l, $_args) { extract($_args)
?>			<ul>
