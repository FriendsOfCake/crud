...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb59716c490c_elements')) { function _lb59716c490c_elements($_l, $_args) { extract($_args)
?>			<ul>
