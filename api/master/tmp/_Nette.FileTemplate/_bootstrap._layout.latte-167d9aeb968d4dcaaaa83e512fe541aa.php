...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb31cdf59ebf_elements')) { function _lb31cdf59ebf_elements($_l, $_args) { extract($_args)
?>			<ul>
