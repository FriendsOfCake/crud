...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb2b53da403d_elements')) { function _lb2b53da403d_elements($_l, $_args) { extract($_args)
?>			<ul>
