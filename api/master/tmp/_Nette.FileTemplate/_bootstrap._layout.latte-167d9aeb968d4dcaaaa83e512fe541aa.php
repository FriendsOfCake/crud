...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb080df507ed_elements')) { function _lb080df507ed_elements($_l, $_args) { extract($_args)
?>			<ul>
