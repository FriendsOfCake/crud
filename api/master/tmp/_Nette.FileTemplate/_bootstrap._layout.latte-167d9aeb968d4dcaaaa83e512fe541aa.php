...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb05b36aba87_elements')) { function _lb05b36aba87_elements($_l, $_args) { extract($_args)
?>			<ul>
