...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbe69352677f_elements')) { function _lbe69352677f_elements($_l, $_args) { extract($_args)
?>			<ul>
