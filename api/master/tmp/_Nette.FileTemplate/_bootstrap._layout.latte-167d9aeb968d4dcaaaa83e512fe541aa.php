...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb7d0ad205d2_elements')) { function _lb7d0ad205d2_elements($_l, $_args) { extract($_args)
?>			<ul>
