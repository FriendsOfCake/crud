...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbef546c2525_elements')) { function _lbef546c2525_elements($_l, $_args) { extract($_args)
?>			<ul>
