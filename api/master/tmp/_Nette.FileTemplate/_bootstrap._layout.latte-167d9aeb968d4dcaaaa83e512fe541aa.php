...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbd994ef330a_elements')) { function _lbd994ef330a_elements($_l, $_args) { extract($_args)
?>			<ul>
