...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb2e3cf4526e_elements')) { function _lb2e3cf4526e_elements($_l, $_args) { extract($_args)
?>			<ul>
