...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lba0ea031dfe_elements')) { function _lba0ea031dfe_elements($_l, $_args) { extract($_args)
?>			<ul>
