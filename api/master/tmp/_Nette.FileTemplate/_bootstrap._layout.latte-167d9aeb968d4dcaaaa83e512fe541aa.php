...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb34d7134f45_elements')) { function _lb34d7134f45_elements($_l, $_args) { extract($_args)
?>			<ul>
