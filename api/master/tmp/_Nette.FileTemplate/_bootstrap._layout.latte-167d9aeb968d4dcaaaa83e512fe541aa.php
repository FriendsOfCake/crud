...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb7f2f31b041_elements')) { function _lb7f2f31b041_elements($_l, $_args) { extract($_args)
?>			<ul>
