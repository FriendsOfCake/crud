...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb1cec487dfd_elements')) { function _lb1cec487dfd_elements($_l, $_args) { extract($_args)
?>			<ul>
