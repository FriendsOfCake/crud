...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb6668f7ed3a_elements')) { function _lb6668f7ed3a_elements($_l, $_args) { extract($_args)
?>			<ul>
