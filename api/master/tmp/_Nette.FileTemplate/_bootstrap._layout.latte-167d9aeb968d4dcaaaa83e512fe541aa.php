...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb18a025b86e_elements')) { function _lb18a025b86e_elements($_l, $_args) { extract($_args)
?>			<ul>
