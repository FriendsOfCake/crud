...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb0e70ef04dd_elements')) { function _lb0e70ef04dd_elements($_l, $_args) { extract($_args)
?>			<ul>
