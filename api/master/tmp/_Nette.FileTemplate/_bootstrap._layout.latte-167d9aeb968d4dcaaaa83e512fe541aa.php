...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb2a417ce592_elements')) { function _lb2a417ce592_elements($_l, $_args) { extract($_args)
?>			<ul>
