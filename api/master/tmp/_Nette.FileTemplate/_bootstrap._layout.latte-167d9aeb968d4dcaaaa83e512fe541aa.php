...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb891781721b_elements')) { function _lb891781721b_elements($_l, $_args) { extract($_args)
?>			<ul>
