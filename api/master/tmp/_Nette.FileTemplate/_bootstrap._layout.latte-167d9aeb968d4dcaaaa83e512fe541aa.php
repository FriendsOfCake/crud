...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb75f3a8b2b1_elements')) { function _lb75f3a8b2b1_elements($_l, $_args) { extract($_args)
?>			<ul>
