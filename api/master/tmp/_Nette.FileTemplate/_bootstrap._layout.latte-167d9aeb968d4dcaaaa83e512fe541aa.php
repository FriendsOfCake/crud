...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lba4c8d67d41_elements')) { function _lba4c8d67d41_elements($_l, $_args) { extract($_args)
?>			<ul>
