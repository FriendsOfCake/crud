...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb21b55422de_elements')) { function _lb21b55422de_elements($_l, $_args) { extract($_args)
?>			<ul>
