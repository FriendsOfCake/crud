...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb7cd92e27c5_elements')) { function _lb7cd92e27c5_elements($_l, $_args) { extract($_args)
?>			<ul>
