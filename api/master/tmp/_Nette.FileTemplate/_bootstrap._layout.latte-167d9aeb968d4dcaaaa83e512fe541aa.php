...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb2d9e8075f9_elements')) { function _lb2d9e8075f9_elements($_l, $_args) { extract($_args)
?>			<ul>
