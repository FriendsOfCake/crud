...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbb09876c78e_elements')) { function _lbb09876c78e_elements($_l, $_args) { extract($_args)
?>			<ul>
