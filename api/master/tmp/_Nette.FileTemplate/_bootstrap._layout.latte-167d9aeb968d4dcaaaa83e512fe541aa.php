...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbe636f89c78_elements')) { function _lbe636f89c78_elements($_l, $_args) { extract($_args)
?>			<ul>
