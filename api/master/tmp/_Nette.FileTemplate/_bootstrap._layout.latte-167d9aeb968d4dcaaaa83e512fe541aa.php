...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbec73250655_elements')) { function _lbec73250655_elements($_l, $_args) { extract($_args)
?>			<ul>
