...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb582d855eb8_elements')) { function _lb582d855eb8_elements($_l, $_args) { extract($_args)
?>			<ul>
