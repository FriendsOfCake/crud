...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb84289a48bf_elements')) { function _lb84289a48bf_elements($_l, $_args) { extract($_args)
?>			<ul>
