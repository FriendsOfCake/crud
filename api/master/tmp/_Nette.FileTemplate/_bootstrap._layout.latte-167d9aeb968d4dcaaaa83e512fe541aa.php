...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb5ee87a4ecb_elements')) { function _lb5ee87a4ecb_elements($_l, $_args) { extract($_args)
?>			<ul>
