...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb6dd28b9fa5_elements')) { function _lb6dd28b9fa5_elements($_l, $_args) { extract($_args)
?>			<ul>
