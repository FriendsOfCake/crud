...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb2f8487f654_elements')) { function _lb2f8487f654_elements($_l, $_args) { extract($_args)
?>			<ul>
