...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb8db816618e_elements')) { function _lb8db816618e_elements($_l, $_args) { extract($_args)
?>			<ul>
