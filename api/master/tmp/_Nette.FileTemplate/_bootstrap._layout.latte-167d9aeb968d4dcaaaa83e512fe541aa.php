...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbb0efd43448_elements')) { function _lbb0efd43448_elements($_l, $_args) { extract($_args)
?>			<ul>
