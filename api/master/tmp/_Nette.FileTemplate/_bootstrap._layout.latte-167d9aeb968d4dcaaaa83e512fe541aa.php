...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbf879ec1619_elements')) { function _lbf879ec1619_elements($_l, $_args) { extract($_args)
?>			<ul>
