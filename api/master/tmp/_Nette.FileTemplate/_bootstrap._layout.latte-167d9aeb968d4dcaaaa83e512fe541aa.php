...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb71527f7cc4_elements')) { function _lb71527f7cc4_elements($_l, $_args) { extract($_args)
?>			<ul>
