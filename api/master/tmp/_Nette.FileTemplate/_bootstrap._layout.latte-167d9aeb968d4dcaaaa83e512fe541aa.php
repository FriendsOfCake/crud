...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb8d476d823b_elements')) { function _lb8d476d823b_elements($_l, $_args) { extract($_args)
?>			<ul>
