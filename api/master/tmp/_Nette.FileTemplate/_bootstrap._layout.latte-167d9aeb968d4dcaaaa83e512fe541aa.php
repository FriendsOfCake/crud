...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbe306ce427c_elements')) { function _lbe306ce427c_elements($_l, $_args) { extract($_args)
?>			<ul>
