...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb45242b5b93_elements')) { function _lb45242b5b93_elements($_l, $_args) { extract($_args)
?>			<ul>
