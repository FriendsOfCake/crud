...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb0d9328c3fa_elements')) { function _lb0d9328c3fa_elements($_l, $_args) { extract($_args)
?>			<ul>
