...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb47c02cd0b1_elements')) { function _lb47c02cd0b1_elements($_l, $_args) { extract($_args)
?>			<ul>
