...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb06d631f736_elements')) { function _lb06d631f736_elements($_l, $_args) { extract($_args)
?>			<ul>
