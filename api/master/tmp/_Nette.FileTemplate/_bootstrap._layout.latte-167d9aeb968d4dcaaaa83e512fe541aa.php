...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbecf1c2ce2e_elements')) { function _lbecf1c2ce2e_elements($_l, $_args) { extract($_args)
?>			<ul>
