...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbcbc12ed3fc_elements')) { function _lbcbc12ed3fc_elements($_l, $_args) { extract($_args)
?>			<ul>
