...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbcd992e91a0_elements')) { function _lbcd992e91a0_elements($_l, $_args) { extract($_args)
?>			<ul>
