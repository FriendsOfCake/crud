...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb918250d12a_elements')) { function _lb918250d12a_elements($_l, $_args) { extract($_args)
?>			<ul>
