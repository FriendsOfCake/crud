...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb8323165181_elements')) { function _lb8323165181_elements($_l, $_args) { extract($_args)
?>			<ul>
