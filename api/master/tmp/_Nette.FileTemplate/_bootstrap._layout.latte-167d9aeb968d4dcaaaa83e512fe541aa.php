...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lba36b0ba4c2_elements')) { function _lba36b0ba4c2_elements($_l, $_args) { extract($_args)
?>			<ul>
