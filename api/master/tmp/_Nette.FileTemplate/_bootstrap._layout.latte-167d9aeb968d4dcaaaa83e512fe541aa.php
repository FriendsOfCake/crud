...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb2f20570c92_elements')) { function _lb2f20570c92_elements($_l, $_args) { extract($_args)
?>			<ul>
