...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb6a2876f337_elements')) { function _lb6a2876f337_elements($_l, $_args) { extract($_args)
?>			<ul>
