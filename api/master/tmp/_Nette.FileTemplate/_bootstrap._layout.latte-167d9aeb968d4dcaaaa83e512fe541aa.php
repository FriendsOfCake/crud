...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbc19e1f7875_elements')) { function _lbc19e1f7875_elements($_l, $_args) { extract($_args)
?>			<ul>
