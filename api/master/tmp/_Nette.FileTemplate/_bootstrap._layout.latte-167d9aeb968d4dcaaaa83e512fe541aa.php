...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb957bfb5b31_elements')) { function _lb957bfb5b31_elements($_l, $_args) { extract($_args)
?>			<ul>
