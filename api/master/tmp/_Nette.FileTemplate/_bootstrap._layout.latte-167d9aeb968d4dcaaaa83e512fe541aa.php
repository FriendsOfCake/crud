...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb17ce03dd7a_elements')) { function _lb17ce03dd7a_elements($_l, $_args) { extract($_args)
?>			<ul>
