...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb9e0c688baa_elements')) { function _lb9e0c688baa_elements($_l, $_args) { extract($_args)
?>			<ul>
