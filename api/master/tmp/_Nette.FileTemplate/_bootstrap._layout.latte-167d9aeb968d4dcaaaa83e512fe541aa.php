...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb53def7bc0d_elements')) { function _lb53def7bc0d_elements($_l, $_args) { extract($_args)
?>			<ul>
