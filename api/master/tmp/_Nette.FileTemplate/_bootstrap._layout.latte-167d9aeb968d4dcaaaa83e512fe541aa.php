...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb1d0490ec75_elements')) { function _lb1d0490ec75_elements($_l, $_args) { extract($_args)
?>			<ul>
