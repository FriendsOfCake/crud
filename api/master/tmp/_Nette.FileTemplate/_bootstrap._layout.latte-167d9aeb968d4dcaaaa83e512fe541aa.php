...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb3e38c937d3_elements')) { function _lb3e38c937d3_elements($_l, $_args) { extract($_args)
?>			<ul>
