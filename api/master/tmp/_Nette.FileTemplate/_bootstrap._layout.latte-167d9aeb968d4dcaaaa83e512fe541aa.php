...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbf78c41474f_elements')) { function _lbf78c41474f_elements($_l, $_args) { extract($_args)
?>			<ul>
