...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb3cd2f4f46b_elements')) { function _lb3cd2f4f46b_elements($_l, $_args) { extract($_args)
?>			<ul>
