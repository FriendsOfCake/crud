...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbd1c91f8f87_elements')) { function _lbd1c91f8f87_elements($_l, $_args) { extract($_args)
?>			<ul>
