...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbf253a7bea8_elements')) { function _lbf253a7bea8_elements($_l, $_args) { extract($_args)
?>			<ul>
