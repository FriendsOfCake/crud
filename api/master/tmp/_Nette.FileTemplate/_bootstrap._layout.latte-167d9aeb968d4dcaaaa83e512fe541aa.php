...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbbec5f0a636_elements')) { function _lbbec5f0a636_elements($_l, $_args) { extract($_args)
?>			<ul>
