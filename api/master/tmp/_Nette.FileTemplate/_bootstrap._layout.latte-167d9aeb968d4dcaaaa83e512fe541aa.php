...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbf649b406e6_elements')) { function _lbf649b406e6_elements($_l, $_args) { extract($_args)
?>			<ul>
