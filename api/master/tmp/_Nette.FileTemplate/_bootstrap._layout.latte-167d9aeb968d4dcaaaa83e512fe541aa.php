...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbcf5c1b7afa_elements')) { function _lbcf5c1b7afa_elements($_l, $_args) { extract($_args)
?>			<ul>
