...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb2d7e2175d1_elements')) { function _lb2d7e2175d1_elements($_l, $_args) { extract($_args)
?>			<ul>
