...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbb716364d6a_elements')) { function _lbb716364d6a_elements($_l, $_args) { extract($_args)
?>			<ul>
