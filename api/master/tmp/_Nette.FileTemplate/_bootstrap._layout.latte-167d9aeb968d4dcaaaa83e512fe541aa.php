...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb190eb509dc_elements')) { function _lb190eb509dc_elements($_l, $_args) { extract($_args)
?>			<ul>
