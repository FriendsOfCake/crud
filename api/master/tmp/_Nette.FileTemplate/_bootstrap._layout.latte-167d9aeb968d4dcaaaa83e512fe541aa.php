...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb4b271a996d_elements')) { function _lb4b271a996d_elements($_l, $_args) { extract($_args)
?>			<ul>
