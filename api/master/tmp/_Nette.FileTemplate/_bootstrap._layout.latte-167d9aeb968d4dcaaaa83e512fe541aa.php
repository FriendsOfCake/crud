...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbf3ac9b332f_elements')) { function _lbf3ac9b332f_elements($_l, $_args) { extract($_args)
?>			<ul>
