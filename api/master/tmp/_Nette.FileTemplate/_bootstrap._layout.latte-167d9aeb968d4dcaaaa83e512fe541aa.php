...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb883edcbdbf_elements')) { function _lb883edcbdbf_elements($_l, $_args) { extract($_args)
?>			<ul>
