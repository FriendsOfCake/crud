...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb7de5474f8f_elements')) { function _lb7de5474f8f_elements($_l, $_args) { extract($_args)
?>			<ul>
