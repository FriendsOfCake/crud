...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbd5c3271aae_elements')) { function _lbd5c3271aae_elements($_l, $_args) { extract($_args)
?>			<ul>
