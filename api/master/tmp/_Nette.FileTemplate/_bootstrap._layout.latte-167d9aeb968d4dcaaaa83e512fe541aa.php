...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb119892595a_elements')) { function _lb119892595a_elements($_l, $_args) { extract($_args)
?>			<ul>
