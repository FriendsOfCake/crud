...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb8f8eb8b25f_elements')) { function _lb8f8eb8b25f_elements($_l, $_args) { extract($_args)
?>			<ul>
