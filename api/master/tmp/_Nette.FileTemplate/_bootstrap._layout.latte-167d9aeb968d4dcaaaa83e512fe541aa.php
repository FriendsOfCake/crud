...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb609da3031a_elements')) { function _lb609da3031a_elements($_l, $_args) { extract($_args)
?>			<ul>
