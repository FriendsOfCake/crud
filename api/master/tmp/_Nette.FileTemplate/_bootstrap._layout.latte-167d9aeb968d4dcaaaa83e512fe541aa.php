...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb1fcef59dca_elements')) { function _lb1fcef59dca_elements($_l, $_args) { extract($_args)
?>			<ul>
