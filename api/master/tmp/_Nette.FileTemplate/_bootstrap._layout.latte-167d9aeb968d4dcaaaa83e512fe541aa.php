...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb46f591df75_elements')) { function _lb46f591df75_elements($_l, $_args) { extract($_args)
?>			<ul>
