...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb37cc02ec86_elements')) { function _lb37cc02ec86_elements($_l, $_args) { extract($_args)
?>			<ul>
