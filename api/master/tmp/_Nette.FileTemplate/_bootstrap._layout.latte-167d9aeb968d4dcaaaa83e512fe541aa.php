...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbe5d2b7d6c8_elements')) { function _lbe5d2b7d6c8_elements($_l, $_args) { extract($_args)
?>			<ul>
