...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbc0c58a5cd5_elements')) { function _lbc0c58a5cd5_elements($_l, $_args) { extract($_args)
?>			<ul>
