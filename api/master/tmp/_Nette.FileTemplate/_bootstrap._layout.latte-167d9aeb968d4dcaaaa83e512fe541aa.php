...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb18d6cd1002_elements')) { function _lb18d6cd1002_elements($_l, $_args) { extract($_args)
?>			<ul>
