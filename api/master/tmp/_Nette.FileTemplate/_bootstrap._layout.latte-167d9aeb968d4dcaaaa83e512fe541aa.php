...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb3bfe6a823a_elements')) { function _lb3bfe6a823a_elements($_l, $_args) { extract($_args)
?>			<ul>
