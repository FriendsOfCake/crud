...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb08f426dee1_elements')) { function _lb08f426dee1_elements($_l, $_args) { extract($_args)
?>			<ul>
