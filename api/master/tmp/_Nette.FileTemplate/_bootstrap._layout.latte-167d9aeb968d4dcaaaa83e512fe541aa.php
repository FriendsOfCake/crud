...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbb42d1eab04_elements')) { function _lbb42d1eab04_elements($_l, $_args) { extract($_args)
?>			<ul>
