...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb50db9ad7d4_elements')) { function _lb50db9ad7d4_elements($_l, $_args) { extract($_args)
?>			<ul>
