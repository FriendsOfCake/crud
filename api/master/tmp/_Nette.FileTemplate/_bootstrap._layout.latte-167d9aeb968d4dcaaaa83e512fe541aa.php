...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbd5f741b578_elements')) { function _lbd5f741b578_elements($_l, $_args) { extract($_args)
?>			<ul>
