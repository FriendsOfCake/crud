...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb4c066c4926_elements')) { function _lb4c066c4926_elements($_l, $_args) { extract($_args)
?>			<ul>
