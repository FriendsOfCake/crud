...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb45c50bc6e6_elements')) { function _lb45c50bc6e6_elements($_l, $_args) { extract($_args)
?>			<ul>
