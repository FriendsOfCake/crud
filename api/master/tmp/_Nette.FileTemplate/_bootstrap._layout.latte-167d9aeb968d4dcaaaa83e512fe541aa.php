...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbcd7ff75646_elements')) { function _lbcd7ff75646_elements($_l, $_args) { extract($_args)
?>			<ul>
