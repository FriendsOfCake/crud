...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb90dafc2f7a_elements')) { function _lb90dafc2f7a_elements($_l, $_args) { extract($_args)
?>			<ul>
