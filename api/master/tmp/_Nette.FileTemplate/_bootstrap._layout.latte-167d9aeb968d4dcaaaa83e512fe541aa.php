...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbd0268ee64f_elements')) { function _lbd0268ee64f_elements($_l, $_args) { extract($_args)
?>			<ul>
