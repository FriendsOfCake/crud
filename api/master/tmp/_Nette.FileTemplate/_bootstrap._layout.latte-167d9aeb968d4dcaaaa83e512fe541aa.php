...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbba8faa62ec_elements')) { function _lbba8faa62ec_elements($_l, $_args) { extract($_args)
?>			<ul>
