...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb6bbb366b6f_elements')) { function _lb6bbb366b6f_elements($_l, $_args) { extract($_args)
?>			<ul>
