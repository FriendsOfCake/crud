...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb2233dca3ec_elements')) { function _lb2233dca3ec_elements($_l, $_args) { extract($_args)
?>			<ul>
