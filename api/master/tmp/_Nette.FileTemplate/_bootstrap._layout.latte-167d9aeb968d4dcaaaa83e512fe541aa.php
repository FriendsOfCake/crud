...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb3948162fe7_elements')) { function _lb3948162fe7_elements($_l, $_args) { extract($_args)
?>			<ul>
