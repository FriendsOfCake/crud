...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb4ce8415c96_elements')) { function _lb4ce8415c96_elements($_l, $_args) { extract($_args)
?>			<ul>
