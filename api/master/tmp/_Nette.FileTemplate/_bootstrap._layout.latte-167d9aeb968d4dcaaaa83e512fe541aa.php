...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb33cf29c372_elements')) { function _lb33cf29c372_elements($_l, $_args) { extract($_args)
?>			<ul>
