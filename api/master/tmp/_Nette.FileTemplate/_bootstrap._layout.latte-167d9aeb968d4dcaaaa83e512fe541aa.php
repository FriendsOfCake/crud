...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb75c8246af5_elements')) { function _lb75c8246af5_elements($_l, $_args) { extract($_args)
?>			<ul>
