...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbdbf651d9c6_elements')) { function _lbdbf651d9c6_elements($_l, $_args) { extract($_args)
?>			<ul>
