...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb6e49d610ab_elements')) { function _lb6e49d610ab_elements($_l, $_args) { extract($_args)
?>			<ul>
