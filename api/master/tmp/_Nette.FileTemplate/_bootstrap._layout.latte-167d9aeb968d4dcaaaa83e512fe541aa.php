...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbbfbd4650e3_elements')) { function _lbbfbd4650e3_elements($_l, $_args) { extract($_args)
?>			<ul>
