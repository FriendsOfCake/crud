...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb7ea3897b76_elements')) { function _lb7ea3897b76_elements($_l, $_args) { extract($_args)
?>			<ul>
