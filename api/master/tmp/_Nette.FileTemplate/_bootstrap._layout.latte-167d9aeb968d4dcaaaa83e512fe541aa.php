...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb1881203f9d_elements')) { function _lb1881203f9d_elements($_l, $_args) { extract($_args)
?>			<ul>
