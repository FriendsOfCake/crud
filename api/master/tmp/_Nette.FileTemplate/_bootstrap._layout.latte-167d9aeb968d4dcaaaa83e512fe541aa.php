...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbc8be913937_elements')) { function _lbc8be913937_elements($_l, $_args) { extract($_args)
?>			<ul>
