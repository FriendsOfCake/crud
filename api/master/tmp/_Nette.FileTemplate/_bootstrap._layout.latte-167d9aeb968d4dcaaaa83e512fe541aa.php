...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbb8360f03d1_elements')) { function _lbb8360f03d1_elements($_l, $_args) { extract($_args)
?>			<ul>
