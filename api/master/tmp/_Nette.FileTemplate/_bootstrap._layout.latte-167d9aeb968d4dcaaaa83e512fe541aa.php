...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb9d534fa42d_elements')) { function _lb9d534fa42d_elements($_l, $_args) { extract($_args)
?>			<ul>
