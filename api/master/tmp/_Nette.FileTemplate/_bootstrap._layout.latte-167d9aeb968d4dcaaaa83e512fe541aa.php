...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb22b51c20cd_elements')) { function _lb22b51c20cd_elements($_l, $_args) { extract($_args)
?>			<ul>
