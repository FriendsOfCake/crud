...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb1e3e482690_elements')) { function _lb1e3e482690_elements($_l, $_args) { extract($_args)
?>			<ul>
