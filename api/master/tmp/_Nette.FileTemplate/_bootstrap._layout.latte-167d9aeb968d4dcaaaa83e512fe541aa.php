...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbb02f1ae61b_elements')) { function _lbb02f1ae61b_elements($_l, $_args) { extract($_args)
?>			<ul>
