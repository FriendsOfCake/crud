...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbbe0d781bca_elements')) { function _lbbe0d781bca_elements($_l, $_args) { extract($_args)
?>			<ul>
