...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb37b9ce5507_elements')) { function _lb37b9ce5507_elements($_l, $_args) { extract($_args)
?>			<ul>
