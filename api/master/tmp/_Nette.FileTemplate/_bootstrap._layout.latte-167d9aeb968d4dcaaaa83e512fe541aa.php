...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lb6f10b93207_elements')) { function _lb6f10b93207_elements($_l, $_args) { extract($_args)
?>			<ul>
