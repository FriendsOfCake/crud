...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbc456e89a00_elements')) { function _lbc456e89a00_elements($_l, $_args) { extract($_args)
?>			<ul>
