...
// block elements
//
if (!function_exists($_l->blocks['elements'][] = '_lbb17092f4cc_elements')) { function _lbb17092f4cc_elements($_l, $_args) { extract($_args)
?>			<ul>
