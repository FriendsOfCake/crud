...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7612f7a404_content')) { function _lb7612f7a404_content($_l, $_args) { extract($_args)
?><div id="content">
