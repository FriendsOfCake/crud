...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb103a409712_content')) { function _lb103a409712_content($_l, $_args) { extract($_args)
?><div id="content">
