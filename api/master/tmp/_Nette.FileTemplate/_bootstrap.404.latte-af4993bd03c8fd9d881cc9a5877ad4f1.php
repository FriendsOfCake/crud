...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1718e0debf_content')) { function _lb1718e0debf_content($_l, $_args) { extract($_args)
?><div id="content">
