...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe7ccb8d3dd_content')) { function _lbe7ccb8d3dd_content($_l, $_args) { extract($_args)
?><div id="content">
