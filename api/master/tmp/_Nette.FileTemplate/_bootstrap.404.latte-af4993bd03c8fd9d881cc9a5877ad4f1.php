...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba21d8a6e6c_content')) { function _lba21d8a6e6c_content($_l, $_args) { extract($_args)
?><div id="content">
