...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf2f8007299_content')) { function _lbf2f8007299_content($_l, $_args) { extract($_args)
?><div id="content">
