...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb27be6e8bd3_content')) { function _lb27be6e8bd3_content($_l, $_args) { extract($_args)
?><div id="content">
