...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbeadda06e22_content')) { function _lbeadda06e22_content($_l, $_args) { extract($_args)
?><div id="content">
