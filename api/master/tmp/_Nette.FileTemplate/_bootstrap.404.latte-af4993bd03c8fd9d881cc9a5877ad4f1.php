...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb664a9eee5c_content')) { function _lb664a9eee5c_content($_l, $_args) { extract($_args)
?><div id="content">
