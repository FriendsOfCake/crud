...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb114186107f_content')) { function _lb114186107f_content($_l, $_args) { extract($_args)
?><div id="content">
