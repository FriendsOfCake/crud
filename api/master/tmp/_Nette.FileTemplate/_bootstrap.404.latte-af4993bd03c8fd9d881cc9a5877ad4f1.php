...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8ef6aba3ce_content')) { function _lb8ef6aba3ce_content($_l, $_args) { extract($_args)
?><div id="content">
