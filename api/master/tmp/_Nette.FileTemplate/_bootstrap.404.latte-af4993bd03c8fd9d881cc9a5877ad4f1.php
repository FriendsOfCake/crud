...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbed9063c4a7_content')) { function _lbed9063c4a7_content($_l, $_args) { extract($_args)
?><div id="content">
