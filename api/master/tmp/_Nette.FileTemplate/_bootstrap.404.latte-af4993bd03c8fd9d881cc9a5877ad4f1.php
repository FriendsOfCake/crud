...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb96cecc2b1b_content')) { function _lb96cecc2b1b_content($_l, $_args) { extract($_args)
?><div id="content">
