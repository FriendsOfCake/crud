...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1cd50e6a28_content')) { function _lb1cd50e6a28_content($_l, $_args) { extract($_args)
?><div id="content">
