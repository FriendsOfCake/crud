...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4b6e3b1ffa_content')) { function _lb4b6e3b1ffa_content($_l, $_args) { extract($_args)
?><div id="content">
