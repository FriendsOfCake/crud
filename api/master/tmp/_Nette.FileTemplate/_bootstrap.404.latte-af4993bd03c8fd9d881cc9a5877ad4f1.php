...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0590718ef2_content')) { function _lb0590718ef2_content($_l, $_args) { extract($_args)
?><div id="content">
