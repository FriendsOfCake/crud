...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdcbde9d151_content')) { function _lbdcbde9d151_content($_l, $_args) { extract($_args)
?><div id="content">
