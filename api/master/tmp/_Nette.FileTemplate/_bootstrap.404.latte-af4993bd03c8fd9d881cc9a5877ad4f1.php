...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf4cab61cd6_content')) { function _lbf4cab61cd6_content($_l, $_args) { extract($_args)
?><div id="content">
