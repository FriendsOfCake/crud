...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb178396311d_content')) { function _lb178396311d_content($_l, $_args) { extract($_args)
?><div id="content">
