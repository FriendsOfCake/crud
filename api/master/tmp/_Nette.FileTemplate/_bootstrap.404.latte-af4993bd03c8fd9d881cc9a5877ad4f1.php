...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb9ba91167c_content')) { function _lbb9ba91167c_content($_l, $_args) { extract($_args)
?><div id="content">
