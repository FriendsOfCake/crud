...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb43a914446e_content')) { function _lb43a914446e_content($_l, $_args) { extract($_args)
?><div id="content">
