...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6b806c2107_content')) { function _lb6b806c2107_content($_l, $_args) { extract($_args)
?><div id="content">
