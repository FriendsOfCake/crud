...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8e2364901b_content')) { function _lb8e2364901b_content($_l, $_args) { extract($_args)
?><div id="content">
