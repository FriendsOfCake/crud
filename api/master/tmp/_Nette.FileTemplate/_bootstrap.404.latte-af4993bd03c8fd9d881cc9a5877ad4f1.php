...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe600c43453_content')) { function _lbe600c43453_content($_l, $_args) { extract($_args)
?><div id="content">
