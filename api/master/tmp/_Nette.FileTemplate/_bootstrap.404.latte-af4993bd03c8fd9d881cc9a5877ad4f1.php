...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe9318ff6e4_content')) { function _lbe9318ff6e4_content($_l, $_args) { extract($_args)
?><div id="content">
