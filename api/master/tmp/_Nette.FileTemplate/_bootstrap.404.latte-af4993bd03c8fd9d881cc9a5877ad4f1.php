...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2ab1a74c2d_content')) { function _lb2ab1a74c2d_content($_l, $_args) { extract($_args)
?><div id="content">
