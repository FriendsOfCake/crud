...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb179f98b0ae_content')) { function _lb179f98b0ae_content($_l, $_args) { extract($_args)
?><div id="content">
