...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3f08d5300f_content')) { function _lb3f08d5300f_content($_l, $_args) { extract($_args)
?><div id="content">
