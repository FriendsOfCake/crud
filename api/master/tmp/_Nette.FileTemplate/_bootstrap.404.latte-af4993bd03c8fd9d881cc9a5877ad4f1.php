...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb409e1952e_content')) { function _lbb409e1952e_content($_l, $_args) { extract($_args)
?><div id="content">
