...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc2111573cc_content')) { function _lbc2111573cc_content($_l, $_args) { extract($_args)
?><div id="content">
