...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb817e726959_content')) { function _lb817e726959_content($_l, $_args) { extract($_args)
?><div id="content">
