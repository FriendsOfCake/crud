...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5537f10017_content')) { function _lb5537f10017_content($_l, $_args) { extract($_args)
?><div id="content">
