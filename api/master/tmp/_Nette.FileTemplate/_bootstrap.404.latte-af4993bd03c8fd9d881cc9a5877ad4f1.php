...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0cfc6c4a19_content')) { function _lb0cfc6c4a19_content($_l, $_args) { extract($_args)
?><div id="content">
