...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2020beab13_content')) { function _lb2020beab13_content($_l, $_args) { extract($_args)
?><div id="content">
