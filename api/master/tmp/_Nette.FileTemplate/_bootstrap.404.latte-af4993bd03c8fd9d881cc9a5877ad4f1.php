...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3ef7baac0e_content')) { function _lb3ef7baac0e_content($_l, $_args) { extract($_args)
?><div id="content">
