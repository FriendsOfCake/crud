...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0256a1cb45_content')) { function _lb0256a1cb45_content($_l, $_args) { extract($_args)
?><div id="content">
