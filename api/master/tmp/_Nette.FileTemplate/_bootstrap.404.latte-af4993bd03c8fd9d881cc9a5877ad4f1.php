...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0eb8b7b792_content')) { function _lb0eb8b7b792_content($_l, $_args) { extract($_args)
?><div id="content">
