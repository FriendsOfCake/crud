...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5ae32fac00_content')) { function _lb5ae32fac00_content($_l, $_args) { extract($_args)
?><div id="content">
