...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb86c35ed1df_content')) { function _lb86c35ed1df_content($_l, $_args) { extract($_args)
?><div id="content">
