...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc51d17ca01_content')) { function _lbc51d17ca01_content($_l, $_args) { extract($_args)
?><div id="content">
