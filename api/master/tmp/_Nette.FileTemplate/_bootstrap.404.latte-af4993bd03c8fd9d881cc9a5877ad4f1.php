...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba3690cc6c9_content')) { function _lba3690cc6c9_content($_l, $_args) { extract($_args)
?><div id="content">
