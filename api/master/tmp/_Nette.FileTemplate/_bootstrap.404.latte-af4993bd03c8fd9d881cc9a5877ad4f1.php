...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb22fc5a90e2_content')) { function _lb22fc5a90e2_content($_l, $_args) { extract($_args)
?><div id="content">
