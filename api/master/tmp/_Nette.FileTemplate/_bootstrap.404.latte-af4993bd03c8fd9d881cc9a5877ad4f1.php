...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb6eb4ec6f3_content')) { function _lbb6eb4ec6f3_content($_l, $_args) { extract($_args)
?><div id="content">
