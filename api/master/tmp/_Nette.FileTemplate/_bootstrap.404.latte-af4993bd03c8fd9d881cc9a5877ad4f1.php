...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbff30a0847a_content')) { function _lbff30a0847a_content($_l, $_args) { extract($_args)
?><div id="content">
