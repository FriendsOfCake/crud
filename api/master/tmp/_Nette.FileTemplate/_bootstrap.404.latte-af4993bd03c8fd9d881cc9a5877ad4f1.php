...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb673b9add98_content')) { function _lb673b9add98_content($_l, $_args) { extract($_args)
?><div id="content">
