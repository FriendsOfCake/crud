...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba1ba08a33f_content')) { function _lba1ba08a33f_content($_l, $_args) { extract($_args)
?><div id="content">
