...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7fed9aba8d_content')) { function _lb7fed9aba8d_content($_l, $_args) { extract($_args)
?><div id="content">
