...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba54c7bc4b6_content')) { function _lba54c7bc4b6_content($_l, $_args) { extract($_args)
?><div id="content">
