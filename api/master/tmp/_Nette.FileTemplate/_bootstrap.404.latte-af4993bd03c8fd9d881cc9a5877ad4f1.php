...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6edfd0ac02_content')) { function _lb6edfd0ac02_content($_l, $_args) { extract($_args)
?><div id="content">
