...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbca54cab4e0_content')) { function _lbca54cab4e0_content($_l, $_args) { extract($_args)
?><div id="content">
