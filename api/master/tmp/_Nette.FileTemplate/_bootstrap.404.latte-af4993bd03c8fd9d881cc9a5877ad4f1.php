...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbff8bc80c82_content')) { function _lbff8bc80c82_content($_l, $_args) { extract($_args)
?><div id="content">
