...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb938c40d7d5_content')) { function _lb938c40d7d5_content($_l, $_args) { extract($_args)
?><div id="content">
