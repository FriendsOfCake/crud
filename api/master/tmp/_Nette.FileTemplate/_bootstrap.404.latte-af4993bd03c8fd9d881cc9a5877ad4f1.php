...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0cf0a933b0_content')) { function _lb0cf0a933b0_content($_l, $_args) { extract($_args)
?><div id="content">
