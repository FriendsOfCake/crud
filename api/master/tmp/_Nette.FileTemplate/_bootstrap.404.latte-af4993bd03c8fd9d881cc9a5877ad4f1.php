...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6add34f6f2_content')) { function _lb6add34f6f2_content($_l, $_args) { extract($_args)
?><div id="content">
