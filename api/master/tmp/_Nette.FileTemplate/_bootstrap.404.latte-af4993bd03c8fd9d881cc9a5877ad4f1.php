...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc82aa8695f_content')) { function _lbc82aa8695f_content($_l, $_args) { extract($_args)
?><div id="content">
