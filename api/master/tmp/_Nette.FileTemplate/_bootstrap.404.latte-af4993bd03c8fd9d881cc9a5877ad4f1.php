...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbeaf645da1e_content')) { function _lbeaf645da1e_content($_l, $_args) { extract($_args)
?><div id="content">
