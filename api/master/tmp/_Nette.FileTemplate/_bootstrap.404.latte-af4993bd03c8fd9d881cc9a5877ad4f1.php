...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf13c7fba11_content')) { function _lbf13c7fba11_content($_l, $_args) { extract($_args)
?><div id="content">
