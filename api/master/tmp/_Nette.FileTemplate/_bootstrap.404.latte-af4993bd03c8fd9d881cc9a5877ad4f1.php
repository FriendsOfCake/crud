...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf21b8f854c_content')) { function _lbf21b8f854c_content($_l, $_args) { extract($_args)
?><div id="content">
