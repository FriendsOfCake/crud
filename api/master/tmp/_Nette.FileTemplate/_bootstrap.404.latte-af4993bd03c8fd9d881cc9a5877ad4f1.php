...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd455126d0a_content')) { function _lbd455126d0a_content($_l, $_args) { extract($_args)
?><div id="content">
