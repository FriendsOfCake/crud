...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3e88d9acd4_content')) { function _lb3e88d9acd4_content($_l, $_args) { extract($_args)
?><div id="content">
