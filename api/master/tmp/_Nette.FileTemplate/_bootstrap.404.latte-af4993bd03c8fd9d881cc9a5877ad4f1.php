...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd24ad4e418_content')) { function _lbd24ad4e418_content($_l, $_args) { extract($_args)
?><div id="content">
