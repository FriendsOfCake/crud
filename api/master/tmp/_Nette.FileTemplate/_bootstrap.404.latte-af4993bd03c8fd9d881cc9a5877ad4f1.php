...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc39717ec1e_content')) { function _lbc39717ec1e_content($_l, $_args) { extract($_args)
?><div id="content">
