...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb806b018982_content')) { function _lb806b018982_content($_l, $_args) { extract($_args)
?><div id="content">
