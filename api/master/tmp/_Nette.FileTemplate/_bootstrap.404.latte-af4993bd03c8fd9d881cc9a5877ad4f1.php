...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb6c5c0fadb_content')) { function _lbb6c5c0fadb_content($_l, $_args) { extract($_args)
?><div id="content">
