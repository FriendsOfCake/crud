...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb44416aafe4_content')) { function _lb44416aafe4_content($_l, $_args) { extract($_args)
?><div id="content">
