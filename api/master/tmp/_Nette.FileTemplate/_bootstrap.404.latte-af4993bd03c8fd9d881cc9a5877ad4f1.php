...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0f7ea9f635_content')) { function _lb0f7ea9f635_content($_l, $_args) { extract($_args)
?><div id="content">
