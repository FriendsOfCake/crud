...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbadbc98ba93_content')) { function _lbadbc98ba93_content($_l, $_args) { extract($_args)
?><div id="content">
