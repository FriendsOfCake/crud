...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9493121f31_content')) { function _lb9493121f31_content($_l, $_args) { extract($_args)
?><div id="content">
