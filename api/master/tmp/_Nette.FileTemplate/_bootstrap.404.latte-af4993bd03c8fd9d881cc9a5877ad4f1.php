...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbed48ac3256_content')) { function _lbed48ac3256_content($_l, $_args) { extract($_args)
?><div id="content">
