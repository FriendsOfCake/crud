...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe5584609de_content')) { function _lbe5584609de_content($_l, $_args) { extract($_args)
?><div id="content">
