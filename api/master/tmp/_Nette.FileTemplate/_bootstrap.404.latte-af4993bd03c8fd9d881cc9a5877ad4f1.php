...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0887335438_content')) { function _lb0887335438_content($_l, $_args) { extract($_args)
?><div id="content">
