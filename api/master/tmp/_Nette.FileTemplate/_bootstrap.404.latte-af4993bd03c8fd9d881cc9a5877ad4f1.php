...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9976808ab8_content')) { function _lb9976808ab8_content($_l, $_args) { extract($_args)
?><div id="content">
