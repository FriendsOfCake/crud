...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9ad8a62fd4_content')) { function _lb9ad8a62fd4_content($_l, $_args) { extract($_args)
?><div id="content">
