...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3e24d3bafb_content')) { function _lb3e24d3bafb_content($_l, $_args) { extract($_args)
?><div id="content">
