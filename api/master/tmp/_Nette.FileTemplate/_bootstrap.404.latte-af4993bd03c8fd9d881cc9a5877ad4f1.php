...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2d4e4418ce_content')) { function _lb2d4e4418ce_content($_l, $_args) { extract($_args)
?><div id="content">
