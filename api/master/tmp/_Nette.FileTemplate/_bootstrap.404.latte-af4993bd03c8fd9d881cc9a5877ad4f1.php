...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd37397c3fa_content')) { function _lbd37397c3fa_content($_l, $_args) { extract($_args)
?><div id="content">
