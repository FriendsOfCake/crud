...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7830e6d3df_content')) { function _lb7830e6d3df_content($_l, $_args) { extract($_args)
?><div id="content">
