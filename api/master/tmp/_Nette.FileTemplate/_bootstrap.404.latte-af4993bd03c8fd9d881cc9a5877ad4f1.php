...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbeda91175a1_content')) { function _lbeda91175a1_content($_l, $_args) { extract($_args)
?><div id="content">
