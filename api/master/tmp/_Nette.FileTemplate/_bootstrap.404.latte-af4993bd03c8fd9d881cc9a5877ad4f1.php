...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb41932577dd_content')) { function _lb41932577dd_content($_l, $_args) { extract($_args)
?><div id="content">
