...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc78f67a2ae_content')) { function _lbc78f67a2ae_content($_l, $_args) { extract($_args)
?><div id="content">
