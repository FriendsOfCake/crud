...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4f89db1ac9_content')) { function _lb4f89db1ac9_content($_l, $_args) { extract($_args)
?><div id="content">
