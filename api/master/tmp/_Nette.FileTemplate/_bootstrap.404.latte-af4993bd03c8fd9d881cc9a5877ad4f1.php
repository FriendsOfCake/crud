...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8cbc81594c_content')) { function _lb8cbc81594c_content($_l, $_args) { extract($_args)
?><div id="content">
