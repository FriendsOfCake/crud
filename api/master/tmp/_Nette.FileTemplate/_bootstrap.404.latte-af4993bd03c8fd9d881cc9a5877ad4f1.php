...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbbaff3fd41c_content')) { function _lbbaff3fd41c_content($_l, $_args) { extract($_args)
?><div id="content">
