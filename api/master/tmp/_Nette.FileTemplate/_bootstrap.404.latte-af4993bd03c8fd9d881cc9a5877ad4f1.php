...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbed1d09df0e_content')) { function _lbed1d09df0e_content($_l, $_args) { extract($_args)
?><div id="content">
