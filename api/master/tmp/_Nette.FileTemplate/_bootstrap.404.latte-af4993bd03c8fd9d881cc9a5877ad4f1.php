...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbbab7709f3d_content')) { function _lbbab7709f3d_content($_l, $_args) { extract($_args)
?><div id="content">
