...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd4c79ed99d_content')) { function _lbd4c79ed99d_content($_l, $_args) { extract($_args)
?><div id="content">
