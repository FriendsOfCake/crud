...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb787848e79e_content')) { function _lb787848e79e_content($_l, $_args) { extract($_args)
?><div id="content">
