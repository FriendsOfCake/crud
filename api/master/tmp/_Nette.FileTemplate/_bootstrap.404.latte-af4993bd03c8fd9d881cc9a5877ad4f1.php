...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbebce17bf64_content')) { function _lbebce17bf64_content($_l, $_args) { extract($_args)
?><div id="content">
