...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbeae78f3f24_content')) { function _lbeae78f3f24_content($_l, $_args) { extract($_args)
?><div id="content">
