...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbfa1caeb391_content')) { function _lbfa1caeb391_content($_l, $_args) { extract($_args)
?><div id="content">
