...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb38b07134f1_content')) { function _lb38b07134f1_content($_l, $_args) { extract($_args)
?><div id="content">
