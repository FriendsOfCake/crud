...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb082b814601_content')) { function _lb082b814601_content($_l, $_args) { extract($_args)
?><div id="content">
