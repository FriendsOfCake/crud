...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd3b9662607_content')) { function _lbd3b9662607_content($_l, $_args) { extract($_args)
?><div id="content">
