...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3a3fa8eace_content')) { function _lb3a3fa8eace_content($_l, $_args) { extract($_args)
?><div id="content">
