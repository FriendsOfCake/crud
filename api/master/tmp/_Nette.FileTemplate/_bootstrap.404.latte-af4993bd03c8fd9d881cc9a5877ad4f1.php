...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd19d5e3965_content')) { function _lbd19d5e3965_content($_l, $_args) { extract($_args)
?><div id="content">
