...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb23fcf09dec_content')) { function _lb23fcf09dec_content($_l, $_args) { extract($_args)
?><div id="content">
