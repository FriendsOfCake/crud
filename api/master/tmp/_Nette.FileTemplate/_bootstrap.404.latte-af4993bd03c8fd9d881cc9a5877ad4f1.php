...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbccb09f613f_content')) { function _lbccb09f613f_content($_l, $_args) { extract($_args)
?><div id="content">
