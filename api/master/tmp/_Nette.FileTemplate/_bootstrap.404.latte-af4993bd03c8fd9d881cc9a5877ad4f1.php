...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc211708d7e_content')) { function _lbc211708d7e_content($_l, $_args) { extract($_args)
?><div id="content">
