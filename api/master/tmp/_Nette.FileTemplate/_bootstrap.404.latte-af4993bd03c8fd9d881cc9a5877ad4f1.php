...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2f7f0a1c4b_content')) { function _lb2f7f0a1c4b_content($_l, $_args) { extract($_args)
?><div id="content">
