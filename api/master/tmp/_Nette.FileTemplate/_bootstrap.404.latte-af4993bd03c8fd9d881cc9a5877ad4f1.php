...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc3296b64c7_content')) { function _lbc3296b64c7_content($_l, $_args) { extract($_args)
?><div id="content">
