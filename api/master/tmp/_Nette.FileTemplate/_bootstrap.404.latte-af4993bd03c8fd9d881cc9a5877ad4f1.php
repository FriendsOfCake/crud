...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd6f8d6ba32_content')) { function _lbd6f8d6ba32_content($_l, $_args) { extract($_args)
?><div id="content">
