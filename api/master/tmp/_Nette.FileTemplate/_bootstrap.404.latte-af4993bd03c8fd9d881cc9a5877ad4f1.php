...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc93f053742_content')) { function _lbc93f053742_content($_l, $_args) { extract($_args)
?><div id="content">
