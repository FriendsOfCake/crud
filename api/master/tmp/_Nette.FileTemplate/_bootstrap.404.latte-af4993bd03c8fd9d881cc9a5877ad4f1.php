...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb54952963d1_content')) { function _lb54952963d1_content($_l, $_args) { extract($_args)
?><div id="content">
