...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdc1a7ec0b3_content')) { function _lbdc1a7ec0b3_content($_l, $_args) { extract($_args)
?><div id="content">
