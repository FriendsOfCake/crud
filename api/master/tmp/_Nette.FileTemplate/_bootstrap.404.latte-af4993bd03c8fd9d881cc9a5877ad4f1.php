...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb739d9bdda6_content')) { function _lb739d9bdda6_content($_l, $_args) { extract($_args)
?><div id="content">
