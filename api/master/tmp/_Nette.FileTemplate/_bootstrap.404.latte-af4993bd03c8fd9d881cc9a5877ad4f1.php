...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbad2b6ee4e6_content')) { function _lbad2b6ee4e6_content($_l, $_args) { extract($_args)
?><div id="content">
