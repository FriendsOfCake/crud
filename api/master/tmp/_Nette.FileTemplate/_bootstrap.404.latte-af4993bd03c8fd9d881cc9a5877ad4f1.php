...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc21c6c6560_content')) { function _lbc21c6c6560_content($_l, $_args) { extract($_args)
?><div id="content">
