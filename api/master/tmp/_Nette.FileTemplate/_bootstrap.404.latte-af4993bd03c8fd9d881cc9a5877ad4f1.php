...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb062011ebc8_content')) { function _lb062011ebc8_content($_l, $_args) { extract($_args)
?><div id="content">
