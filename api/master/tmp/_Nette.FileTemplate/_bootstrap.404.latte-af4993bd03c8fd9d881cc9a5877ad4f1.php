...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5be3705724_content')) { function _lb5be3705724_content($_l, $_args) { extract($_args)
?><div id="content">
