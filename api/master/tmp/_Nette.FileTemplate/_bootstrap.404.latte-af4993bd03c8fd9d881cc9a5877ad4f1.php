...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd2a0648154_content')) { function _lbd2a0648154_content($_l, $_args) { extract($_args)
?><div id="content">
