...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8699810a8c_content')) { function _lb8699810a8c_content($_l, $_args) { extract($_args)
?><div id="content">
