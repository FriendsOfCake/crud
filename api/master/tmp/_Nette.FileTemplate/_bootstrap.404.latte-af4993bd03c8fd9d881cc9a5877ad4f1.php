...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2ac58995bc_content')) { function _lb2ac58995bc_content($_l, $_args) { extract($_args)
?><div id="content">
