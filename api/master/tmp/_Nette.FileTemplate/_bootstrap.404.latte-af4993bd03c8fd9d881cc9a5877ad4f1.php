...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbab01cf1081_content')) { function _lbab01cf1081_content($_l, $_args) { extract($_args)
?><div id="content">
