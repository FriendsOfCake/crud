...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5d34ed4b96_content')) { function _lb5d34ed4b96_content($_l, $_args) { extract($_args)
?><div id="content">
