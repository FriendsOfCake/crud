...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb68cf30db6a_content')) { function _lb68cf30db6a_content($_l, $_args) { extract($_args)
?><div id="content">
