...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb3cd63e0a7_content')) { function _lbb3cd63e0a7_content($_l, $_args) { extract($_args)
?><div id="content">
