...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbff40a4e8d5_content')) { function _lbff40a4e8d5_content($_l, $_args) { extract($_args)
?><div id="content">
