...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb151adbec2e_content')) { function _lb151adbec2e_content($_l, $_args) { extract($_args)
?><div id="content">
