...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9fcc4689fb_content')) { function _lb9fcc4689fb_content($_l, $_args) { extract($_args)
?><div id="content">
