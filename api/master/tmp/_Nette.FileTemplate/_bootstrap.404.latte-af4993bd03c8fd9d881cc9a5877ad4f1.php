...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb005a531d68_content')) { function _lb005a531d68_content($_l, $_args) { extract($_args)
?><div id="content">
