...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb962f37778d_content')) { function _lb962f37778d_content($_l, $_args) { extract($_args)
?><div id="content">
