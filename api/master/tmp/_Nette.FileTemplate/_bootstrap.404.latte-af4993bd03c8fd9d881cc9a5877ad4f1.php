...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb772ab01185_content')) { function _lb772ab01185_content($_l, $_args) { extract($_args)
?><div id="content">
