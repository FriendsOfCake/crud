...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb631fa3f872_content')) { function _lb631fa3f872_content($_l, $_args) { extract($_args)
?><div id="content">
