...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb87ca06dcc5_content')) { function _lb87ca06dcc5_content($_l, $_args) { extract($_args)
?><div id="content">
