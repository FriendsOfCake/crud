...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb73561ff9ff_content')) { function _lb73561ff9ff_content($_l, $_args) { extract($_args)
?><div id="content">
