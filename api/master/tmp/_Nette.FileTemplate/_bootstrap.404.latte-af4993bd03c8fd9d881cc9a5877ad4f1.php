...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3409ac73fc_content')) { function _lb3409ac73fc_content($_l, $_args) { extract($_args)
?><div id="content">
