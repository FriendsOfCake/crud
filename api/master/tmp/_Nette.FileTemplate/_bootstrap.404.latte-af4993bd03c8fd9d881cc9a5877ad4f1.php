...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe75d2cef04_content')) { function _lbe75d2cef04_content($_l, $_args) { extract($_args)
?><div id="content">
