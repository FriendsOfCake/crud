...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb97f75dbdfb_content')) { function _lb97f75dbdfb_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb4d5aab08de_classes')) { function _lb4d5aab08de_classes($_l, $_args) { extract($_args)
