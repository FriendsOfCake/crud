...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb52be4d7ee_content')) { function _lbb52be4d7ee_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb450b24365c_classes')) { function _lb450b24365c_classes($_l, $_args) { extract($_args)
