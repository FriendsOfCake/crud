...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8ddb7261c7_content')) { function _lb8ddb7261c7_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb714e54d814_classes')) { function _lb714e54d814_classes($_l, $_args) { extract($_args)
