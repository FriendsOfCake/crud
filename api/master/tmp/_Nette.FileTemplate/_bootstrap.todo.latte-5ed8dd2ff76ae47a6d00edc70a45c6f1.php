...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8420c2380b_content')) { function _lb8420c2380b_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lba78bd41d6a_classes')) { function _lba78bd41d6a_classes($_l, $_args) { extract($_args)
