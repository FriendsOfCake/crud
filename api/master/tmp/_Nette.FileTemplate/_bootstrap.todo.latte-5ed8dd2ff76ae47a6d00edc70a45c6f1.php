...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5849761cd8_content')) { function _lb5849761cd8_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbbbc66e557b_classes')) { function _lbbbc66e557b_classes($_l, $_args) { extract($_args)
