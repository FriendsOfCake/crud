...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd229ff5649_content')) { function _lbd229ff5649_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb5f597df68a_classes')) { function _lb5f597df68a_classes($_l, $_args) { extract($_args)
