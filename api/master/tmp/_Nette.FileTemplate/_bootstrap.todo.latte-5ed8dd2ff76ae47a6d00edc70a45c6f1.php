...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5a09d6ebd4_content')) { function _lb5a09d6ebd4_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb528274c1be_classes')) { function _lb528274c1be_classes($_l, $_args) { extract($_args)
