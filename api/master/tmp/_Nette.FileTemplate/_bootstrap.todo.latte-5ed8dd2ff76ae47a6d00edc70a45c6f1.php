...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4ca08aa08a_content')) { function _lb4ca08aa08a_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb128fa882b_classes')) { function _lbb128fa882b_classes($_l, $_args) { extract($_args)
