...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc546a1e646_content')) { function _lbc546a1e646_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb4a80884cc4_classes')) { function _lb4a80884cc4_classes($_l, $_args) { extract($_args)
