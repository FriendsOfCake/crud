...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb51cc3f79fc_content')) { function _lb51cc3f79fc_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb5eafe070ff_classes')) { function _lb5eafe070ff_classes($_l, $_args) { extract($_args)
