...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7eb16a5c77_content')) { function _lb7eb16a5c77_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbac593f4a25_classes')) { function _lbac593f4a25_classes($_l, $_args) { extract($_args)
