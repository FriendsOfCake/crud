...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb23dacd48c7_content')) { function _lb23dacd48c7_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbf6f17ca9d0_classes')) { function _lbf6f17ca9d0_classes($_l, $_args) { extract($_args)
