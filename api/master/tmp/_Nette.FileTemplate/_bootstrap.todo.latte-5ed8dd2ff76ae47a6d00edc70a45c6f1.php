...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb55a5985316_content')) { function _lb55a5985316_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb732435007e_classes')) { function _lb732435007e_classes($_l, $_args) { extract($_args)
