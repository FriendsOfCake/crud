...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6718976cbb_content')) { function _lb6718976cbb_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb3c60d159a5_classes')) { function _lb3c60d159a5_classes($_l, $_args) { extract($_args)
