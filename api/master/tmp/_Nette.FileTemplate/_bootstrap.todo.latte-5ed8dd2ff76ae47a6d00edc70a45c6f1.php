...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb41e3ff0855_content')) { function _lb41e3ff0855_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb79fe4f985_classes')) { function _lbb79fe4f985_classes($_l, $_args) { extract($_args)
