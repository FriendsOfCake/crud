...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb08a026ebe5_content')) { function _lb08a026ebe5_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb00460a6edd_classes')) { function _lb00460a6edd_classes($_l, $_args) { extract($_args)
