...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe9b7f77941_content')) { function _lbe9b7f77941_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb24c20413c3_classes')) { function _lb24c20413c3_classes($_l, $_args) { extract($_args)
