...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb065df0a3b3_content')) { function _lb065df0a3b3_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbc0a580ee24_classes')) { function _lbc0a580ee24_classes($_l, $_args) { extract($_args)
