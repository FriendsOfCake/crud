...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc6b037b849_content')) { function _lbc6b037b849_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb4853895265_classes')) { function _lb4853895265_classes($_l, $_args) { extract($_args)
