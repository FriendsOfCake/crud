...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb05d0ad9169_content')) { function _lb05d0ad9169_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb089ab2f94c_classes')) { function _lb089ab2f94c_classes($_l, $_args) { extract($_args)
