...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1babcda7c9_content')) { function _lb1babcda7c9_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb3de7ffc885_classes')) { function _lb3de7ffc885_classes($_l, $_args) { extract($_args)
