...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb23113e7ade_content')) { function _lb23113e7ade_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb4bf50b00f0_classes')) { function _lb4bf50b00f0_classes($_l, $_args) { extract($_args)
