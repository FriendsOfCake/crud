...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0ab52fc334_content')) { function _lb0ab52fc334_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbe9d89a80e3_classes')) { function _lbe9d89a80e3_classes($_l, $_args) { extract($_args)
