...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb245c2e46fd_content')) { function _lb245c2e46fd_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb5cd5722619_classes')) { function _lb5cd5722619_classes($_l, $_args) { extract($_args)
