...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9a1a5b926f_content')) { function _lb9a1a5b926f_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb9780634978_classes')) { function _lb9780634978_classes($_l, $_args) { extract($_args)
