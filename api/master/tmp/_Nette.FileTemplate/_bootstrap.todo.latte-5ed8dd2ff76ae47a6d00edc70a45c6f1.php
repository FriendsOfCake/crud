...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc467644d3e_content')) { function _lbc467644d3e_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbe6dbf41b54_classes')) { function _lbe6dbf41b54_classes($_l, $_args) { extract($_args)
