...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3295c8e457_content')) { function _lb3295c8e457_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbceb43f359b_classes')) { function _lbceb43f359b_classes($_l, $_args) { extract($_args)
