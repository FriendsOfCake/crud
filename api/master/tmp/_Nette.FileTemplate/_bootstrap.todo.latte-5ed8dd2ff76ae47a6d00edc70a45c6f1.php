...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb00b6676a9d_content')) { function _lb00b6676a9d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb93d0f219fd_classes')) { function _lb93d0f219fd_classes($_l, $_args) { extract($_args)
