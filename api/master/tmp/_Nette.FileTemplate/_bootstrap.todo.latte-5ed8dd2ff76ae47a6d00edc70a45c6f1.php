...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb29fd8a24e4_content')) { function _lb29fd8a24e4_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb4f01468165_classes')) { function _lb4f01468165_classes($_l, $_args) { extract($_args)
