...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf8b51c31ae_content')) { function _lbf8b51c31ae_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb202c253483_classes')) { function _lb202c253483_classes($_l, $_args) { extract($_args)
