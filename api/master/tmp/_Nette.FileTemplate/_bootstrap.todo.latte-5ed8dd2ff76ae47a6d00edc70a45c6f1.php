...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb815099d827_content')) { function _lb815099d827_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb9f7e0df89_classes')) { function _lbb9f7e0df89_classes($_l, $_args) { extract($_args)
