...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8c8499a910_content')) { function _lb8c8499a910_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb2a29a05a9c_classes')) { function _lb2a29a05a9c_classes($_l, $_args) { extract($_args)
