...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb2747f0b0d_content')) { function _lbb2747f0b0d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb7c7fbb8c6d_classes')) { function _lb7c7fbb8c6d_classes($_l, $_args) { extract($_args)
