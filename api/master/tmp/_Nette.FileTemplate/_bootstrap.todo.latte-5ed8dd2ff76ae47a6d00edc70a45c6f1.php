...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbda6bc641a8_content')) { function _lbda6bc641a8_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb604a9e28d9_classes')) { function _lb604a9e28d9_classes($_l, $_args) { extract($_args)
