...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbea86e4e6a3_content')) { function _lbea86e4e6a3_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb682fa9439_classes')) { function _lbb682fa9439_classes($_l, $_args) { extract($_args)
