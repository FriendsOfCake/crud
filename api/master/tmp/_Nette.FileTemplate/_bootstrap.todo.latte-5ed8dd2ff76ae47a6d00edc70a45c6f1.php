...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb290d187824_content')) { function _lb290d187824_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lba295dfda82_classes')) { function _lba295dfda82_classes($_l, $_args) { extract($_args)
