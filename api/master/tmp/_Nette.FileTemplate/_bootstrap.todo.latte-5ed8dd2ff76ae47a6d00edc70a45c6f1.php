...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2fa4522e3a_content')) { function _lb2fa4522e3a_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb88b5abf8f7_classes')) { function _lb88b5abf8f7_classes($_l, $_args) { extract($_args)
