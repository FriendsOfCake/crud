...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0303986a32_content')) { function _lb0303986a32_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb4c28f83046_classes')) { function _lb4c28f83046_classes($_l, $_args) { extract($_args)
