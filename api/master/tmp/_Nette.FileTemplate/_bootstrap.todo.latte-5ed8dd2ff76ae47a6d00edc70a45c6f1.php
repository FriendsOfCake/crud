...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf6f8b6b45d_content')) { function _lbf6f8b6b45d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb57140718af_classes')) { function _lb57140718af_classes($_l, $_args) { extract($_args)
