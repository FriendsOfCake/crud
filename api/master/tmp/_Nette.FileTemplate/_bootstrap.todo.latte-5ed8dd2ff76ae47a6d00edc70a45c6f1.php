...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbfd6f45857f_content')) { function _lbfd6f45857f_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb53697ef067_classes')) { function _lb53697ef067_classes($_l, $_args) { extract($_args)
