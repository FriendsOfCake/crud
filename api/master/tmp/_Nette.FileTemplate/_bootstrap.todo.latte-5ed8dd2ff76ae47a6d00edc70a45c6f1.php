...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb58ad8a6e4e_content')) { function _lb58ad8a6e4e_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lba8dd15681c_classes')) { function _lba8dd15681c_classes($_l, $_args) { extract($_args)
