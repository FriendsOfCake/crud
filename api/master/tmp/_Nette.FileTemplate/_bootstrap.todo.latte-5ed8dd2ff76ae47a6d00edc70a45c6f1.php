...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb79e609cdae_content')) { function _lb79e609cdae_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb1f5e0a9be7_classes')) { function _lb1f5e0a9be7_classes($_l, $_args) { extract($_args)
