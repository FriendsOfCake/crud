...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb842a1f3244_content')) { function _lb842a1f3244_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb28b168f13d_classes')) { function _lb28b168f13d_classes($_l, $_args) { extract($_args)
