...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb53cf86ae8d_content')) { function _lb53cf86ae8d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb5707c00470_classes')) { function _lb5707c00470_classes($_l, $_args) { extract($_args)
