...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdc8778ba3b_content')) { function _lbdc8778ba3b_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb7b734adf81_classes')) { function _lb7b734adf81_classes($_l, $_args) { extract($_args)
