...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb41f892cb7b_content')) { function _lb41f892cb7b_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb3846a2d2f4_classes')) { function _lb3846a2d2f4_classes($_l, $_args) { extract($_args)
