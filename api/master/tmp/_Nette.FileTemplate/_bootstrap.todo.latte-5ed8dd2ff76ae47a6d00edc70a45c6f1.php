...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0cb0da72e4_content')) { function _lb0cb0da72e4_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb69906ef7cb_classes')) { function _lb69906ef7cb_classes($_l, $_args) { extract($_args)
