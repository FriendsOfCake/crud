...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7b27031210_content')) { function _lb7b27031210_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb31e50ec5d_classes')) { function _lbb31e50ec5d_classes($_l, $_args) { extract($_args)
