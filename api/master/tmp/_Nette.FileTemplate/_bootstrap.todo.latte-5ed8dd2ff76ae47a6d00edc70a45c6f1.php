...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbee8b2249cf_content')) { function _lbee8b2249cf_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbec81dfc383_classes')) { function _lbec81dfc383_classes($_l, $_args) { extract($_args)
