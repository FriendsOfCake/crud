...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb940a8cba8f_content')) { function _lb940a8cba8f_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb4704594a57_classes')) { function _lb4704594a57_classes($_l, $_args) { extract($_args)
