...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5e8bf40a5a_content')) { function _lb5e8bf40a5a_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb250927304c_classes')) { function _lb250927304c_classes($_l, $_args) { extract($_args)
