...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbeb31034435_content')) { function _lbeb31034435_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb947c24071f_classes')) { function _lb947c24071f_classes($_l, $_args) { extract($_args)
