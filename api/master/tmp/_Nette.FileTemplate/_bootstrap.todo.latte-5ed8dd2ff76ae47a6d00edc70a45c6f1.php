...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9737233287_content')) { function _lb9737233287_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lba30990a31d_classes')) { function _lba30990a31d_classes($_l, $_args) { extract($_args)
