...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf21db06e5f_content')) { function _lbf21db06e5f_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb53c7d54fb4_classes')) { function _lb53c7d54fb4_classes($_l, $_args) { extract($_args)
