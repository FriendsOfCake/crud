...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbee22db6e60_content')) { function _lbee22db6e60_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb4f6934a710_classes')) { function _lb4f6934a710_classes($_l, $_args) { extract($_args)
