...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbfb52e2fc96_content')) { function _lbfb52e2fc96_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lba84d7e7ce3_classes')) { function _lba84d7e7ce3_classes($_l, $_args) { extract($_args)
