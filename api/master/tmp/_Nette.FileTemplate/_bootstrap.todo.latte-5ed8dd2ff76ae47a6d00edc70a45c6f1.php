...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5d8a2810c9_content')) { function _lb5d8a2810c9_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbd659b8b2ce_classes')) { function _lbd659b8b2ce_classes($_l, $_args) { extract($_args)
