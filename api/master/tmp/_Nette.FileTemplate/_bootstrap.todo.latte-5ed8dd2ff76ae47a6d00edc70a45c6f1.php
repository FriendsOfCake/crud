...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbbc5fc0c749_content')) { function _lbbc5fc0c749_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbd255a49762_classes')) { function _lbd255a49762_classes($_l, $_args) { extract($_args)
