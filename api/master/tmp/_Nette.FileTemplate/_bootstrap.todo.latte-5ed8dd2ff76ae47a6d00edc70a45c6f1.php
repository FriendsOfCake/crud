...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd8cb0b09f4_content')) { function _lbd8cb0b09f4_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb7aa1394c5_classes')) { function _lbb7aa1394c5_classes($_l, $_args) { extract($_args)
