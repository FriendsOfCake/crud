...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe6a35f99a0_content')) { function _lbe6a35f99a0_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbd535ce136a_classes')) { function _lbd535ce136a_classes($_l, $_args) { extract($_args)
