...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb8f0d447213_content')) { function _lb8f0d447213_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbdadf5e92b4_classes')) { function _lbdadf5e92b4_classes($_l, $_args) { extract($_args)
