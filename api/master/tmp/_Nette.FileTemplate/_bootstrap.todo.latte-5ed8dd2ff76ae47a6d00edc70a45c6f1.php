...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb270dda973a_content')) { function _lb270dda973a_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb285d09b847_classes')) { function _lb285d09b847_classes($_l, $_args) { extract($_args)
