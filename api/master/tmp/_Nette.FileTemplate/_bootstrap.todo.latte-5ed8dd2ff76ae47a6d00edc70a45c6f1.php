...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbbcab9db6ba_content')) { function _lbbcab9db6ba_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbfee8d28ba3_classes')) { function _lbfee8d28ba3_classes($_l, $_args) { extract($_args)
