...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd59be60d83_content')) { function _lbd59be60d83_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbdbffe7233f_classes')) { function _lbdbffe7233f_classes($_l, $_args) { extract($_args)
