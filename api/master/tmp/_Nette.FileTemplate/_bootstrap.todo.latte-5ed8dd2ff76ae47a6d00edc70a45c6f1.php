...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2a26a4fe3c_content')) { function _lb2a26a4fe3c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lba26f9d23ec_classes')) { function _lba26f9d23ec_classes($_l, $_args) { extract($_args)
