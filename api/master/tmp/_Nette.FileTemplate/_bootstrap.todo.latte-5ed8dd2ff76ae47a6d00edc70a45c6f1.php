...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb571132229e_content')) { function _lb571132229e_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb4868a953c8_classes')) { function _lb4868a953c8_classes($_l, $_args) { extract($_args)
