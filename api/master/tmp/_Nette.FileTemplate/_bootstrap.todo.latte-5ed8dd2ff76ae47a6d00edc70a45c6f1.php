...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3145fca68c_content')) { function _lb3145fca68c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb479a392ba2_classes')) { function _lb479a392ba2_classes($_l, $_args) { extract($_args)
