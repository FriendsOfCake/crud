...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe8423cf98d_content')) { function _lbe8423cf98d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbf00ed2ec41_classes')) { function _lbf00ed2ec41_classes($_l, $_args) { extract($_args)
