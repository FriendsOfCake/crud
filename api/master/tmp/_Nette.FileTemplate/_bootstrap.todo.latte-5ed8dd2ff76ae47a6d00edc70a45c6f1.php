...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb04a1d133f2_content')) { function _lb04a1d133f2_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbd743963ce2_classes')) { function _lbd743963ce2_classes($_l, $_args) { extract($_args)
