...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2ea2cd87ee_content')) { function _lb2ea2cd87ee_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lba5c687a862_classes')) { function _lba5c687a862_classes($_l, $_args) { extract($_args)
