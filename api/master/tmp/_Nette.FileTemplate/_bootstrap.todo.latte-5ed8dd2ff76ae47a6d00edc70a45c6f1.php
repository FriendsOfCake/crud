...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbcf322ed38c_content')) { function _lbcf322ed38c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb2663ec7fa2_classes')) { function _lb2663ec7fa2_classes($_l, $_args) { extract($_args)
