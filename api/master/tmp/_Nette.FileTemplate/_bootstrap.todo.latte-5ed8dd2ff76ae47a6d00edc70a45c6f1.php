...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb942ff38427_content')) { function _lb942ff38427_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbfa9fefba87_classes')) { function _lbfa9fefba87_classes($_l, $_args) { extract($_args)
