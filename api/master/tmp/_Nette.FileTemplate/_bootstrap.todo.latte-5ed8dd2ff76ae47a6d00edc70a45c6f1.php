...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbcb669d4a2b_content')) { function _lbcb669d4a2b_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb0002445bdc_classes')) { function _lb0002445bdc_classes($_l, $_args) { extract($_args)
