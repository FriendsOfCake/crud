...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9905f79216_content')) { function _lb9905f79216_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbcdf1543003_classes')) { function _lbcdf1543003_classes($_l, $_args) { extract($_args)
