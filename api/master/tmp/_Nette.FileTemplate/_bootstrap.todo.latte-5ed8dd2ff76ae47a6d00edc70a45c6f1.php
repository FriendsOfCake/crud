...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb44fcc1a0b6_content')) { function _lb44fcc1a0b6_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbf7de656c69_classes')) { function _lbf7de656c69_classes($_l, $_args) { extract($_args)
