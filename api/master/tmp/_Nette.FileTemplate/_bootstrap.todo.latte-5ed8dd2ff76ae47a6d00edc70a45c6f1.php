...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0f59034e73_content')) { function _lb0f59034e73_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb44cd96e444_classes')) { function _lb44cd96e444_classes($_l, $_args) { extract($_args)
