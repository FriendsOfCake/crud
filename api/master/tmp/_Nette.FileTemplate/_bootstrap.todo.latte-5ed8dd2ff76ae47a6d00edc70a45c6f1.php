...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb01c822b50_content')) { function _lbb01c822b50_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb894b527628_classes')) { function _lb894b527628_classes($_l, $_args) { extract($_args)
