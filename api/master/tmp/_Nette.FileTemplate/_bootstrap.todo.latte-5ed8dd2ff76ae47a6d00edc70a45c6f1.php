...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb0fe979bdc_content')) { function _lbb0fe979bdc_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb7a0215bb6a_classes')) { function _lb7a0215bb6a_classes($_l, $_args) { extract($_args)
