...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb782109b949_content')) { function _lb782109b949_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb2540e2a04d_classes')) { function _lb2540e2a04d_classes($_l, $_args) { extract($_args)
