...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbbb93cabea7_content')) { function _lbbb93cabea7_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb02987aa397_classes')) { function _lb02987aa397_classes($_l, $_args) { extract($_args)
