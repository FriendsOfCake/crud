...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3ba14063c7_content')) { function _lb3ba14063c7_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbe1fd125dcf_classes')) { function _lbe1fd125dcf_classes($_l, $_args) { extract($_args)
