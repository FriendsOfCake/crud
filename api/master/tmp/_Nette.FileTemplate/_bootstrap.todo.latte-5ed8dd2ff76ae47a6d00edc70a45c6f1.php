...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6a308afe10_content')) { function _lb6a308afe10_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb391150bb08_classes')) { function _lb391150bb08_classes($_l, $_args) { extract($_args)
