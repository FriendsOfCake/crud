...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6d99f9a30a_content')) { function _lb6d99f9a30a_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb039e75df3c_classes')) { function _lb039e75df3c_classes($_l, $_args) { extract($_args)
