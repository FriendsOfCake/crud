...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb57d31064aa_content')) { function _lb57d31064aa_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb51603ef37b_classes')) { function _lb51603ef37b_classes($_l, $_args) { extract($_args)
