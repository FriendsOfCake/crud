...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbace52b2512_content')) { function _lbace52b2512_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbe5506e19bd_classes')) { function _lbe5506e19bd_classes($_l, $_args) { extract($_args)
