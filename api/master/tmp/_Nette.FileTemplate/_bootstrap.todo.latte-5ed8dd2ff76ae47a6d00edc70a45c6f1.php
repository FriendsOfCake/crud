...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd5dc598f78_content')) { function _lbd5dc598f78_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb4aa57eb7f_classes')) { function _lbb4aa57eb7f_classes($_l, $_args) { extract($_args)
