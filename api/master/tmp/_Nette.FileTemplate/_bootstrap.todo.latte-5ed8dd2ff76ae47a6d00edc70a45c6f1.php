...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1ee9adee81_content')) { function _lb1ee9adee81_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb738e9123c6_classes')) { function _lb738e9123c6_classes($_l, $_args) { extract($_args)
