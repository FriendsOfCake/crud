...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbfc48272bba_content')) { function _lbfc48272bba_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb2ba6d3bccb_classes')) { function _lb2ba6d3bccb_classes($_l, $_args) { extract($_args)
