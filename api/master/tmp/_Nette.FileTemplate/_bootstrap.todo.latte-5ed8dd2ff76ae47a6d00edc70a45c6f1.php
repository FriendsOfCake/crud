...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb227c6af07a_content')) { function _lb227c6af07a_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb8e95c9a8d8_classes')) { function _lb8e95c9a8d8_classes($_l, $_args) { extract($_args)
