...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdf6818ea1c_content')) { function _lbdf6818ea1c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb75b06a360c_classes')) { function _lb75b06a360c_classes($_l, $_args) { extract($_args)
