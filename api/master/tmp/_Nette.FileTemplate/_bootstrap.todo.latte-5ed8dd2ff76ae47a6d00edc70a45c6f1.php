...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3b8588e6fb_content')) { function _lb3b8588e6fb_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb0e5833f954_classes')) { function _lb0e5833f954_classes($_l, $_args) { extract($_args)
