...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbfce4a12e02_content')) { function _lbfce4a12e02_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb0abeab79ae_classes')) { function _lb0abeab79ae_classes($_l, $_args) { extract($_args)
