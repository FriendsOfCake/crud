...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf41ff6d440_content')) { function _lbf41ff6d440_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbc759215bcc_classes')) { function _lbc759215bcc_classes($_l, $_args) { extract($_args)
