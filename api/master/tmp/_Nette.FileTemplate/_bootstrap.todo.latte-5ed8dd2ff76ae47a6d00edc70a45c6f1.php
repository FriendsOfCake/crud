...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe0439a7ce2_content')) { function _lbe0439a7ce2_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbe4846f4c37_classes')) { function _lbe4846f4c37_classes($_l, $_args) { extract($_args)
