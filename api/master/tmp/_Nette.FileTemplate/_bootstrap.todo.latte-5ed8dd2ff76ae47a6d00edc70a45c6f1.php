...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc9eef86528_content')) { function _lbc9eef86528_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb12bbc3574d_classes')) { function _lb12bbc3574d_classes($_l, $_args) { extract($_args)
