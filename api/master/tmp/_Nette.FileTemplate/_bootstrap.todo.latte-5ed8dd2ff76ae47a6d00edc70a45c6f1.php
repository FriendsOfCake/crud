...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb330e044c5a_content')) { function _lb330e044c5a_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb6c86b38aa2_classes')) { function _lb6c86b38aa2_classes($_l, $_args) { extract($_args)
