...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf12ff1b6fa_content')) { function _lbf12ff1b6fa_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbca49f859e3_classes')) { function _lbca49f859e3_classes($_l, $_args) { extract($_args)
