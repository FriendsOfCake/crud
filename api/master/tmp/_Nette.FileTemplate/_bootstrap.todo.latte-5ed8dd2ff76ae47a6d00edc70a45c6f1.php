...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbcdbbc80087_content')) { function _lbcdbbc80087_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb5feeed5f52_classes')) { function _lb5feeed5f52_classes($_l, $_args) { extract($_args)
