...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe4ac312b05_content')) { function _lbe4ac312b05_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lba1f8f249a6_classes')) { function _lba1f8f249a6_classes($_l, $_args) { extract($_args)
