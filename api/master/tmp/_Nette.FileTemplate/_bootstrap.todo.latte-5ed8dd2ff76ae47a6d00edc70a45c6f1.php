...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbaa50e1719b_content')) { function _lbaa50e1719b_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb7fa28ce243_classes')) { function _lb7fa28ce243_classes($_l, $_args) { extract($_args)
