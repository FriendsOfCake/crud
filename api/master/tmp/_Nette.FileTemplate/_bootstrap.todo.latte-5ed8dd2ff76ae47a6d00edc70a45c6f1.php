...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb270d3d991a_content')) { function _lb270d3d991a_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb7b72fa66d7_classes')) { function _lb7b72fa66d7_classes($_l, $_args) { extract($_args)
