...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb53e39fd2e5_content')) { function _lb53e39fd2e5_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb6b681b4d42_classes')) { function _lb6b681b4d42_classes($_l, $_args) { extract($_args)
