...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbcbcfa0272c_content')) { function _lbcbcfa0272c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb8292aee102_classes')) { function _lb8292aee102_classes($_l, $_args) { extract($_args)
