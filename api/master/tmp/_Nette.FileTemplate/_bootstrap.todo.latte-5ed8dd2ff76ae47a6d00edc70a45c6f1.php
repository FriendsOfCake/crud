...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4810683a62_content')) { function _lb4810683a62_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbaa6da3acbd_classes')) { function _lbaa6da3acbd_classes($_l, $_args) { extract($_args)
