...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf0791e0391_content')) { function _lbf0791e0391_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb167b6ac7d0_classes')) { function _lb167b6ac7d0_classes($_l, $_args) { extract($_args)
