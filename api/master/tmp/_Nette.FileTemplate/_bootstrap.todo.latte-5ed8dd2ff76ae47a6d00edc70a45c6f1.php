...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb49814d04f0_content')) { function _lb49814d04f0_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbf4737eb14a_classes')) { function _lbf4737eb14a_classes($_l, $_args) { extract($_args)
