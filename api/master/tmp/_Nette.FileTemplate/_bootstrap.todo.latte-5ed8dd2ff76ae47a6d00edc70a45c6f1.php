...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb099749fb0d_content')) { function _lb099749fb0d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb540160918_classes')) { function _lbb540160918_classes($_l, $_args) { extract($_args)
