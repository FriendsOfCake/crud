...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc16d5b7b1c_content')) { function _lbc16d5b7b1c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb03a8fd8316_classes')) { function _lb03a8fd8316_classes($_l, $_args) { extract($_args)
