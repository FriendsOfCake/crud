...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4aa855dd6e_content')) { function _lb4aa855dd6e_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb1665b86f4d_classes')) { function _lb1665b86f4d_classes($_l, $_args) { extract($_args)
