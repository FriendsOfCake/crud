...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc8da5c8717_content')) { function _lbc8da5c8717_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb1bd8df00e0_classes')) { function _lb1bd8df00e0_classes($_l, $_args) { extract($_args)
