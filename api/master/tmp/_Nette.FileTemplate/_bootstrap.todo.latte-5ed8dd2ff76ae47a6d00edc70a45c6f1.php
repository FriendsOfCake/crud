...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd1a453df5d_content')) { function _lbd1a453df5d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbc31370412b_classes')) { function _lbc31370412b_classes($_l, $_args) { extract($_args)
