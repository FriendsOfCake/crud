...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4f7db0a2ef_content')) { function _lb4f7db0a2ef_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbd11e1cddf0_classes')) { function _lbd11e1cddf0_classes($_l, $_args) { extract($_args)
