...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb04ced8eecc_content')) { function _lb04ced8eecc_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbf1b08d9b79_classes')) { function _lbf1b08d9b79_classes($_l, $_args) { extract($_args)
