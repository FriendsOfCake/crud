...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb5485511de5_content')) { function _lb5485511de5_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb3a61d9702b_classes')) { function _lb3a61d9702b_classes($_l, $_args) { extract($_args)
