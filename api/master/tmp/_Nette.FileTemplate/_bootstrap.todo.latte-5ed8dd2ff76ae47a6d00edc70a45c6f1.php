...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb05a3ee1bde_content')) { function _lb05a3ee1bde_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbe471d2c855_classes')) { function _lbe471d2c855_classes($_l, $_args) { extract($_args)
