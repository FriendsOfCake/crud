...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb799fa51542_content')) { function _lb799fa51542_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb3e50603bee_classes')) { function _lb3e50603bee_classes($_l, $_args) { extract($_args)
