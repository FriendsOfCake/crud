...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3a7c8727a3_content')) { function _lb3a7c8727a3_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb4d9b3b23a6_classes')) { function _lb4d9b3b23a6_classes($_l, $_args) { extract($_args)
