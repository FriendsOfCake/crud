...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbde43c8ecb6_content')) { function _lbde43c8ecb6_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb05301d7cbb_classes')) { function _lb05301d7cbb_classes($_l, $_args) { extract($_args)
