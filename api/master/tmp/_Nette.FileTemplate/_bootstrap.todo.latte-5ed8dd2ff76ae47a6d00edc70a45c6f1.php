...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2df0484de7_content')) { function _lb2df0484de7_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb8cba4013df_classes')) { function _lb8cba4013df_classes($_l, $_args) { extract($_args)
