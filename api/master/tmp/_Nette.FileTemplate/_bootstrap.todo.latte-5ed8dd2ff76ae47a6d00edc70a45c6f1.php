...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb58080a4dfa_content')) { function _lb58080a4dfa_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb0379570fe4_classes')) { function _lb0379570fe4_classes($_l, $_args) { extract($_args)
