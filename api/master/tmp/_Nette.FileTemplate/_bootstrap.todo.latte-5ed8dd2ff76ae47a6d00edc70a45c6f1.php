...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb9f1969a3bc_content')) { function _lb9f1969a3bc_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb94760ebe6d_classes')) { function _lb94760ebe6d_classes($_l, $_args) { extract($_args)
