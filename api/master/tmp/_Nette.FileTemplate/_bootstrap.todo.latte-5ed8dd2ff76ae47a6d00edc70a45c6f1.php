...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb40ef1b81d_content')) { function _lbb40ef1b81d_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbc5f7eaff4e_classes')) { function _lbc5f7eaff4e_classes($_l, $_args) { extract($_args)
