...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd60edab798_content')) { function _lbd60edab798_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb241002bcca_classes')) { function _lb241002bcca_classes($_l, $_args) { extract($_args)
