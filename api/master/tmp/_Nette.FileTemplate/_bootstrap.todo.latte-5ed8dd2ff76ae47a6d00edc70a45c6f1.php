...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb604661e1b8_content')) { function _lb604661e1b8_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbcc4422f5ac_classes')) { function _lbcc4422f5ac_classes($_l, $_args) { extract($_args)
