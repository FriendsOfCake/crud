...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb1ff08ca002_content')) { function _lb1ff08ca002_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb7165c8e5ed_classes')) { function _lb7165c8e5ed_classes($_l, $_args) { extract($_args)
