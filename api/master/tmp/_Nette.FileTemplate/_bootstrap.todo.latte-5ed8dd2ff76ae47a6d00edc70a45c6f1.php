...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0114a43d6c_content')) { function _lb0114a43d6c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb86461052f4_classes')) { function _lb86461052f4_classes($_l, $_args) { extract($_args)
