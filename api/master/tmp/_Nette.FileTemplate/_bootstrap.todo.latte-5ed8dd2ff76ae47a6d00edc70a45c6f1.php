...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb4114168d21_content')) { function _lb4114168d21_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbbaad092524_classes')) { function _lbbaad092524_classes($_l, $_args) { extract($_args)
