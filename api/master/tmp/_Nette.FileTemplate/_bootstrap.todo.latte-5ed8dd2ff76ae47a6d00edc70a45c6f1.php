...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbd8edf6cb6a_content')) { function _lbd8edf6cb6a_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbdcaa1133b0_classes')) { function _lbdcaa1133b0_classes($_l, $_args) { extract($_args)
