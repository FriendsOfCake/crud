...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3007442cae_content')) { function _lb3007442cae_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb01f1727916_classes')) { function _lb01f1727916_classes($_l, $_args) { extract($_args)
