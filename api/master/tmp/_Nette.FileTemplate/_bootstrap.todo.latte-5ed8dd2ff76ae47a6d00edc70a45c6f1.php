...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe7eccb2aec_content')) { function _lbe7eccb2aec_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb4e9143aa70_classes')) { function _lb4e9143aa70_classes($_l, $_args) { extract($_args)
