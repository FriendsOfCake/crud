...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3bf0ff4aac_content')) { function _lb3bf0ff4aac_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb226a3e420a_classes')) { function _lb226a3e420a_classes($_l, $_args) { extract($_args)
