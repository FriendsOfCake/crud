...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe840ae9894_content')) { function _lbe840ae9894_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb440569f1a_classes')) { function _lbb440569f1a_classes($_l, $_args) { extract($_args)
