...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb8dea71e0f_content')) { function _lbb8dea71e0f_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb546ee18578_classes')) { function _lb546ee18578_classes($_l, $_args) { extract($_args)
