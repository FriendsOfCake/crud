...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdd0ebc1a63_content')) { function _lbdd0ebc1a63_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb5098d65ef6_classes')) { function _lb5098d65ef6_classes($_l, $_args) { extract($_args)
