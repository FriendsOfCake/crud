...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb22a18bb46e_content')) { function _lb22a18bb46e_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb9338748454_classes')) { function _lb9338748454_classes($_l, $_args) { extract($_args)
