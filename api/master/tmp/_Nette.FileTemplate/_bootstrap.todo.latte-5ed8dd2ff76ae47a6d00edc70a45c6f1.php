...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe75f96d879_content')) { function _lbe75f96d879_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb3dd64e4efa_classes')) { function _lb3dd64e4efa_classes($_l, $_args) { extract($_args)
