...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf5c8d68858_content')) { function _lbf5c8d68858_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbf03c7d7272_classes')) { function _lbf03c7d7272_classes($_l, $_args) { extract($_args)
