...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba0925df8f5_content')) { function _lba0925df8f5_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb953303c2df_classes')) { function _lb953303c2df_classes($_l, $_args) { extract($_args)
