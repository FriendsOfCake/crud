...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb43a70537d5_content')) { function _lb43a70537d5_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbd80b399620_classes')) { function _lbd80b399620_classes($_l, $_args) { extract($_args)
