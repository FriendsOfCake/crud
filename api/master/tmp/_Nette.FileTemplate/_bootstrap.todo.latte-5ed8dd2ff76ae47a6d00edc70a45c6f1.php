...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb403c070fbb_content')) { function _lb403c070fbb_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbbf5d9e38af_classes')) { function _lbbf5d9e38af_classes($_l, $_args) { extract($_args)
