...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb7cb5ace457_content')) { function _lb7cb5ace457_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb9d014dbf91_classes')) { function _lb9d014dbf91_classes($_l, $_args) { extract($_args)
