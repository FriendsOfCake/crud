...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbcbf18efad7_content')) { function _lbcbf18efad7_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb5c48f1dc6a_classes')) { function _lb5c48f1dc6a_classes($_l, $_args) { extract($_args)
