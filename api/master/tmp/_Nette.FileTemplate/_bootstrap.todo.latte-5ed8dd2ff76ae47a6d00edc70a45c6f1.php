...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb00b6b5efa3_content')) { function _lb00b6b5efa3_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbbb671c374e_classes')) { function _lbbb671c374e_classes($_l, $_args) { extract($_args)
