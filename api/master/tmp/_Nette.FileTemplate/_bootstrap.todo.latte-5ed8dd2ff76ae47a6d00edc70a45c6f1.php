...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbb1dea6ad13_content')) { function _lbb1dea6ad13_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb286b060934_classes')) { function _lb286b060934_classes($_l, $_args) { extract($_args)
