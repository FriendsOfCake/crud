...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbec95b78593_content')) { function _lbec95b78593_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb12170ed6f9_classes')) { function _lb12170ed6f9_classes($_l, $_args) { extract($_args)
