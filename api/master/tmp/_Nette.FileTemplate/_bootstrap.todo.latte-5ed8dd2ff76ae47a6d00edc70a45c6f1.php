...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba08adde853_content')) { function _lba08adde853_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb8f66ce4704_classes')) { function _lb8f66ce4704_classes($_l, $_args) { extract($_args)
