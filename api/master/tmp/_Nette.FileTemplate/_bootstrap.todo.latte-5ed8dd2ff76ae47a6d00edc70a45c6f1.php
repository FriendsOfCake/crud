...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb589925e9b5_content')) { function _lb589925e9b5_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb5a74df9916_classes')) { function _lb5a74df9916_classes($_l, $_args) { extract($_args)
