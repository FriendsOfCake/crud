...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbeda8d731d9_content')) { function _lbeda8d731d9_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbe370982f92_classes')) { function _lbe370982f92_classes($_l, $_args) { extract($_args)
