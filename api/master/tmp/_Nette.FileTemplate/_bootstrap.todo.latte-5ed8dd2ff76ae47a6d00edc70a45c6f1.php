...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf0cd25fcc2_content')) { function _lbf0cd25fcc2_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbb073282ee1_classes')) { function _lbb073282ee1_classes($_l, $_args) { extract($_args)
