...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf44a36a014_content')) { function _lbf44a36a014_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbebe5f04fec_classes')) { function _lbebe5f04fec_classes($_l, $_args) { extract($_args)
