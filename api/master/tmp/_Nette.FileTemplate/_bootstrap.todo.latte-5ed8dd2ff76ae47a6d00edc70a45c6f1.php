...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb855df751c8_content')) { function _lb855df751c8_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb3b66f8a2bf_classes')) { function _lb3b66f8a2bf_classes($_l, $_args) { extract($_args)
