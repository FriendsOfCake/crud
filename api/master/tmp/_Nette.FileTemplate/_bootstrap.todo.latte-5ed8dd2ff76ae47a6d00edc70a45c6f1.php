...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb44b855273c_content')) { function _lb44b855273c_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb996156f785_classes')) { function _lb996156f785_classes($_l, $_args) { extract($_args)
