...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb368c58fce8_content')) { function _lb368c58fce8_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb53beaf6636_classes')) { function _lb53beaf6636_classes($_l, $_args) { extract($_args)
