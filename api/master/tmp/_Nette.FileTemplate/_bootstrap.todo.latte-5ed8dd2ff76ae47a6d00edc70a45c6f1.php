...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb6d33da5446_content')) { function _lb6d33da5446_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb3f884702d2_classes')) { function _lb3f884702d2_classes($_l, $_args) { extract($_args)
