...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdc5bba2638_content')) { function _lbdc5bba2638_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb1752baf0eb_classes')) { function _lb1752baf0eb_classes($_l, $_args) { extract($_args)
