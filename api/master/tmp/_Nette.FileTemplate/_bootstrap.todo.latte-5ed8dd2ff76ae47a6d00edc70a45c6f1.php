...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb537d2ea03a_content')) { function _lb537d2ea03a_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lbf83ad7e8c2_classes')) { function _lbf83ad7e8c2_classes($_l, $_args) { extract($_args)
