...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb3e60ca0f7b_content')) { function _lb3e60ca0f7b_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb20541619a8_classes')) { function _lb20541619a8_classes($_l, $_args) { extract($_args)
