...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lba41bb0b6ff_content')) { function _lba41bb0b6ff_content($_l, $_args) { extract($_args)
?><div id="content">
...
// block classes
//
if (!function_exists($_l->blocks['classes'][] = '_lb5312830bc1_classes')) { function _lb5312830bc1_classes($_l, $_args) { extract($_args)
